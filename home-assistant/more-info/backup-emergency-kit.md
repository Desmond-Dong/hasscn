...
存储在 Home Assistant Cloud 上的[备份](/home-assistant/common-tasks/general/index.md#backups)始终使用 [AES-128](https://en.wikipedia.org/wiki/Advanced_Encryption_Standard) 加密。对于存储在[其他备份位置](/home-assistant/common-tasks/general/index.md#defining-backup-locations)的备份，您可以选择是否加密备份。备份应急工具包包含[恢复备份](/home-assistant/common-tasks/general/index.md#restoring-a-backup)所需的信息，例如加密密钥和相关备份的元数据。
...
3. 将工具包存储在 Home Assistant 系统之外的安全地方。
   ...
   * 但如果您在此期间更改了加密密钥，您仍然需要与旧备份匹配的旧密钥。如果没有加密密钥，就没有办法[恢复加密的备份](/home-assistant/common-tasks/general/index.md#restoring-a-backup)。

## 更改您的加密密钥

当您设置[备份](/home-assistant/common-tasks/general/index.md#backups)时，会自动生成一个加密密钥。此密钥用于您所有的备份。您可以用新密钥替换它，新密钥将用于所有未来的备份。要解密更改之前创建的备份，您仍然需要以前的加密密钥。
