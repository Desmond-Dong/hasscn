...
[`statistics`](/home-assistant/integrations/statistics/index.md) sensors for each particulate sensor you are
...
The [`statistics`](/home-assistant/integrations/statistics/index.md) sensors can then be combined into a template
