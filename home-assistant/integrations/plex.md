...
**Plex Media Server** integration 允许您将 Home Assistant 连接到 [Plex Media Server](https://plex.tv)。配置完成后，正在流式传输的 [Plex 客户端](https://www.plex.tv/apps-devices/) 会显示为[媒体播放器](/home-assistant/integrations/media_player/index.md)，并通过 Home Assistant 中的[传感器](/home-assistant/integrations/sensor/index.md)报告播放状态和资料库大小。媒体播放器将允许您控制媒体播放并查看当前播放的项目。

支持在链接的 [Sonos](/home-assistant/integrations/sonos/index.md) 扬声器上直接播放音乐的功能在 [Sonos 播放](#sonos-playback) 部分中提供。
...
* [Chromecast](/home-assistant/integrations/cast/index.md#plex)
* [Sonos](/home-assistant/integrations/plex.md#sonos-playback)
...
3. 配置 [Sonos](/home-assistant/integrations/sonos/index.md) 集成。
