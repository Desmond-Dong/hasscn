...
To send files and images, your jabber server must support [XEP\_0363](https://xmpp.org/extensions/xep-0363.html).

:::note
Be aware that images are uploaded onto the Jabber server of your provider. They reside there un-encrypted and could be accessed by the server admins. Usually images are deleted after a few days.<br> <br>
...
如需了解更多通知相关信息，请参阅[自动化入门页面](/home-assistant/getting-started/automation/index.md)。
