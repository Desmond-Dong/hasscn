...
Besides the standard actions provided by the Home Assistant [Light](/home-assistant/integrations/light/index.md) and [Scene](/home-assistant/integrations/scene.md) integrations, the following extra actions are provided by the UPB integration:
