...
The **Seven Segments OCR** integration allows you to read physical seven segments displays through Home Assistant. [`ssocr`](https://www.unix-ag.uni-kl.de/~auerswal/ssocr/) is used to extract the value shown on the display which is observed by a [camera](/home-assistant/integrations/camera/index.md).
...
<p class='img'>
  <img src='/home-assistant/images/screenshots/ssocr.png' />
</p>

With the help of a [template sensor](/home-assistant/integrations/template.md), the value can be shown as badge.
