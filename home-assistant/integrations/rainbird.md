...
2. Follow the setup guide for installing your LNK WiFi Module
3. Complete the necessary steps in the Rain Bird App
4. Home Assistant should auto discover the device on your network based on the mac address. Otherwise you will need to know the devices IP address on your network to let Home Assistant know how to connect to it.
...
* **Controller irrigation schedule**
  * **Description**: The irrigation schedule calendar
