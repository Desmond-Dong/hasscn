...
The **OneDrive for Business** integration allows you to use [OneDrive for Business](https://www.microsoft.com/en-us/microsoft-365/onedrive/online-cloud-storage) for [Home Assistant Backups](/home-assistant/common-tasks/general/index.md#backups).
