...
1. 访问 <https://myuplink.com/register> 并注册用户账户。
...
配置此集成时需要使用上面创建的 **Client ID** 和 **Client Secret**。更多信息请参阅 [Application Credentials](/home-assistant/integrations/application_credentials.md)。
