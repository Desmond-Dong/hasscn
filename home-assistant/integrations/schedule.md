...
The `schedule.get_schedule` action populates [response data](/home-assistant/docs/scripts/perform-actions.md#use-templates-to-handle-response-data) with the configured time ranges of a schedule.
