...
打开一盏灯，或通过 [groups](/home-assistant/integrations/group/index.md) 打开多盏灯。
...
*注意*：如果将 `light.toggle` 用于一组灯，它会分别切换每盏灯的状态。如果你希望这些灯被视为单个灯，请改用 [Light Groups](/home-assistant/integrations/group.md#binary-sensor-light-and-switch-groups)。
