...
**流媒体**集成为通过 Home Assistant 代理实时视频流提供了一种方式。大多数用户不需要配置任何内容，也不需要直接与此集成交互，因为它是供[摄像头集成](/home-assistant/integrations/camera.md)使用的内部集成。
