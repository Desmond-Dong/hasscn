...
与大多数其他集成不同，此集成不提供任何实体。导入的数据可以在[能源仪表板](/home-assistant/docs/energy/index.md)和[统计图表卡片](/home-assistant/dashboards/statistics-graph/index.md)中使用。
...
如果您对实时监控感兴趣，此集成不适合您。在这种情况下，您需要使用实时计量集成，如 [Tibber](/home-assistant/integrations/tibber/index.md)。
