...
有关 `speak` 的更多选项，请参阅主要 [TTS](/home-assistant/integrations/tts/index.md#service-speak) 构建块页面上的 Speak 部分。
...
有关在 Home Assistant 中使用文字转语音的更多信息及其提供的所有选项的更多详细信息，请参阅 [TTS 文档](/home-assistant/integrations/tts/index.md)。

有关在 Home Assistant 中使用语音转文字的更多信息及其提供的所有选项的更多详细信息，请参阅 [STT 文档](/home-assistant/integrations/stt/index.md)。
