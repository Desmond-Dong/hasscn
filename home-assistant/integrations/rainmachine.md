...
The integration has an [update entity](/home-assistant/integrations/update/index.md) that provides information on the latest available RainMachine firmware version. The firmware update can be triggered and installed onto your RainMachine controller
