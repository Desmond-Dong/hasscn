...
This is the local counterpart to the [Nexia](/home-assistant/integrations/nexia/index.md) cloud integration. If your thermostat supports local control, this integration provides faster response times and does not depend on internet connectivity.
...
2. Put the thermostat in *pairing mode*:
