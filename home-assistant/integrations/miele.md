...
如果你的安装中没有启用 [My Home Assistant](/home-assistant/integrations/my.md)，你可以改用 `<HOME_ASSISTANT_URL>/auth/external/callback` 作为重定向 URI。
...
集成配置过程中可能会要求输入 *Client ID* 和 *Client Secret*。更多信息请参阅下方的[故障排除](/home-assistant/integrations/miele/index.md#troubleshooting)以及 [Application Credentials](/home-assistant/integrations/application_credentials.md)。
