...
请查看[受支持 tld 的完整列表](https://www.google.com/supported_domains)，了解允许使用的 TLD 值。当多个方言共用同一个两位语言代码时（例如 *US、UK、AU*），此项可用于强制指定所使用的方言。
...
有关 `speak` 的更多选项，请参阅主 [TTS](/home-assistant/integrations/tts/index.md#action-speak) 构建块页面中的 Speak 章节。
...
有关在 Home Assistant 中使用文字转语音以及所有可用选项的更多信息，请参阅 [TTS 文档](/home-assistant/integrations/tts/index.md)。
