...
URL 字段中允许使用[模板](/home-assistant/docs/configuration/templating/index.md)，可用于选择不同的图像或根据传感器状态参数化 URL。模板有效性和网络访问将在配置步骤中检查。
...
要访问同时具有快照和实时流 URL 的摄像头，使用 [stream](/home-assistant/integrations/stream/index.md) 集成。

* Still Image URL: `http://194.218.96.92/jpg/image.jpg`
* Stream Source: `rtsp://user:pass@194.218.96.92:554`

如果摄像头只有实时流 URL 而没有快照 URL，[stream](/home-assistant/integrations/stream/index.md) 集成也可以从实时流 URL 生成静态图像。
