...
:::important
添加图片时，请确保包含这些附件的文件夹已加入 `allowlist_external_dirs`。<br>请参阅：[基础设置文档](/home-assistant/integrations/homeassistant/index.md#allowlist_external_dirs)
...
要进一步了解如何在自动化中使用通知，请参阅[自动化入门页面](/home-assistant/getting-started/automation/index.md)。
