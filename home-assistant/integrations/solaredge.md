...
You can find the created statistics under [**Settings** > **Developer tools** > **Statistics**](https://my.home-assistant.io/redirect/developer_statistics/), searching for `solaredge:`.

You can show them in the UI using the [`Statistic card`](/home-assistant/dashboards/statistic/index.md) or [`Statistics graph card`](/home-assistant/dashboards/statistics-graph/index.md).
You can use them in automations using the [`SQL`](/home-assistant/integrations/sql/index.md) integration.
...
![Screenshot of hourly production per module graph](/home-assistant/images/integrations/solaredge/hourly_production.png)
...
![Screenshot of daily production per module graph](/home-assistant/images/integrations/solaredge/daily_production.png)
...
To identify problematic modules, you could set up the [`SQL`](/home-assistant/integrations/sql/index.md) integration with the following:
...
* The statistics are intentionally updated infrequently (every 12 hours). If you want more frequent updates, you can call the [`homeassistant.reload_config_entry`](/home-assistant/integrations/homeassistant/index.md#action-homeassistantreload_config_entry) action from an automation.
