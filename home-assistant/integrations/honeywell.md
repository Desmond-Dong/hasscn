...
The **Honeywell Total Connect Comfort** integration integrates Home Assistant with *US-based* [Honeywell Total Connect Comfort (TCC)](https://mytotalconnectcomfort.com/portal/) climate systems.
...
All [climate actions](/home-assistant/integrations/climate.md) are supported except `set_swing_mode`.
...
For more details, see the [humidifier](/home-assistant/integrations/humidifier.md) integration documentation.
