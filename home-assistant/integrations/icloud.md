...
`icloud.update` 动作请求更新某个 iDevice 或链接到 iCloud 账户的所有设备。该请求将导致新的 Home Assistant [state\_changed](/home-assistant/docs/configuration/events/index.md#event-state_changed) 事件描述当前 iPhone 位置。它可以在需要手动位置更新时用于自动化中，例如，当门打开时检查是否有人在家。
