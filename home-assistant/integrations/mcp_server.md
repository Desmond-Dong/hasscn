...
此集成可提供与其他基于 LLM 的对话代理类似的功能，例如 [Anthropic](/home-assistant/integrations/anthropic/index.md)、[Google Generative AI](/home-assistant/integrations/google_generative_ai_conversation.md)、[Ollama](/home-assistant/integrations/ollama/index.md) 和 [Open AI](/home-assistant/integrations/openai_conversation/index.md)。在这些对话代理中，Home Assistant 是客户端，会准备可用工具并通过提示词将其传递给 LLM。
...
1. 如果你尚未安装 `gemini-cli`，请先安装。安装说明见 <https://geminicli.com/>。
