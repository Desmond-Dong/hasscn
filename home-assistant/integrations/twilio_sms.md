...
前提是你已经设置好 [Twilio](/home-assistant/integrations/twilio/index.md)。
...
Twilio 是一个通知平台，因此可以像[这里所述](/home-assistant/integrations/notify/index.md)那样通过调用 notify 操作来控制。它会向通知 **target** 中的所有 E.164 电话号码发送通知。有关电话号码格式的信息，请参阅上文中关于 `from_number` 配置变量的说明。你也可以使用 `whatsapp:+123456789` 向 WhatsApp 用户发送通知。
