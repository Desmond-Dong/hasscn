...
当您在此集成中配置要跟踪的仓库时，它将在设备面板中表示为一个服务，所有与该仓库相关的实体都将嵌套在该设备下。该设备还提供 GitHub 上仓库的链接以及下载该服务[诊断信息](/home-assistant/integrations/diagnostics.md)的选项。
...
此示例使用此集成提供的 [最新发布](#latest-release) 实体和一个 [notify](/home-assistant/integrations/notify.md) 动作，
...
此示例使用此集成提供的 [星标](#diagnostic-entities) 诊断实体和一个 [notify](/home-assistant/integrations/notify.md) 动作，
