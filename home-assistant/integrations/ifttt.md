...
要接收来自 IFTTT 的事件，您的 Home Assistant 实例需要能从互联网访问，并且您需要已[配置](/home-assistant/integrations/homeassistant/index.md#allowlist_external_urls)外部 URL，或者使用 IFTTT 集成中提供的 Nabu Casa 账户 webhook URL。
