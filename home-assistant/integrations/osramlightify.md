...
To enable the integration, add it to your "`configuration.yaml`" file.
:::tip
...
It is suggested to make [scan\_interval](/home-assistant/docs/configuration/platform_options/index.md#scan-interval)
