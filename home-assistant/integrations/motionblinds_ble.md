...
由于 Motionblinds 蓝牙电机需要通过蓝牙连接进行控制，Home Assistant 默认不会自动更新电机状态。因此，您可以对任意属于 Motionblinds 蓝牙设备的实体使用 [homeassistant.update\_entity](https://www.home-assistant.io/docs/scripts/perform-actions/#homeassistant-actions) 操作，这会连接到您的 Motionblinds 蓝牙电机并更新该设备下所有实体的状态。不过，请注意，这样做可能会影响电池续航。
