...
要在您的安装中启用 FFmpeg 源，您必须首先配置 [FFmpeg 集成](/home-assistant/integrations/ffmpeg/index.md)，然后将以下内容添加到您的 "`configuration.yaml`" 文件中：
...
如果您在使用此摄像头时遇到问题，请参阅[故障排除部分](/home-assistant/integrations/ffmpeg/index.md#troubleshooting)。
