...
唤醒词检测实体无法手动实现，但可以由 [Wyoming](/home-assistant/integrations/wyoming.md) 等集成提供。[Assist Pipelines](https://developers.home-assistant.io/docs/voice/pipelines/) 中的 API 可将唤醒词检测作为 [Assist](/home-assistant/voice_control/index.md) 的一部分启用。
