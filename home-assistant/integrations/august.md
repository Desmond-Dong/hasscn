...
对于使用 [Yale Home](https://yalehome.com/global) 应用程序的设备，应改用 [Yale](/home-assistant/integrations/yale.md) 集成。
...
[Yale Access Bluetooth](/home-assistant/integrations/yalexs_ble.md) 集成通过蓝牙对许多 Yale Access 门锁和一些使用相同系统的 August 门锁提供本地控制。

对于支持 Yale Access 系统的门锁，August 集成可以使您的离线访问密钥保持最新，以确保您可以通过蓝牙操作门锁。离线密钥更新必须满足以下要求：

* August 集成必须支持该门锁。
* [Yale Access Bluetooth 集成](/home-assistant/integrations/yalexs_ble.md) 必须支持该门锁。
* 蓝牙集成必须处于活动状态且正常工作。
* 门锁必须能被 [Yale Access Bluetooth 集成](/home-assistant/integrations/yalexs_ble.md) 发现。
...
* 确保门锁在范围内且能被 [Yale Access Bluetooth 集成](/home-assistant/integrations/yalexs_ble.md) 发现。
