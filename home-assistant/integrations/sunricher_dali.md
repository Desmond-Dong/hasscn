...
3. While discovery is in progress, press the **Reset** button on your DALI gateway device once. The gateway will respond immediately after the button press.
   ![Press the Reset button on the DALI gateway](/home-assistant/images/integrations/sunricher_dali_center/gateway_reset_button.png)

After setup, the gateway appears under [**Settings** > **Devices & services**](https://my.home-assistant.io/redirect/integrations/). Multiple gateways are supported, each with its own set of entities.
