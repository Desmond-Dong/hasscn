...
2. Select *Config*\* `[mdi:settings]`, then **General**.
...
API key:
    description: "The API key of your SABnzbd server. You can find this in the SABnzbd web interface under **Config** `[mdi:settings]` (top right) > **General** > **Security**."
```
...
6. Enable debug logging: Temporarily enable [debug logging](/home-assistant/docs/configuration/troubleshooting/index.md#debug-logs-and-diagnostics) for the SABnzbd integration to get more detailed error messages.
