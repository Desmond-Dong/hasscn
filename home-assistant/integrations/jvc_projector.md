...
The JVC Projector remote platform will create a [Remote](/home-assistant/integrations/remote/index.md) entity for the device. This entity allows you to send the following commands via the [remote.send\_command](/home-assistant/integrations/remote/index.md) action.
...
The JVC Projector binary sensor platform will create the following [Binary Sensor](/home-assistant/integrations/binary_sensor/index.md) entity:
...
The JVC Projector sensor platform will create the following [Sensors](/home-assistant/integrations/sensor/index.md) entities. Some of these sensors are disabled by default and may not be available for your model.
...
The JVC Projector select platform will create the following [Select](/home-assistant/integrations/select/index.md) entities. Some of these selects are disabled by default and may not be available for your model.
