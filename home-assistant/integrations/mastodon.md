...
<details>
<summary>避免短时间重复发布的状态动作示例</summary>
...
<details>
<summary>包含媒体和内容警告且不显示在公开时间线的发布示例</summary>
...
<details>
<summary>休假期间静音已关注账户的示例</summary>
...
For more on how to use notifications in your automations, please see the [getting started with automation page](/home-assistant/getting-started/automation/index.md).
