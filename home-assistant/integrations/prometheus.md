...
* 由 [client library](https://github.com/prometheus/client_python) 提供的指标，包括一组 **process\_\*** 指标，以及一个伪指标 **python\_info**，其中包含的不是数值而是标签形式的客户端 Python 版本信息，也就是 Home Assistant 所使用的 Python 解释器信息。
