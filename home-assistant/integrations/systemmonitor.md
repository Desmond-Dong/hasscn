...
:::note
All entities are disabled by default, you need to [enable the entities](/home-assistant/common-tasks/general/index.md#enabling-or-disabling-entities) that you wish to use.
...
The `process` binary sensor needs to be configured by the config entry options. Go to **[Settings > Devices & services](https://my.home-assistant.io/redirect/integrations/)**, select the **System Monitor** integration and select **Configure**.
