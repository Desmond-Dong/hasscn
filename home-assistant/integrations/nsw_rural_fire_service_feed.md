...
| external\_id        | The external ID used in the feed to identify the incident in the feed.                          |
...
| publication\_date   | Date and time when this incident was last updated.                                              |
| council\_area       | Council area in which this incident takes place.                                                |
...
| responsible\_agency | Agency responsible for this incident.                                                           |
