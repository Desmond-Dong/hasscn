...
You can find the statistics in [**Settings** > **Developer tools** > **Statistics**](https://my.home-assistant.io/redirect/developer_statistics/) and search for "suez\_water".
...
* The Energy dashboard must be enabled in your Home Assistant instance. If you haven't set it up yet, please refer to the [Energy dashboard documentation](/home-assistant/home-assistant-energy/).
