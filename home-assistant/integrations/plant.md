...
Another good source of this data would be the [Mi Flora](/home-assistant/integrations/miflora) integration.
...
The main sources of the data will usually be a [MiFlora sensor](/home-assistant/integrations/miflora) or a [MQTT sensor](/home-assistant/integrations/sensor.mqtt/index.md) receiving the data from a [PlantGateway](https://github.com/ChristianKuehnel/plantgateway).
