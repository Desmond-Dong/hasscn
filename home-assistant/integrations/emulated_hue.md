...
:::warning
请注意，对于新的 **Google Home** 用户来说，`emulated_hue` 已不再可用。如果您以前没有配置过并成功使用它，请改用 [Google Assistant](/home-assistant/integrations/google_assistant/index.md) 集成或 [Nabu Casa cloud](/home-assistant/integrations/cloud.md) 集成。
...
请注意，具体路径会因安装方式不同而有所差异。例如，如果您按照 [Virtualenv 说明](/home-assistant/installation/linux/index.md) 进行安装，路径会是 `/srv/homeassistant/bin/python3`。
