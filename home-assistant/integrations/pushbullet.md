...
前往 <https://www.pushbullet.com/#settings/account> 获取 API 密钥或访问令牌。
...
Pushbullet 是一个 notify 平台，因此可以像[这里所述](/home-assistant/integrations/notify/index.md)那样通过调用 notify 动作来控制。它会向 Pushbullet 账户中注册的所有设备发送通知。您也可以通过可选的 **target** 参数指定特定账户设备、联系人或频道。
...
:::important
别忘了[允许外部目录](/home-assistant/integrations/homeassistant/index.md#allowlist_external_dirs)，这样 Home Assistant 才能访问这些目录。
