...
如果您使用 [`default_config`](/home-assistant/integrations/default_config/index.md)，并且通过以下任一安装类型运行 Home Assistant，则 go2rtc 集成会自动设置，您无需执行任何操作：
...
此集成属于 [`default_config`](/home-assistant/integrations/default_config/index.md) 的一部分。
