...
madVR Envy remote 平台会为设备创建一个 [remote](/home-assistant/integrations/remote/index.md) 实体。您可以通过 [remote.send\_command](/home-assistant/integrations/remote/index.md) 操作向该实体发送以下命令。
