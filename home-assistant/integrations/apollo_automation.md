...
Apollo Automation 设备可在本地运行，并能与 Home Assistant 中的 [ESPHome](/home-assistant/integrations/esphome/index.md) 集成无缝协作。由于所有连接都在本地完成，因此 Home Assistant 的状态更新和设备控制几乎是即时的。

:::note
此集成由 [ESPHome](/home-assistant/integrations/esphome/index.md) 集成支持。
:::
