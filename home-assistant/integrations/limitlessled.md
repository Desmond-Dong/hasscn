...
Refer to the [light](/home-assistant/integrations/light/index.md) documentation for general property usage, but keep in mind the following notes specific to LimitlessLED.
...
<p class='img'>
<img src='/home-assistant/images/screenshots/limitlessled_assumed_state.png' />
</p>

Because LimitlessLED lights may have an obsolete state, Home Assistant shows the power switch as two buttons rather than a toggle. This ensures that the power can be set with a single click even if the assumed state is wrong. You can change to use the power toggle with [Customize](/home-assistant/docs/configuration/customizing-devices/index.md):
