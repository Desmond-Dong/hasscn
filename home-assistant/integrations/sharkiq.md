...
当前支持以下 [`vacuum`](/home-assistant/integrations/vacuum/index.md) 操作：
...
除了 [`vacuum`](/home-assistant/integrations/vacuum/index.md) 操作外，此集成还支持房间定向清扫。
...
**Important Note:** 房间列表必须与 Shark Clean 应用中显示的名称 *完全一致*。如果您想确认该操作可识别的准确名称，请在 Home Assistant 中查看 Shark 扫地机器人的 `Rooms` 属性。这里会填入机器人已配置的房间名称，操作也会按这些名称进行识别。
