...
**Evohome** 集成将 Home Assistant 与所有\_非美国\_ [Honeywell Total Connect Comfort (TCC)](https://international.mytotalconnectcomfort.com/Account/Login) CH/DHW 系统链接，例如：
...
要使您的系统与此集成兼容，您必须能够通过 <https://international.mytotalconnectcomfort.com/> 访问它（注意"international"）。
...
TCC 系统实现为一个\_位置\_，由 1-12 个\_区域\_和可选的 DHW 控制器组成：
