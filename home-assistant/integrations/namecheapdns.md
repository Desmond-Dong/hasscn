...
无论如何，在报告问题之前，请启用[调试日志记录](/home-assistant/docs/configuration/troubleshooting/index.md#debug-logs-and-diagnostics)，重新启动集成，一旦问题再次出现，请再次停止调试日志记录（*调试日志文件的下载将自动开始*）。
