...
Home Assistant 的 **LinkPlay** 集成可让您控制多种基于 LinkPlay 协议的媒体播放器。该集成支持通过 [Zeroconf](/home-assistant/integrations/zeroconf.md) 在本地网络中自动发现设备。
...
除了[标准媒体播放器操作](/home-assistant/integrations/media_player/index.md#actions)外，LinkPlay 集成还提供多种自定义操作。
