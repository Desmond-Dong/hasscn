...
要在您的安装中使用 MQTT 风扇，请[将 MQTT 设备作为子条目添加](/home-assistant/integrations/mqtt/index.md#configuration)，或将以下内容添加到 `configuration.yaml` 文件中。
:::tip
...
或者，也可以通过更高级的 [MQTT discovery](/home-assistant/integrations/mqtt/index.md#mqtt-discovery) 来进行设置。
