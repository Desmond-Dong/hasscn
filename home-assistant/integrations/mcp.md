...
[conversation agent](/home-assistant/integrations/conversation.md). For example, you can add an MCP server that
...
(for example [Anthropic](/home-assistant/integrations/anthropic/index.md), [Google Generative AI](/home-assistant/integrations/google_generative_ai_conversation.md), [Ollama](/home-assistant/integrations/ollama/index.md), [Open AI](/home-assistant/integrations/openai_conversation/index.md)).
