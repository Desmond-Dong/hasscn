...
Support for devices by Ogemray in Home Assistant is provided by the [Shelly](/home-assistant/integrations/shelly.md) integration.

Ogemray devices are either rebranded devices or devices that share a common communication protocol, making it possible to use them with the [Shelly](/home-assistant/integrations/shelly.md) integration.
...
For more documentation on how to use Ogemray in Home Assistant, refer to the [Shelly integration documentation page](/home-assistant/integrations/shelly.md).
