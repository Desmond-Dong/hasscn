...
必须将配置的文件夹添加到 [allowlist\_external\_dirs](/home-assistant/integrations/homeassistant/index.md#allowlist_external_dirs)。请注意，默认情况下，文件夹监视是递归的，这意味着子文件夹的内容也会受到监视。
