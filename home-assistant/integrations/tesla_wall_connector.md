...
* **Status** - Present status of the Wall Connector.
  * **Possible states** - booting, not\_connected, connected, ready, negotiating, error, charging\_finished, waiting\_car, charging\_reduced, charging
...
Energy usage can be easily added to the built-in [Energy dashboard](/home-assistant/docs/energy/index.md) using the energy sensor.
