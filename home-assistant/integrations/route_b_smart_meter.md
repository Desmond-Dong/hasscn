...
By default, the data you get is the total consumption since an unknown date in the past. If you want to get your monthly consumption data, you can use the [utility\_meter](/home-assistant/integrations/utility_meter/index.md) integration.

## Retrieving your monthly cost data

To get your monthly cost data, you can use the [template sensor](/home-assistant/integrations/template/index.md) integration along with the [utility\_meter](/home-assistant/integrations/utility_meter/index.md) integration. You will need to know your electricity rate (cost per kWh) to calculate the cost. For instance, if you are using Tokyo Gas and have a price depending on your usage, you can use the following template with a unit of measurement set to your currency per kWh (for example, JPY/kWh) and the appropriate sensor name:
