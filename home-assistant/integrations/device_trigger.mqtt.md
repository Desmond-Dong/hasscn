...
对于按钮、遥控器等设备，MQTT 设备触发器比 [binary sensor](/home-assistant/integrations/binary_sensor.mqtt/index.md) 是更好的选择。

## 配置

MQTT 设备触发器仅支持通过 [MQTT discovery](/home-assistant/integrations/mqtt/index.md#mqtt-discovery) 进行配置，不支持通过 `configuration.yaml` 手动设置。
