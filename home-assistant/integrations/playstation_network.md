...
You can send messages to a friend or group using the `notify.send_message` action.

For more information on using notifications, refer to the [Getting Started with Automation](/home-assistant/getting-started/automation/index.md) page.

## Track online status of friends

The **PlayStation Network integration** allows tracking the online status of your friends. To add a friend, go to [**Settings** > **Devices & services** > **PlayStation Network**](https://my.home-assistant.io/redirect/integration/?domain=playstation_network) and select **`[mdi:plus]` Add friend**.
