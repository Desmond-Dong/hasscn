...
* [recorder 集成](/home-assistant/integrations/recorder.md) 中使用的引擎名称和版本
* 指示 [energy 集成](/home-assistant/integrations/energy.md) 已配置的布尔值
...
崩溃报告仅对 Home Assistant Core 开发人员可见。此功能目前仅限于 [Supervisor](/home-assistant/docs/glossary/index.md#home-assistant-supervisor) 和 [OS-Agent](https://github.com/home-assistant/os-agent)。
