...
Lutron 多年来推出了许多系统，每种系统都有其独特的接口协议。Homeworks 系统有三种：QS、Series 4 和 8，以及 original。此平台仅适用于 Series 4 和 8。另有 [lutron](/home-assistant/integrations/lutron/index.md) 集成用于处理 Lutron RadioRA 2 系统。
