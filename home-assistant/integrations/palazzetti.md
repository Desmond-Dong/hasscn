...
此集成支持以下动作（请参阅 [Climate](/home-assistant/integrations/climate/index.md)）。
...
* [`set_hvac_mode`](/home-assistant/integrations/climate/index.md#action-climateset_hvac_mode)
  * `heat` 表示加热模式
  * `off` 表示关闭炉具
* [`set_fan_mode`](/home-assistant/integrations/climate/index.md#action-climateset_fan_mode)
  * `0` 到 `5` 表示逐级增大的风扇速度
  * `High` 表示可用的最高风扇速度
