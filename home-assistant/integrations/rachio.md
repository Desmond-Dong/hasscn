...
:::important
In order for Rachio switches and sensors to update, your Home Assistant instance must be accessible from the internet, either via Home Assistant Cloud or another method. See the [Remote Access documentation](/home-assistant/docs/configuration/remote/index.md) for more information. The smart hose timers use polling and don't require external access to be setup.
...
If you would like to see and control more detailed zone information, create an [iFrame](/home-assistant/integrations/panel_iframe/) that renders the Rachio web app.
