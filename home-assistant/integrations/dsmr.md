...
* 目前通过 Nigel Dokter 编写的 [dsmr\_parser](https://github.com/ndokter/dsmr_parser) 模块支持 DSMR V2.2、V3、V4、V5、比利时 V5 变体、卢森堡 V5 变体（Smarty）、瑞典 V5 变体，以及德国的 EasyMeter Q3D。
...
* [esp8266\_p1meter (daniel-jong)](https://github.com/daniel-jong/esp8266_p1meter)（在 ESP8266 上解析并发布到 MQTT）
