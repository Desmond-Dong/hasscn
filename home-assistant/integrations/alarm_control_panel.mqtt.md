...
要在您的安装中使用 MQTT 报警控制面板，请[将 MQTT 设备添加为子条目](/home-assistant/integrations/mqtt/index.md#configuration)，或将以下内容添加到您的 "`configuration.yaml`" 文件中。
:::tip
...
或者，可以通过 [MQTT 发现](/home-assistant/integrations/mqtt/index.md#mqtt-discovery) 进行更高级的设置。
