...
| 数据属性 | 可选 | 说明 |
| ---------------------- | -------- | --------------------------------- |
| entity\_id              | No       | KEF 扬声器的 entity\_id。 |
...
| ---------------------- | -------- | ---------------------------------------------------------- |
| entity\_id              | No       | KEF 扬声器的 entity\_id。 |
| desk\_mode              | Yes      | “Desk mode”（`true` 或 `false`） |
| wall\_mode              | Yes      | “Wall mode”（`true` 或 `false`） |
| phase\_correction       | Yes      | “Phase correction”（`true` 或 `false`） |
| high\_pass              | Yes      | “High-pass mode”（`true` 或 `false`） |
| sub\_polarity           | Yes      | “Sub polarity”（`-` 或 `+`） |
| bass\_extension         | Yes      | “Bass extension” 选择器（`Less`、`Standard` 或 `Extra`） |
...
| ---------------------- | -------- | ----------------------------------------------- |
| entity\_id              | No       | KEF 扬声器的 entity\_id。 |
| db\_value               | No       | 滑块值（-6 到 0，步进为 0.5） |
...
| ---------------------- | -------- | ----------------------------------------------- |
| entity\_id              | No       | KEF 扬声器的 entity\_id。 |
| db\_value               | No       | 滑块值（-2 到 2，步进为 0.5） |
...
| ---------------------- | -------- | ----------------------------------------------- |
| entity\_id              | No       | KEF 扬声器的 entity\_id。 |
| hz\_value               | No       | 滑块值（50 到 120，步进为 5） |
...
| ---------------------- | -------- | ----------------------------------------------- |
| entity\_id              | No       | KEF 扬声器的 entity\_id。 |
| hz\_value               | No       | 滑块值（40 到 250，步进为 5） |
...
| ---------------------- | -------- | ----------------------------------------------- |
| entity\_id              | No       | KEF 扬声器的 entity\_id。 |
| db\_value               | No       | 滑块值（-10 到 10，步进为 1） |
