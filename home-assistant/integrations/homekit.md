...
请查看 [HomeKit Device](/home-assistant/integrations/homekit_controller/index.md) 集成，
...
你可能还需要在 [network 配置](/home-assistant/integrations/network.md) 中设置 Home Assistant 使用的默认网络接口。
...
| 集成                                                          | 类型名称               | 说明                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| ------------------------------------------------------------- | ---------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| alarm\_control\_panel                                           | SecuritySystem         | 所有安防系统。                                                                                                                                                                                                                                                                                                                                                                                                                                |
| automation / button / input\_boolean / input\_button / lawn\_mower / remote / scene / script / vacuum | Switch                 | 全部会表示为开关。                                                                                                                                                                                                                                                                                                                                                                                                                            |
| input\_select / select                                         | Switch                 | 会表示为带有各选项按钮的排插。                                                                                                                                                                                                                                                                                                                                                                                                                 |
| binary\_sensor                                                 | Sensor                 | 支持 `co2`、`door`、`garage_door`、`gas`、`moisture`、`motion`、`occupancy`、`opening`、`smoke` 和 `window` 设备类。其他情况默认使用 `occupancy` 设备类。                                                                                                                                                                                                                                                                                     |
...
| device\_tracker / person                                       | Sensor                 | 支持 `occupancy` 设备类。                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
| media\_player                                                  | MediaPlayer            | 会表示为一组开关，用于控制 `on / off`、`play / pause`、`play / stop` 或 `mute`，具体取决于实体的 `supported_features` 以及 `entity_config` 中指定的 `mode` 列表。                                                                                                                                                                                                                                                                              |
| media\_player                                                  | TelevisionMediaPlayer  | 所有 `device_class` 为 `tv` 的媒体播放器。会在 HomeKit 中表示为电视和遥控器配件，以控制 `on / off`、`play / pause`、`select source` 或 `volume increase / decrease`，具体取决于实体的 `supported_features`。需要 iOS 12.2/macOS 10.14.4 或更高版本。                                                                                                                                                                                       |
| media\_player                                                  | ReceiverMediaPlayer    | 所有 `device_class` 为 `receiver` 的媒体播放器。会在 HomeKit 中表示为接收器和遥控器配件，以控制 `on / off`、`play / pause`、`select source` 或 `volume increase / decrease`，具体取决于实体的 `supported_features`。需要 iOS 12.2/macOS 10.14.4 或更高版本。                                                                                                                                                                             |
...
| water\_heater                                                  | WaterHeater            | 所有 `water_heater` 设备。                                                                                                                                                                                                                                                                                                                                                                                                                    |
| device\_automation                                             | DeviceTriggerAccessory | 所有支持触发器的设备。                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
更多详情请参阅 [Zero-configuration networking](/home-assistant/integrations/zeroconf/index.md#troubleshooting) 集成文档。
...
[Universal Media Player](/home-assistant/integrations/universal/index.md#harmony-remote-example) 中提供了一个示例，展示如何封装现有实体，使其能够在 HomeKit 中作为 Television 配件使用。
...
请确认 [`ffmpeg`](/home-assistant/integrations/ffmpeg.md) 集成已正确配置。验证你的流是否可以通过 `ffplay <stream_source>` 或 [VLC Media Player](https://www.videolan.org/) 直接播放。如果你修改过摄像头的实体配置，可能需要[重置该配件](#resetting-accessories)。
