...
例如，如果您的 ZoneMinder 实例配置了一个名为"Home"的运行状态，您可以编写一个[自动化](/home-assistant/getting-started/automation/index.md)，通过包含以下[action](/home-assistant/getting-started/automation-action/)将 ZoneMinder 更改为"Home"运行状态：
...
创建的每个 binary\_sensor 将以配置 [ZoneMinder 集成](/home-assistant/integrations/zoneminder/index.md)时使用的主机名命名。
...
:::important
您必须已配置 [ZoneMinder 集成](/home-assistant/integrations/zoneminder/index.md) 才能使用此功能，如果启用了 ZoneMinder 身份验证，集成配置中指定的账户必须具有"System"的"Edit"权限。
