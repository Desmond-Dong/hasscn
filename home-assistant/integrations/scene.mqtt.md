...
payload_on:
  ...
  default: "ON"
platform:
  description: Must be `scene`. Only allowed and required in [MQTT auto discovery device messages](/home-assistant/integrations/mqtt/#device-discovery-payload).
  required: true
  type: string
qos:
...
在本节中，您将找到一些有关如何使用 MQTT 场景的现实示例。
