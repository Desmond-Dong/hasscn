...
| ---------------------------- | ------------------------------------------------------------------ |
| joaoapps\_join/ring           |                                                                    |
| joaoapps\_join/send\_sms       | `{"number":"5553334444", "message":"Hello!"}`                      |
| joaoapps\_join/send\_tasker    | `{"command":"test"}`                                               |
| joaoapps\_join/send\_url       | `{"url":"http://google.com"}`                                      |
| joaoapps\_join/send\_wallpaper | `{"url":"http://www.planwallpaper.com/static/images/ZhGEqAP.jpg"}` |
| joaoapps\_join/send\_file      | `{"url":"http://download.thinkbroadband.com/5MB.zip"}`             |
