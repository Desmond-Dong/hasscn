...
**Wyoming** 集成使用一种[轻量协议](https://github.com/rhasspy/rhasspy3/blob/master/docs/wyoming.md)将外部语音服务连接到 Home Assistant。这使得 [Assist](/home-assistant/voice_control/index.md) 可以使用多种本地的[语音转文本](/home-assistant/integrations/stt/index.md)、[文本转语音](/home-assistant/integrations/tts/index.md)和[唤醒词检测](/home-assistant/integrations/wake_word/index.md)系统，例如：
...
Home Assistant 的 Wyoming、Piper 和 Whisper 应用（以前称为附加组件）可用于创建完全本地化的语音流水线。要了解具体做法，请按照[安装本地语音流水线](/home-assistant/voice_control/voice_remote_local_assistant/index.md)中的步骤操作。
...
[远程语音卫星设备](https://github.com/rhasspy/wyoming-satellite)可以通过 Wyoming 协议连接到 Home Assistant。这些卫星设备通常运行在 Raspberry Pi 上，并由 Home Assistant 通过 [Zeroconf](/home-assistant/integrations/zeroconf.md) 自动发现。
