...
`stookwijzer.get_forecast` 操作会将 Stookwijzer 建议预报以映射形式写入 [response data](/home-assistant/docs/scripts/perform-actions.md#use-templates-to-handle-response-data)。
