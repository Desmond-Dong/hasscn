...
:::tip
如果您想使用网络存储中的媒体，必须先连接该网络存储。请参阅[这些连接网络存储的说明](/home-assistant/common-tasks/os/index.md#network-storage)。
...
1. 在侧边栏中选择 **媒体**。
2. 导航到包含您想播放媒体的文件夹。\
   *在本示例中，我们将进入 **我的媒体** > **NAS\_Media**。该文件夹是一个网络共享，包含多个 `.mp3` 文件，其中一个名为 `my-music.mp3`。*
3. 从地址栏复制当前 URL。\
