...
有关如何设置 API 密钥，请参阅 [Microsoft Face 集成](/home-assistant/integrations/microsoft_face/index.md) 的配置说明。

如需在自动化规则中使用结果，请参阅 [Image Processing 集成](/home-assistant/integrations/image_processing/index.md) 页面。

:::important
Microsoft Face identify API 的免费版本会限制每月可发起的请求数量。因此，强烈建议您在设置此实体实例时限制 `scan_interval`，具体说明请参阅 [Image Processing 集成](/home-assistant/integrations/image_processing/index.md) 主页面。
