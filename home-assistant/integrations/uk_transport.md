...
To add a single train departure integration add the following to your "`configuration.yaml`" file.
:::tip
...
Attributes can be accessed using the [template sensor](/home-assistant/integrations/template.md) as per this example:
