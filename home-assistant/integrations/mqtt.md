...
* [报警控制面板](/home-assistant/integrations/alarm_control_panel.mqtt/index.md)
* [二值传感器](/home-assistant/integrations/binary_sensor.mqtt/index.md)
* [按钮](/home-assistant/integrations/button.mqtt/index.md)
* [摄像头](/home-assistant/integrations/camera.mqtt/index.md)
* [遮盖](/home-assistant/integrations/cover.mqtt/index.md)
* [温控（HVAC）](/home-assistant/integrations/climate.mqtt/index.md)
* [设备追踪器](/home-assistant/integrations/device_tracker.mqtt/index.md)
* [设备触发器](/home-assistant/integrations/device_trigger.mqtt/index.md)
* [事件](/home-assistant/integrations/event.mqtt/index.md)
* [风扇](/home-assistant/integrations/fan.mqtt/index.md)
* [加湿器](/home-assistant/integrations/humidifier.mqtt/index.md)
* [图像](/home-assistant/integrations/image.mqtt/index.md)
* [割草机](/home-assistant/integrations/lawn_mower.mqtt/index.md)
* [灯光](/home-assistant/integrations/light.mqtt/index.md)
* [门锁](/home-assistant/integrations/lock.mqtt/index.md)
* [通知](/home-assistant/integrations/notify.mqtt/index.md)
* [数字](/home-assistant/integrations/number.mqtt/index.md)
* [场景](/home-assistant/integrations/scene.mqtt/index.md)
* [选择器](/home-assistant/integrations/select.mqtt/index.md)
* [传感器](/home-assistant/integrations/sensor.mqtt/index.md)
* [警报器](/home-assistant/integrations/siren.mqtt/index.md)
* [开关](/home-assistant/integrations/switch.mqtt/index.md)
* [更新](/home-assistant/integrations/update.mqtt/index.md)
* [标签扫描器](/home-assistant/integrations/tag.mqtt/index.md)
* [文本](/home-assistant/integrations/text.mqtt/index.md)
* [吸尘器](/home-assistant/integrations/vacuum.mqtt/index.md)
* [阀门](/home-assistant/integrations/valve.mqtt/index.md)
* [热水器](/home-assistant/integrations/water_heater.mqtt/index.md)
...
:::important
如果您遇到类似 `Failed to connect due to exception: [SSL: CERTIFICATE_VERIFY_FAILED] certificate verify failed` 的错误消息，请打开 `高级选项` 并将 [代理证书验证](/home-assistant/integrations/mqtt/index.md#broker-certificate-validation) 设置为 `Auto`。
...
MQTT 设备的发现将使您能够以最少的配置工作在 Home Assistant 端使用 MQTT 设备。配置在设备本身和设备使用的主题上完成。类似于 [HTTP 二值传感器](/home-assistant/integrations/http/index.md#binary-sensor) 和 [HTTP 传感器](/home-assistant/integrations/http/index.md#sensor)。为了防止设备重新连接时出现多个相同条目，需要唯一标识符。设备端需要两部分：配置主题和设备配置作为负载。

MQTT 发现默认启用，但可以禁用。可以更改发现主题的前缀（默认为 `homeassistant`）。
请参阅 [MQTT 选项部分](#configure-mqtt-options)

:::note
支持 MQTT 发现的 MQTT 组件的文档[可在此处找到](/home-assistant/integrations/mqtt/index.md#configuration-via-mqtt-discovery)。
...
* [设备发现](/home-assistant/integrations/mqtt/index.md#device-discovery-payload)，允许您在单个发现消息中包含多个组件
* [单组件发现](/home-assistant/integrations/mqtt/index.md#single-component-discovery-payload)，您为每个组件发布单独的发现消息
...
或者，设备也可以[为其想要设置的每个组件发送发现负载](/home-assistant/integrations/mqtt/index.md#single-component-discovery-payload)。
...
* `availability` [选项](/home-assistant/integrations/mqtt/index.md#using-availability-topics)。
* `origin`（必需）[选项](/home-assistant/integrations/mqtt/index.md#adding-information-about-the-origin-of-a-discovery-message)
* `command_topic`
* `state_topic`
* `qos`
* `encoding`
...
:::note
要查看每个缩写代表什么，请参阅 [MQTT 发现消息中支持的缩写列表](/home-assistant/integrations/mqtt/index.md#supported-abbreviations-in-mqtt-discovery-messages)。
...
负载中的选项仅用于设置一个特定组件。如果设备包含多个组件，建议改用[设备发现](/home-assistant/integrations/mqtt/index.md#device-discovery-payload)。
...
更多示例[请参阅](/home-assistant/integrations/mqtt/index.md#discovery-examples-with-component-discovery)。
...
连接到共享 `mqtt` 代理的设备或服务可以订阅此主题，并使用 `online` 消息触发发现消息。另请参阅 [birth 和 last will 消息](/home-assistant/integrations/mqtt/index.md#birth-and-last-will-messages)部分。配置发布后，状态主题需要更新，因此需要重新发布。
...
可以用[二值传感器](/home-assistant/integrations/binary_sensor.mqtt/index.md)表示的运动检测设备将作为 JSON 负载发送其配置到配置主题。在向 `config` 发送第一条消息后，发送到状态主题的 MQTT 消息将更新 Home Assistant 中的状态。
...
更多详情请参阅 [MQTT 测试部分](/home-assistant/integrations/mqtt/index.md#testing-your-setup)。
...
传感器 [`identifiers` 或 `connections`](/home-assistant/integrations/sensor.mqtt/index.md#device) 选项允许设置共享同一设备的多个实体。
...
设置灯光、开关等类似，但需要如 [MQTT 开关文档](/home-assistant/integrations/switch.mqtt/index.md) 中所述的 `command_topic`。
...
设置[接受 JSON 负载的灯光](/home-assistant/integrations/light.mqtt/index.md#json-schema)，使用缩写配置变量名称：
...
对于大多数集成，也可以在 "`configuration.yaml`" 中手动设置 MQTT 项目。阅读更多[关于 YAML 配置](/home-assistant/docs/configuration/yaml.md)。
...
如果您有大量手动配置的项目，可能需要考虑[拆分配置](/home-assistant/docs/configuration/splitting_configuration/index.md)。

:::note
支持 YAML 的 MQTT 组件的文档[可在此处找到](/home-assistant/integrations/mqtt/index.md#configuration-via-yaml)。
...
MQTT 集成支持模板。阅读更多[关于在 MQTT 集成中使用模板](/home-assistant/docs/configuration/templating/index.md#using-templates-with-the-mqtt-integration)。
...
在自动化中用作 [`script`](/home-assistant/integrations/script/index.md)。
...
:::note
当 `payload` 在 YAML 脚本或自动化中从[模板](/home-assistant/docs/configuration/templating/index.md#using-value-templates-with-mqtt)渲染时，模板渲染为 `bytes` 字面量，传出 MQTT 负载将仅作为 `raw` 数据发送，如果 `evaluate_payload` 选项标志设置为 `true`。
...
[logger](/home-assistant/integrations/logger/index.md) 集成允许记录接收到的 MQTT 消息。
