...
如需使用 RadioRA 2 和 HomeWorks QS 产品线，请参阅 [Lutron 集成](/home-assistant/integrations/lutron/index.md)。
...
* Pico 遥控器，作为[设备触发器](/home-assistant/integrations/device_automation/index.md)
* Shade 遥控器，作为[设备触发器](/home-assistant/integrations/device_automation/index.md)
...
:::tip
建议为 Lutron Smart Bridge 分配静态 IP 地址。这样可避免其 IP 变化，防止网桥重启后因地址变化而需要修改 `host`。 <br>
...
有关在 Home Assistant 中使用窗帘的更多信息，请参阅 [Covers 集成](/home-assistant/integrations/cover/index.md)。
...
有关在 Home Assistant 中使用灯光的更多信息，请参阅 [Lights 集成](/home-assistant/integrations/light/index.md)。
...
有关在 Home Assistant 中使用场景的更多信息，请参阅 [Scenes 集成](/home-assistant/integrations/scene/index.md)。
...
有关在 Home Assistant 中使用开关的更多信息，请参阅 [Switches 集成](/home-assistant/integrations/switch/index.md)。
...
有关在 Home Assistant 中使用风扇的更多信息，请参阅 [Fans 集成](/home-assistant/integrations/fan/index.md)。
...
有关在 Home Assistant 中使用二进制传感器的更多信息，请参阅 [Binary Sensors 集成](/home-assistant/integrations/binary_sensor/index.md)
...
有关在 Home Assistant 中使用按钮的更多信息，请参阅 [Buttons 集成](/home-assistant/integrations/button/index.md)。
