...
* 若要启用调试日志，请按照[启用调试日志步骤](/home-assistant/docs/configuration/troubleshooting/index.md#debug-logs-and-diagnostics)操作。
...
SmartThings 集成提供两个层级的诊断信息。若要下载诊断，请按照[下载诊断步骤](/home-assistant/docs/configuration/troubleshooting/index.md#download-diagnostics)操作。
