...
* MQTT broker and the [MQTT integration](/home-assistant/integrations/mqtt/index.md) set up in Home Assistant.
...
4. Change the default device name. Use a unique, meaningful name such as E\_Board\_Office, or E\_Board\_Garden.
