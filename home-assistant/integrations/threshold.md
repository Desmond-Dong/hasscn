...
```yaml
entity_id:
  description: "The entity to monitor. Only [sensors](/home-assistant/integrations/sensor/) are supported."
  required: true
  type: string
device_class:
...
The hysteresis parameter can be used in this use-case to avoid frequent state changes around the maximum or the minimum of a temperature curve. We also have to utilize the [derivative sensor](/home-assistant/integrations/derivative/index.md) for this use-case:
