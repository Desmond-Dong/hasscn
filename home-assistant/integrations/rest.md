...
如果每个端点只有一个传感器，也可以将 [RESTful Sensor](/home-assistant/integrations/sensor.rest.md) 和 [RESTful Binary Sensor](/home-assistant/integrations/binary_sensor.rest.md) 作为平台进行设置。
