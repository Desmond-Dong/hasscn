...
To enable the integration via YAML, add it to your "`configuration.yaml`" file.
:::tip
...
LAN packet. This example requires the [Wake on LAN](/home-assistant/integrations/wake_on_lan.md)
