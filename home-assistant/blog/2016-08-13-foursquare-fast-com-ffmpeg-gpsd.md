...
This 发布 includes code contributed by 31 different people. The biggest change in this 发布 is a new unit system. Instead of picking Celsius or Fahrenheit you'll have to pick imperial or metric now. This influences the units for your temperature, distance, and weight. This will simplify any platform or component that needs to know this information. Big thanks to [@Teagan42] for her hard work on this!

<img src='/home-assistant/images/supported_brands/foursquare.png' style='clear: right; margin-left: 5px; border:none; box-shadow: none; float: right; margin-bottom: 16px;' width='100' /><img src='/home-assistant/images/supported_brands/ohmconnect.png' style='clear: right; margin-left: 5px; border:none; box-shadow: none; float: right; margin-bottom: 16px;' width='100' /><img src='/home-assistant/images/supported_brands/fastdotcom.png' style='clear: right; margin-left: 5px; border:none; box-shadow: none; float: right; margin-bottom: 16px;' width='100' /><img src='/home-assistant/images/supported_brands/gpsd.png' style='clear: right; margin-left: 5px; border:none; box-shadow: none; float: right; margin-bottom: 16px;' width='100' /><img src='https://brands.home-assistant.io/ffmpeg/logo.png' srcset='https://brands.home-assistant.io/ffmpeg/logo@2x.png 2x' style='clear: right; margin-left: 5px; border:none; box-shadow: none; float: right; margin-bottom: 16px;' width='100' />

* 核心: Introduce notion of unit system (deprecates temperature unit option) ([@Teagan42])
* Front end: Speed improvements ([@balloob])
* Front end: Improve layout of 状态 dev tool ([@balloob])
...
* [InfluxDB]: Whitelist 实体 option added ([@tchellomello])
* 传感器: Serial [particulate matters][particulate] 传感器 now supported ([@open-homeautomation])
* 传感器 - [Fitbit]: Fix unit system ([@tchellomello])
* 灯光 - [Flux LED]: Add support for \[color and brightness]\[color] ([@Danielhiversen])
* Media Player - [Plex]: Now able to report on music ([@abcminiuser])
* 报警 Control 面板 - [Verisure]: Now able to see who changed the 报警 (@persandtrom)
* Thermostat - [Honeywell]: Add option to read and control HVAC mode ([@Teagan42])
* [Foursquare] component to receive instant 通知 of checkins ([@robbiet480])
* 摄像头: New [FFMPEG] platform allows to stream anything through front end ([@pvizeli])
* Manage [secrets] with new command line 脚本 ([@kellerza])
* 通知 - [SMTP]: Allow embedding of 图像 ([@partofthething])
* 传感器: [OhmConnect] is now supported ([@robbiet480])
* [panel\_custom][panel_custom] component allows the registering of new 面板 ([@balloob])
* 灯光: New [mqtt\_json][mqtt_json] platform for working with JSON payload ([@corbanmailloux])
* 传感器: New [Fast.com] platform to measure network bandwidth performance ([@nkgilley])
* New [pilight] component to control 433 Mz 设备 ([@DavidLP])
* 传感器: [GPSD] now supported ([@fabaff])

### Hotfix 0.26.1 - August 14

* Fix serial\_pm config validation ([@open-homeautomation])
...
* Media Player 遮盖 art would not work when an API 密码 was set. Thanks to [@maddox] for reporting it and [@balloob] for the fix.

### Backward-incompatible changes

* A new unit system has superseded the temperature unit option in the 核心 配置. For now it is backwards compatible, but you should 更新 soon:
...
[FFMPEG]: /integrations/摄像头.ffmpeg/

[SMTP]: /integrations/smtp

[panel_custom]: /integrations/panel_custom/

[Verisure]: /integrations/verisure#报警-control-面板
...
[mqtt_json]: /integrations/灯光.MQTT
