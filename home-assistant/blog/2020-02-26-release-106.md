...
* Add Minecraft Server 集成 ([@elmurato] - [#30992]) ([minecraft\_server docs][minecraft_server docs]) (new-集成)
...
* Add Tado water\_heater ([@michaelarnauts] - [#30095]) ([tado docs]) (breaking change) (new-platform)
...
* **Danfoss Air** - The names of some danfoss\_air 传感器 include a misspelling of the word Danfoss. This typo has been corrected and you will need to adjust all occurrences respectively. - ([@KasperLK] - [#31344]) ([danfoss\_air docs][danfoss_air docs])
...
* **Météo-France** - Météo-France now supports the 配置 flow and is now available to be added as an 集成 from the 集成 UI! There are no more `monitored_conditions` and all 传感器 will be added automatically. - ([@Quentame] - [#29927]) ([meteo\_france docs][meteo_france docs])
...
* **GreenEye Monitor (GEM)** - Greeneye Monitor temperature readings are now correct (previously they would report as twice the actual value). If you've compensated for this in your 仪表盘 or displays, you'll need to undo that compensation with this 发布. - ([@jkeljo] - [#31896]) ([greeneye\_monitor docs][greeneye_monitor docs])
...
* Don't return coroutine in DLNA/DMR 服务 handler ([@tsvi] - [#32011]) ([dlna\_dmr docs][dlna_dmr docs]) (beta fix)
...
* Fix vizio bug to use 'get' to get volume\_step since it is optional ([@raman325] - [#32151]) ([vizio docs]) (beta fix)
...
* Fixed TypeError with old server versions ([@elmurato] - [#32329]) ([minecraft\_server docs][minecraft_server docs])
* Bump pyeight to 0.1.4 ([@mezz64] - [#32363]) ([eight\_sleep docs][eight_sleep docs])
...
* Fix pushover's ATTR\_RETRY env variable typo ([@axilleas] - [#32440])
...
* Change scan\_interval defaults for Tesla ([@alandtse] - [#31194]) ([tesla docs]) (breaking change)
...
* Bump pytrafikverket to 0.1.6.1 ([@endor-force] - [#30697]) ([trafikverket\_train docs][trafikverket_train docs]) ([trafikverket\_weatherstation docs][trafikverket_weatherstation docs])
* 更新 媒体播放器 and add tests to qualify vizio 集成 for platinum quality score ([@raman325] - [#31187]) ([vizio docs])
* Register on HA stop event to gracefully shutdown HomematicIP Cloud connections ([@SukramJ] - [#31289]) ([homematicip\_cloud docs][homematicip_cloud docs])
...
* Remove Throttle on async\_setup and bump pyvizio 版本 ([@raman325] - [#31337]) ([vizio docs])
...
* Let 核心 resolve entity\_id for lastfm from username ([@inverse] - [#31280]) ([lastfm docs])
* Add totalconnect 区域 as 二元sensor ([@austinmroczek] - [#28712]) ([totalconnect docs]) (new-platform)
* Add Tahoma 门锁 support ([@vlebourl] - [#31311]) ([tahoma docs]) (new-platform)
...
* Add temperature and humidity to xiaomi miio air quality monitor ([@fierland] - [#31287]) ([xiaomi\_miio docs][xiaomi_miio docs])
* Support multiple attachments in signal messenger 集成 ([@bbernhard] - [#31141]) ([signal\_messenger docs][signal_messenger docs])
...
* Add unique\_id to essent 传感器 ([@vanbalken] - [#31408]) ([essent docs])
* Catch 设备 not found in 设备 自动化 ([@balloob] - [#31401]) ([device\_automation docs][device_automation docs])
...
* Add Salt Fiber Box 设备 tracker ([@bjornorri] - [#30986]) (new-集成)
* 升级 alpha\_vantage to 2.1.3 ([@fabaff] - [#31388]) ([alpha\_vantage docs][alpha_vantage docs])
* Search specific train in Nederlandse Spoorwegen ([@gurbyz] - [#28898]) ([nederlandse\_spoorwegen docs][nederlandse_spoorwegen docs])
* Enable SUPPORT\_VOLUME\_STEP ([@Cloudenius] - [#31023]) ([pioneer docs])
...
* Add guard clause for discovery\_info to tahoma platforms ([@vlebourl] - [#31434]) ([tahoma docs])
...
* Fix issues with Ambient PWS dispatcher topic ([@bachya] - [#31439]) ([ambient\_station docs][ambient_station docs])
* Add missing await to HMIPC ([@SukramJ] - [#31415]) ([homematicip\_cloud docs][homematicip_cloud docs])
* Add timeout 属性 for send files ([@Konsts] - [#31379]) ([telegram\_bot docs][telegram_bot docs])
* Fix misspelled 传感器 names ([@KasperLK] - [#31344]) ([danfoss\_air docs][danfoss_air docs]) (breaking change)
...
* Add config flow to Meteo-France ([@Quentame] - [#29927]) ([meteo\_france docs][meteo_france docs]) (breaking change)
* 日志 警告 when 实体 referenced in 服务 call not found ([@balloob] - [#31427]) (breaking change)
* Use 实体.async\_request\_call in 服务 助手 ([@balloob] - [#31454])
* Add brightness\_step to 灯光.turn\_on ([@balloob] - [#31452]) ([灯光 docs]) (breaking change)
* deCONZ - Revert from using disabled\_by when setting options ([@Kane610] - [#31446]) ([deconz docs])
...
* Unregister listener for stats 传感器 with max\_age ([@azogue] - [#31580]) ([statistics docs])
* Add Minecraft Server 集成 ([@elmurato] - [#30992]) ([minecraft\_server docs][minecraft_server docs]) (new-集成)
* Extract 服务 from init.py for HomematicIP Cloud ([@SukramJ] - [#31376]) ([homematicip\_cloud docs][homematicip_cloud docs])
...
* Use slug in ping 设备 tracker config validation ([@springstan] - [#31329]) ([ifttt docs]) ([media\_extractor docs][media_extractor docs]) ([onewire docs]) ([ping docs])
* Handle missing next train from NS ([@YarmoM] - [#31626]) ([nederlandse\_spoorwegen docs][nederlandse_spoorwegen docs])
* Remove stray 调试 from unifi 集成 ([@CHAZICLE] - [#31634]) ([unifi docs])
* Add Abode water valve support ([@shred86] - [#30635]) ([abode docs])
* 设备 tracker 实体 based on GPS should always publish updates ([@balloob] - [#31551]) ([device\_tracker docs][device_tracker docs])
* Hue to retry if hub 错误 out ([@balloob] - [#31616]) ([hue docs])
* Bump insteonplm to 0.16.7 ([@teharris1] - [#31645]) ([insteon docs])
* Only auth on enter\_learning in response to 错误 for broadlink ([@bmfurtado] - [#27341]) ([broadlink docs])
* Add unique ID to edimax 开关 ([@andersonshatch] - [#27984]) ([edimax docs])
* Added 区域 type Technical as power. ([@crallian] - [#31611]) ([spc docs])
* Add recorder vars db\_max\_retries and db\_retry\_wait ([@TechnicallyJoe] - [#31561]) ([recorder docs])
...
* Add brightness 灯光 设备 动作 ([@balloob] - [#31567]) ([device\_automation docs][device_automation docs]) ([灯光 docs])
* Fix Météo-France I/O while testing ([@Quentame] - [#31695]) ([meteo\_france docs][meteo_france docs])
* Bump velbus 版本 + load velbus module names into 设备 info ([@Cereal2nd] - [#31664]) ([velbus docs])
* Vicare water\_heater set\_temperature fix and bump PyVicare to 0.1.7 ([@oischinger] - [#31672]) ([vicare docs])
* Add MELCloud 集成 ([@vilppuvuorinen] - [#30712]) ([melcloud docs]) (new-集成)
* Dynalite 集成 ([@ziv1234] - [#27841]) ([dynalite docs]) (new-集成)
...
* Fix set volume level ([@maxcanna] - [#31731]) ([frontier\_silicon docs][frontier_silicon docs])
...
* Improve Huawei LTE timeouting/stalling request behavior ([@scop] - [#31710]) ([huawei\_lte docs][huawei_lte docs])
* Refresh the august access token when needed ([@bdraco] - [#31735]) ([august docs])
* Add new Webhook 动作 to allow enabling encryption in an exis… ([@robbiet480] - [#31743]) ([mobile\_app docs][mobile_app docs])
...
* Add initial 版本 of Vilfo Router 集成 ([@ManneW] - [#31177]) ([vilfo docs]) (new-集成)
* Whitelist shopping list updated event ([@balloob] - [#31742]) ([websocket\_api docs][websocket_api docs])
* Add 设备 name to 传感器 name for mobile\_app ([@dshokouhi] - [#31756]) ([mobile\_app docs][mobile_app docs])
...
* Fix spelling of NETGEAR and CalDAV in manifests ([@frenck] - [#31790]) ([caldav docs]) ([netgear docs]) ([netgear\_lte docs][netgear_lte docs])
...
* Remove force from async\_schedule\_update\_ha\_state for HMIPC ([@SukramJ] - [#31796]) ([homematicip\_cloud docs][homematicip_cloud docs])
...
* Limit translations\_develop to an 集成 ([@balloob] - [#31804])
* Annotate more async functions correctly ([@balloob] - [#31802]) ([coolmaster docs]) ([esphome docs]) ([homekit\_controller docs][homekit_controller docs]) ([mysensors docs]) ([sonos docs]) ([starline docs]) ([upnp docs])
* Fire HASS events on SimpliSafe events ([@bachya] - [#31811]) ([simplisafe docs])
* Change multi\_select config validator to class ([@Kane610] - [#31828])
* Remove energy 传感器 from incompatible Ata 设备 ([@vilppuvuorinen] - [#31831]) ([melcloud docs])
* Add turn\_on\_action 配置 variable ([@maxcanna] - [#31792]) ([lg\_netcast docs][lg_netcast docs])
* Bump pillow to 7.0 ([@robmarkcole] - [#31847]) ([doods docs]) ([proxy docs]) ([qrcode docs]) ([seven\_segments docs][seven_segments docs]) ([tensorflow docs])
* Simplify missing Garmin Connect data handling, mark 实体 un/available ([@scop] - [#31718]) ([garmin\_connect docs][garmin_connect docs])
* Add Tado water\_heater ([@michaelarnauts] - [#30095]) ([tado docs]) (breaking change) (new-platform)
* Revert "Check netgear device\_tracker link\_rate to ensure 设备 is connected" ([@MartinHjelmare] - [#31855]) ([netgear docs])
* 助手 typing improvements ([@scop] - [#31865])
* Improve media name detection on lg\_netcast ([@maxcanna] - [#31863]) ([lg\_netcast docs][lg_netcast docs])
...
* Add support for displaying Daf Yomi ([@moshekaplan] - [#30628]) ([jewish\_calendar docs][jewish_calendar docs])
* Use new custom\_serializer ([@jjlawren] - [#31871]) ([config docs])
...
* Add rainforest\_eagle support for legacy hardware ([@jcalbert] - [#28082]) ([rainforest\_eagle docs][rainforest_eagle docs])
...
* Adjust tests after speed up to 恢复 coverage for HomematicIP Cloud ([@SukramJ] - [#31836]) ([homematicip\_cloud docs][homematicip_cloud docs])
* 升级 python-velbus to 2.0.41 ([@Cereal2nd] - [#31875])
* Type hint improvements ([@scop] - [#31876]) ([elgato docs]) ([esphome docs]) ([iaqualink docs]) ([nsw\_rural\_fire\_service\_feed docs][nsw_rural_fire_service_feed docs]) ([遥控器 docs]) ([wled docs])
* Bump adafruit-blinka and adafruit-circuitpython-mcp230xx ([@jardiamj] - [#31845]) ([mcp23017 docs])
* 更新 nederlandse\_spoorwegen to properly handle punctuality ([@Squixx] - [#31741]) ([nederlandse\_spoorwegen docs][nederlandse_spoorwegen docs])
* Add timestamp to lg\_netcast media\_image\_url to 更新 图像 correctly ([@laszlojakab] - [#30933]) ([lg\_netcast docs][lg_netcast docs])
* Clean up netgear 设备 tracker ([@MartinHjelmare] - [#31861]) ([netgear docs])
* Activate Stale bot for PR's ([@frenck] - [#31837])
* Fix check\_real location guard ([@MartinHjelmare] - [#31890])
* Clean soundtouch ([@MartinHjelmare] - [#31888]) ([soundtouch docs])
* Fix bugs in greeneye\_monitor voltage reporting ([@jkeljo] - [#31895]) ([greeneye\_monitor docs][greeneye_monitor docs])
* 升级 greeneye\_monitor to 2.0 ([@jkeljo] - [#31896]) ([greeneye\_monitor docs][greeneye_monitor docs]) (breaking change)
* prevent dev\_id being permanently assigned as config\_name ([@mueslo] - [#31886]) ([device\_tracker docs][device_tracker docs])
* 升级 youtube\_dl to 版本 2020.02.16 ([@BKPepe] - [#31905]) ([media\_extractor docs][media_extractor docs])
* 升级 aiohue ([@balloob] - [#31903]) ([hue docs])
* Add POD support, sleep fitness 传感器 to EightSleep ([@mezz64] - [#31874]) ([eight\_sleep docs][eight_sleep docs])
* Add logger name to system 日志 ([@balloob] - [#31902]) ([system\_log docs][system_log docs])
* Allow specifying an icon for a 场景 ([@balloob] - [#31898]) ([homeassistant docs])
* Add icons to 脚本 ([@balloob] - [#31899]) ([脚本 docs])
* Bump dependency to 0.10.17 for HomematicIP Cloud ([@SukramJ] - [#31911]) ([homematicip\_cloud docs][homematicip_cloud docs])
...
* Remove duke\_energy 集成 (ADR-0004) ([@frenck] - [#31921]) (breaking change)
* Updated 前端 to 20200217.0 ([@bramkragten] - [#31922]) ([前端 docs])
* Add async\_unload\_entry to iCloud ([@Quentame] - [#31917]) ([icloud docs])
* Add an options flow to demo ([@bramkragten] - [#31920]) ([demo docs])
* Bump aio\_geojson\_geonetnz\_quakes to 0.12 ([@exxamalte] - [#31930]) ([geonetnz\_quakes docs][geonetnz_quakes docs])
* Fix translations\_develop ([@austinmroczek] - [#31942])
* Bump aio\_geojson\_nsw\_rfs\_incidents to 0.3 ([@exxamalte] - [#31941]) ([nsw\_rural\_fire\_service\_feed docs][nsw_rural_fire_service_feed docs])
* Bump pyps4-2ndscreen to 1.0.7 ([@ktnrg45] - [#31943]) ([ps4 docs])
* Add pigpio 遥控器 functionality ([@Poeschl] - [#31667]) ([rpi\_gpio\_pwm docs][rpi_gpio_pwm docs])
* Fix 实体 registry not saving name/icon ([@balloob] - [#31932])
* Untag discovery as an allowed dependency ([@balloob] - [#31934]) ([apple\_tv docs][apple_tv docs]) ([freebox docs]) ([octoprint docs]) ([roku docs]) ([sabnzbd docs]) ([xiaomi\_aqara docs][xiaomi_aqara docs]) ([yeelight docs])
...
* Add support for MQTT 设备 触发器 ([@emontnemery] - [#31679]) ([device\_automation docs][device_automation docs]) ([MQTT docs])
...
* 升级 to bimmer\_connected 0.7.1 to fix US and China access ([@gerard33] - [#31968]) ([bmw\_connected\_drive docs][bmw_connected_drive docs])
...
* Add new 设备 to HomematicIP Cloud ([@SukramJ] - [#31914]) ([homematicip\_cloud docs][homematicip_cloud docs])
* Add shutter group to HomematicIP Cloud ([@SukramJ] - [#31916]) ([homematicip\_cloud docs][homematicip_cloud docs])
