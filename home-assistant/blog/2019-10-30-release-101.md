...
<a href='/home-assistant/integrations/#版本/0.101'><img src='/home-assistant/images/blog/2019-10-0.101/components.png' style='border: 0;box-shadow: none;'></a>
...
通过 HTTP 配置来设置 API 密码和 Trusted Networks 认证提供程序的支持也已经移除。现在需要在认证提供程序部分中进行配置（[文档](https://www.home-assistant.io/docs/authentication/providers/)）。

所谓直接认证，是指你可以不使用 bearer token，仅通过从受信任网络发起请求，或在 URL 中追加 `?api_password=X` 的方式来完成认证请求。

这些功能仍然可以作为认证提供程序使用（[文档](https://www.home-assistant.io/docs/authentication/providers/)）。

你可以使用长期有效访问令牌，它们可以在前端的个人资料页面中创建。这些令牌不会过期，并且可以加入到请求头中。更多信息请参阅开发者文档。

<p class='img'>
<img src='/home-assistant/images/blog/2019-10-0.101/long-lived-access-tokens.png' alt='Screenshot of the Long-Lived Access Tokens interface in the profile page.'></a>
个人资料页面中的长期有效访问令牌界面截图。
</p>

或者，你也可以使用基于 Webhook 的集成。Webhook 是一个难以猜测的唯一 URL，可用于向 Home Assistant 发送数据。发送到 Webhook 的请求不需要认证。
你的 Webhook 需要可以从互联网访问；如果你订阅了云服务，云端会帮你处理这件事。你可以在云配置页面中找到云端 Webhook URL。

## Hassbian

你可能已经看到了，我们将逐步停止维护 Hassbian。

Hassbian 是在 Raspbian 基础上为 Home Assistant 优化的一个发行版。由于开发者时间有限，再加上 [Hass.io](https://www.home-assistant.io/hassio/) 这类更简单的替代方案已经出现，现在是时候让 Hassbian 退场了。

衷心感谢所有参与 Hassbian 项目的人，特别是长期推动这个项目的 [@landrash](https://github.com/landrash)，以及 [@ludeeus](https://github.com/ludeeus)。

更多信息，请阅读这篇[博客文章](https://www.home-assistant.io/博客/2019/10/26/rip-hassbian/)。
...
<p class='img'>
<img src='/home-assistant/images/blog/2019-10-0.101/device_automation_duration.png' alt='Screenshot of a 设备 触发器 with duration.'></a>
Screenshot of a 设备 触发器 with duration.
</p>

## 前端

前端这边也发生了很多变化；我们收到了大量来自 Hacktoberfest 的 PR，为前端加入了本地化支持，也进一步改善了用户体验。
特别感谢 [@springstan](https://github.com/springstan)，他完成了大量本地化工作。现在，我们的绝大部分界面都已经可以翻译了！

非常感谢所有贡献者！

多亏了 [@timmo001](https://github.com/timmo001)，我们现在有了自己的确认对话框！再也不用面对难看的浏览器原生弹窗了。

<p class='img'>
<img src='/home-assistant/images/blog/2019-10-0.101/confirm_dialog.png' alt='Screenshot of a confirm dialog when restarting Home Assistant.'></a>
...
<p class='img'>
<img src='/home-assistant/images/blog/2019-10-0.101/yaml_editor.png' alt='Screenshot of the 服务 dev tools with YAML editor.'></a>
...
<p class='img'>
<img src='/home-assistant/images/blog/2019-10-0.101/entity_registry_data_table.png' alt='Screenshot of the 实体 registry data table.'></a>
实体注册表数据表格截图。
</p>
...
<p class='img'>
<img src='/home-assistant/images/blog/2019-10-0.101/device_automation_device_picker.png' alt='Screenshot of the 设备 picker.'></a>
设备选择器截图。
</p>

[mdonoughe](https://github.com/mdonoughe) 在自动化编辑器中加入了“激活场景”动作的支持。

## Lovelace

所有变更请查看 [Lovelace 更新日志](https://www.home-assistant.io/Lovelace/changelog/)。

## 其他消息

<blockquote class="twitter-tweet"><p lang="en" dir="ltr">Proud to announce that the Visual Studio Code 插件 for <a href="https://twitter.com/home_assistant?ref_src=twsrc%5Etfw">@home_assistant</a> reached v1.0.0! 🎉<br><br>This 版本 ships the second generation code-server, VSCode 1.39, HA extension 1.3, updates MDI ext and adds a rainbow indent function ❤️<br><br>Oh, and it is FAST 🚀 <a href="https://t.co/eBe8CirZ4B">pic.twitter.com/eBe8CirZ4B</a></p>&mdash; Franck Nijhof (@Frenck) <a href="https://twitter.com/Frenck/status/1188044714571907072?ref_src=twsrc%5Etfw">October 26, 2019</a></blockquote>
...
<blockquote class="twitter-tweet"><p lang="en" dir="ltr">Weekend IOT project: 天气 info from the Cloud, literally. Details on github here:<a href="https://t.co/V9xpxqyRAv">https://t.co/V9xpxqyRAv</a><a href="https://twitter.com/hashtag/homeassistant?src=hash&amp;ref_src=twsrc%5Etfw">#homeassistant</a> <a href="https://twitter.com/hashtag/arduino?src=hash&amp;ref_src=twsrc%5Etfw">#arduino</a> <a href="https://twitter.com/hashtag/MQTT?src=hash&amp;ref_src=twsrc%5Etfw">#MQTT</a> <a href="https://twitter.com/hashtag/smarthome?src=hash&amp;ref_src=twsrc%5Etfw">#smarthome</a> <a href="https://t.co/YrkEBpa9Rw">pic.twitter.com/YrkEBpa9Rw</a></p>&mdash; Gabe Scelta (@sfgabe) <a href="https://twitter.com/sfgabe/status/1183871117972430848?ref_src=twsrc%5Etfw">October 14, 2019</a>
</blockquote>

<blockquote class="twitter-tweet"><p lang="en" dir="ltr">🎉Restriction 卡片 for <a href="https://twitter.com/home_assistant?ref_src=twsrc%5Etfw">@home_assistant</a> released 🎉<br>Client-side security for your Lovelace 卡片<br>* Options to hide/block/门锁/密码-protect/confirm interactions with 卡片<br>* Set 条件 for when to apply<br>* Set exemptions based on 用户<a href="https://t.co/psiVBf9U7N">https://t.co/psiVBf9U7N</a></p>&mdash; Ian Richardson (@iantrich) <a href="https://twitter.com/iantrich/status/1184849711527874561?ref_src=twsrc%5Etfw">October 17, 2019</a>
</blockquote>
...
* Bump env\_canada to fixed 0.0.29 版本 ([@shmick] - [#28360]) ([environment\_canada docs][environment_canada docs])
* Fix Airly asyncio timeout 错误 ([@bieniu] - [#28387]) ([airly docs])
* Fix hdate spamming homeassistant 日志 ([@tsvi] - [#28392]) ([jewish\_calendar docs][jewish_calendar docs])
...
* Use server-specific unique\_ids for Plex 媒体播放器 ([@jjlawren] - [#28447]) ([plex docs])
* Also 安装 after\_deps ([@balloob] - [#28453])
...
* Add deprecated 属性 to 灯光.reproduce\_state ([@Santobert] - [#28557]) ([灯光 docs])
...
* **Removed** - The following 集成 have been removed:
  * **Direct 认证 via trusted networks or API password** - It is no longer possible to make authenticated requests using trusted networks or by appending ?api\_password=X to the URL. You will now first need to get an 认证 token and use that token to make requests. Auth providers for trusted networks and API passwords are still available. - ([@balloob] - [#27656]) ([auth docs]) ([http docs]) ([websocket\_api docs][websocket_api docs])
...
* **Genius Hub** - This addresses an issue that requires the `unique_id` of **温控** and **water\_heater** 实体 to be changed. After upgrading HA with this change, 用户 will have stale 实体 in the 实体 registry that they may wish to clear out. -  ([@zxdavb] - [#27916]) ([geniushub docs])
...
* **Jewish Calendar**
  * The output of the timestamp 传感器 have been streamlined, so they're easier to use in 自动化. All the timestamp 传感器 will return UTC time in ISO 8601 format.
    属性 have been added to get a UNIX timestamp. -  ([@tsvi] - [#26940]) ([jewish\_calendar docs][jewish_calendar docs])
  * The holiday type 传感器 has been removed and added as an 属性 to the holiday 传感器.
    The **holiday name** 传感器 has been renamed to **holiday**. ([@tsvi] - [#27654]) ([jewish\_calendar docs][jewish_calendar docs]) (breaking change)
...
* **Onkyo** - Added `max_receiver_volume`, which sets the maximum volume of the receiver - this will default to 80, which worked with older Onkyo models. See 文档 for details on how to find your receivers' max volume.
  ...
  The max\_volume is now a percentage instead of a number from 0 to 80. If you have a `max_volume` setting of 80, you will need to change this to 100, if you have it as 40 you will need to change this to 50. To work out the new max volume setting use this formula: `( / 80) * 100` - ([@foxy82] - [#27218]) ([onkyo docs])
...
* **Tesla** - Tesla `entity_id` and `unique_id` have changed. This is necessary so that multi-vehicle households have a way to distinguish vehicles by basing the name off the name in the app. 用户 should remove old tesla entries from the 实体 registry after the 升级 and 更新 自动化 where tesla entity\_ids are used. - ([@alandtse] - [#27957]) ([tesla docs])
...
* Add unique\_id to cert\_expiry ([@jjlawren] - [#27140]) ([cert\_expiry docs][cert_expiry docs])
...
* Add support for `for` to binary\_sensor, 灯光 and 开关 设备 条件 ([@emontnemery] - [#27153]) ([binary\_sensor docs][binary_sensor docs]) ([device\_automation docs][device_automation docs]) ([灯光 docs]) ([开关 docs])
* Unload cert\_expiry config entries ([@jjlawren] - [#27150]) ([cert\_expiry docs][cert_expiry docs])
...
* Add Airly 集成 ([@bieniu] - [#26375]) ([airly docs]) (new-集成)
* Add SecurityPanelController for alarm\_control\_panel to alexa ([@ochlocracy] - [#27081]) ([alexa docs])
...
* Fix 模板 风扇 turn\_on 动作 ([@sermayoral] - [#27181]) ([模板 docs])
* Fix tests running in hass.io 图像 ([@balloob] - [#27169])
* 门锁 open 服务 data ([@Santobert] - [#27204])
* Add acceleration 传感器 to Homematic IP Cloud ([@SukramJ] - [#27199]) ([homematicip\_cloud docs][homematicip_cloud docs])
* lock\_reproduce\_state ([@Santobert] - [#27203]) ([门锁 docs])
* 开关 reproduce 状态 ([@Santobert] - [#27202]) ([开关 docs])
* Add turn\_on method to ecobee 温控 platform ([@marthoc] - [#27103]) ([ecobee docs]) (breaking change)
* Add opentherm\_gw config flow ([@mvn23] - [#27148]) ([opentherm\_gw docs][opentherm_gw docs])
...
* automation\_reproduce\_state ([@Santobert] - [#27222]) ([自动化 docs])
* Add set\_location 服务 doc ([@oncleben31] - [#27216])
* fan\_reproduce\_state ([@Santobert] - [#27227]) ([风扇 docs])
...
* Repair SolarEdge\_local inverter fahrenheit temperature ([@scheric] - [#27096]) ([solaredge\_local docs][solaredge_local docs])
* add 脚本 shortcut for activating 场景 ([@mdonoughe] - [#27223])
* Bump python-miio 版本 to 0.4.6 ([@syssi] - [#27231]) ([xiaomi\_miio docs][xiaomi_miio docs])
* Add Xiaomi Air 加湿器 CB1 (zhimi.加湿器.cb1) support ([@syssi] - [#27232]) ([xiaomi\_miio docs][xiaomi_miio docs])
* Add io:SomfyBasicContactIOSystemSensor to TaHoma component ([@jensihnow] - [#27234]) ([tahoma docs])
* Add basic test support to Homematic IP Cloud ([@SukramJ] - [#27228]) ([homematicip\_cloud docs][homematicip_cloud docs])
...
* Add 'flash\_length' to esphome 灯光 async\_turn\_off ([@CQoute] - [#27214]) ([esphome docs])
* Add missing 文档 for some Hassio 服务 ([@oncleben31] - [#27215])
* Validate generated 条件 ([@emontnemery] - [#27263]) ([binary\_sensor docs][binary_sensor docs]) ([device\_automation docs][device_automation docs]) ([灯光 docs]) ([传感器 docs]) ([开关 docs])
* Add 属性 to neato 集成 ([@Santobert] - [#27260]) ([neato docs])
* Add PTZ support to Foscam 摄像头 component ([@skgsergio] - [#27238]) ([foscam docs])
* Note snake\_case 状态 属性 name convention in 实体 docs ([@scop] - [#27287])
...
* Validate generated 设备 触发器 ([@emontnemery] - [#27264]) ([binary\_sensor docs][binary_sensor docs]) ([deconz docs]) ([device\_automation docs][device_automation docs]) ([传感器 docs]) ([zha docs])
...
* move import to top-level ([@exxamalte] - [#27314]) ([transport\_nsw docs][transport_nsw docs])
* Move imports in geo\_rss\_events component ([@exxamalte] - [#27313]) ([geo\_rss\_events docs][geo_rss_events docs])
...
* Fix Logi Circle 摄像头 not responding to 打开/off commands ([@evanjd] - [#27317]) ([logi\_circle docs][logi_circle docs])
* Add 场景.apply 服务 ([@balloob] - [#27298])
* Improve Neato login process ([@Santobert] - [#27327]) ([neato docs])
* Validate generated 设备 动作 ([@emontnemery] - [#27262]) ([device\_automation docs][device_automation docs]) ([zha docs])
* Cleanup handling of 属性 for HomematicIP Cloud ([@SukramJ] - [#27331]) ([homematicip\_cloud docs][homematicip_cloud docs])
* Include unit\_of\_measurement in 传感器 设备 触发器 capabilities ([@emontnemery] - [#27265]) ([传感器 docs])
...
* Add 文档 for logger.set\_level 服务 ([@oncleben31] - [#27211])
...
* 安装 requirements for all deps with tests ([@balloob] - [#27362]) ([epsonworkforce docs]) ([ign\_sismologia docs][ign_sismologia docs]) ([supla docs])
...
* Move imports in nissan\_leaf component ([@Quentame] - [#27359]) ([nissan\_leaf docs][nissan_leaf docs])
...
* Allow Google Assistant relative volume control ([@RyanEwen] - [#26585]) ([google\_assistant docs][google_assistant docs])
* Remove hipchat ([@fabaff] - [#27399]) (breaking change)
* Move imports in waze\_travel\_time component ([@eifinger] - [#27384]) ([waze\_travel\_time docs][waze_travel_time docs])
...
* Move imports in yamaha + yamaha\_musiccast component ([@Quentame] - [#27389]) ([yamaha docs]) ([yamaha\_musiccast docs][yamaha_musiccast docs])
...
* Move imports in google\_travel\_time component ([@eifinger] - [#27381]) ([google\_travel\_time docs][google_travel_time docs])
* Move imports in github component ([@mnigbur] - [#27406]) ([github docs])
* Move imports in eufy component ([@mnigbur] - [#27405]) ([eufy docs])
* Move imports in apple\_tv component ([@Quentame] - [#27356]) ([apple\_tv docs][apple_tv docs])
* Remove hydroquebec 集成 (ADR-0004) ([@frenck] - [#27407])
* Standardize times in time 传感器 Jewish 日历 ([@tsvi] - [#26940]) ([jewish\_calendar docs][jewish_calendar docs]) (breaking change)
* Revert "Allow Google Assistant relative volume control (#26585)" ([@balloob] - [#27416]) ([google\_assistant docs][google_assistant docs])
...
* Refactor home --> hap for Homematic IP Cloud ([@SukramJ] - [#27368]) ([homematicip\_cloud docs][homematicip_cloud docs])
...
* Move imports in acer\_projector component ([@Bouni] - [#27456]) ([acer\_projector docs][acer_projector docs])
* Move imports in vizio component ([@Quentame] - [#27452]) ([vizio docs])
* Bump pygatt to 4.0.5 ([@foreign-sub] - [#27526]) ([bluetooth\_le\_tracker docs][bluetooth_le_tracker docs]) ([skybeacon docs])
...
* Add improved 场景 support to input number 集成 ([@abstrakct] - [#27530]) ([input\_number docs][input_number docs])
...
* moved imports to top level ([@Bouni] - [#27512]) ([bt\_home\_hub\_5 docs][bt_home_hub_5 docs])
* Add test to Homematic IP Cloud 温控 ([@SukramJ] - [#27472]) ([homematicip\_cloud docs][homematicip_cloud docs])
...
* moved imports to top level ([@Bouni] - [#27503]) ([bluetooth\_le\_tracker docs][bluetooth_le_tracker docs])
...
* Move AmazonPolly imports ([@tulindo] - [#27443]) ([amazon\_polly docs][amazon_polly docs])
...
* Bump RtmAPI to 0.7.2 ([@quthla] - [#27433]) ([remember\_the\_milk docs][remember_the_milk docs])
* Move imports in watson\_iot component ([@Quentame] - [#27448]) ([watson\_iot docs][watson_iot docs])
...
* 升级 alpha\_vantage to 2.1.1 ([@fabaff] - [#27580]) ([alpha\_vantage docs][alpha_vantage docs])
* Move imports in thermoworks\_smoke component ([@Michsior14] - [#27586]) ([thermoworks\_smoke docs][thermoworks_smoke docs])
* 升级 pillow to 6.2.0 ([@fabaff] - [#27581]) ([image\_processing docs][image_processing docs]) ([proxy docs]) ([qrcode docs])
* Move import in deutsche\_bahn 集成 ([@springstan] - [#27579]) ([deutsche\_bahn docs][deutsche_bahn docs])
* Move imports in thingspeak component ([@Michsior14] - [#27585]) ([thingspeak docs])
* Move imports in tplink\_lte component ([@Michsior14] - [#27583]) ([tplink\_lte docs][tplink_lte docs])
...
* add content for 服务.yaml in component media\_extractor ([@Mofeywalker] - [#27608])
...
* Google Assistant Local SDK ([@balloob] - [#27428]) ([cloud docs]) ([google\_assistant docs][google_assistant docs]) ([http docs]) ([Webhook docs]) ([zeroconf docs])
...
* 更新 yandex transport after api change ([@rishatik92] - [#27591]) ([yandex\_transport docs][yandex_transport docs])
...
* move imports in synology\_srm component ([@Michsior14] - [#27603]) ([synology\_srm docs][synology_srm docs])
* moved imports to top level ([@Bouni] - [#27632]) ([bt\_smarthub docs][bt_smarthub docs])
* moved imports to top level ([@Bouni] - [#27634]) ([cisco\_ios docs][cisco_ios docs])
...
* Typing misc fixes ([@scop] - [#27543]) ([binary\_sensor docs][binary_sensor docs]) ([device\_automation docs][device_automation docs]) ([灯光 docs]) ([传感器 docs]) ([开关 docs])
* Updated 前端 to 20191014.0 ([@bramkragten] - [#27661]) ([前端 docs])
* Move imports in panasonic\_viera component ([@javicalle] - [#27665]) ([panasonic\_viera docs][panasonic_viera docs])
* Improve discovery title ([@Kane610] - [#27664]) ([deconz docs])
* Move imports in panasonic\_bluray component ([@javicalle] - [#27658]) ([panasonic\_bluray docs][panasonic_bluray docs])
...
* Move imports in steam\_online component ([@Michsior14] - [#27648]) ([steam\_online docs][steam_online docs])
...
* Remove direct 认证 via trusted networks or API 密码 ([@balloob] - [#27656]) ([auth docs]) ([http docs]) ([websocket\_api docs][websocket_api docs]) (breaking change)
* Add Apprise 通知 集成 ([@caronc] - [#26868]) ([apprise docs]) (new-集成)
...
* moved imports to top level ([@Bouni] - [#27677]) ([digital\_ocean docs][digital_ocean docs])
* Handle marker attrs that may not exist ([@bwarden] - [#27519]) ([cups docs])
* Improve code coverage for HomematicIP Cloud ([@SukramJ] - [#27606]) ([homematicip\_cloud docs][homematicip_cloud docs])
* Move imports in decora component ([@Bouni] - [#27645]) ([decora docs])
* moved imports to top level ([@Bouni] - [#27683]) ([dlib\_face\_detect docs][dlib_face_detect docs])
...
* moved imports to top level ([@Bouni] - [#27693]) ([dlib\_face\_identify docs][dlib_face_identify docs])
* 更新 fritzconnection requirement to 0.8.4 ([@AaronDavidSchneider] - [#27698]) ([fritz docs]) ([fritzbox\_netmonitor docs][fritzbox_netmonitor docs])
...
* Add improved 场景 support to input\_text ([@abstrakct] - [#27687]) ([input\_text docs][input_text docs])
* Fix config imports ([@balloob] - [#27669]) ([config docs])
* Add improved 场景 support for input\_select ([@abstrakct] - [#27697]) ([input\_select docs][input_select docs])
* move imports in sony\_projector component ([@Michsior14] - [#27718]) ([sony\_projector docs][sony_projector docs])
...
* Moved imports to top-level in fritzbox\_callmonitor component ([@springstan] - [#27705]) ([fritzbox\_callmonitor docs][fritzbox_callmonitor docs])
* moved imports to top level ([@Bouni] - [#27696]) ([dovado docs])
* New 传感器 platform 集成 for Orange and Rockland Utility smart energy meter ([@bvlaicu] - [#27571]) ([oru docs]) (new-集成)
* Move imports in device\_tracker component ([@Bouni] - [#27676]) ([device\_tracker docs][device_tracker docs])
* Add evohome high\_precision temperatures ([@zxdavb] - [#27513]) ([evohome docs])
...
* Bump ndms2-client to 0.0.10 ([@foxel] - [#27734]) ([keenetic\_ndms2 docs][keenetic_ndms2 docs])
* 升级 youtube\_dl to 2019.10.16 ([@BKPepe] - [#27737]) ([media\_extractor docs][media_extractor docs])
* Axis - Improve discovery title by adding placeholder support ([@Kane610] - [#27663]) ([axis docs])
* Add 设备 动作 support to the alarm\_control\_panel 集成 ([@emontnemery] - [#27616]) ([alarm\_control\_panel docs][alarm_control_panel docs]) ([device\_automation docs][device_automation docs])
...
* bump rpi.gpio to 0.7.0 ([@Misiu] - [#27753]) ([mcp23017 docs]) ([rpi\_gpio docs][rpi_gpio docs])
* Move imports in rpi\_gpio ([@Misiu] - [#27752]) ([rpi\_gpio docs][rpi_gpio docs])
* Move imports in ifttt component ([@Quentame] - [#27792]) ([ifttt docs])
* Move imports in keyboard component ([@Quentame] - [#27791]) ([keyboard docs])
* Move imports in linux\_battery component ([@Quentame] - [#27789]) ([linux\_battery docs][linux_battery docs])
...
* Move imports in imap + imap\_email\_content component ([@Quentame] - [#27793]) ([imap docs]) ([imap\_email\_content docs][imap_email_content docs])
* Move imports in netgear\_lte component ([@Quentame] - [#27777]) ([netgear\_lte docs][netgear_lte docs])
...
* moved imports to top level ([@Bouni] - [#27782]) ([aladdin\_connect docs][aladdin_connect docs])
* Move imports in android\_ip\_webcam component ([@Bouni] - [#27797]) ([android\_ip\_webcam docs][android_ip_webcam docs])
* Add on\_off\_inverted to KNX 温控 ([@tombbo] - [#25900]) ([knx docs])
* Move imports in html5 component ([@Quentame] - [#27473]) ([html5 docs])
* Move imports in MQTT component ([@exxamalte] - [#27835]) ([MQTT docs]) (new-platform)
* Move imports in august component ([@Bouni] - [#27810]) ([august docs])
* Move imports in asterisk\_mbox component ([@Bouni] - [#27807]) ([asterisk\_mbox docs][asterisk_mbox docs])
...
* Move imports in gitlab\_ci component ([@Quentame] - [#27827]) ([gitlab\_ci docs][gitlab_ci docs])
...
* Move imports in flux\_led component ([@Quentame] - [#27822]) ([flux\_led docs][flux_led docs])
* Move imports in fritz + fritzbox\_netmonitor component ([@Quentame] - [#27823]) ([fritz docs])
* Move imports in MCP23017 component ([@Misiu] - [#27769]) ([mcp23017 docs])
* Move imports in anel\_pwrctrl component ([@Bouni] - [#27798]) ([anel\_pwrctrl docs][anel_pwrctrl docs])
* Move imports in bbb\_gpio component ([@Bouni] - [#27813]) ([bbb\_gpio docs][bbb_gpio docs])
* Move imports in bitcoin component ([@Bouni] - [#27814]) ([bitcoin docs])
* bump client ([@zxdavb] - [#27799]) ([geniushub docs])
* Move imports in telegram\_bot component ([@Quentame] - [#27785]) ([telegram\_bot docs][telegram_bot docs])
* Add 设备 动作 support to the 门锁 集成 ([@emontnemery] - [#27499]) ([门锁 docs])
* Add grid 传感器 to SolarEdge\_local ([@scheric] - [#27247]) ([solaredge\_local docs][solaredge_local docs])
...
* Add device\_info to HomematicIP 温控 and acp ([@SukramJ] - [#27771]) ([homematicip\_cloud docs][homematicip_cloud docs])
* Add opentherm\_gw options flow. ([@mvn23] - [#27316]) ([opentherm\_gw docs][opentherm_gw docs])
* Add ability for MQTT 设备 tracker to map non-default topic payloads to 区域/状态 ([@raman325] - [#27143]) ([MQTT docs])
* Move holiday info into a single 传感器 with multiple attributess ([@tsvi] - [#27654]) ([jewish\_calendar docs][jewish_calendar docs]) (breaking change)
* Add sinch 集成 (通知 component) ([@bendikrb] - [#26502]) ([sinch docs]) (new-集成)
...
* Move imports in bmw\_connected\_drive component ([@Bouni] - [#27853]) ([bmw\_connected\_drive docs][bmw_connected_drive docs])
...
* Refactor the conversation 集成 ([@balloob] - [#27839]) ([conversation docs]) ([shopping\_list docs][shopping_list docs])
* Use pre-commit in CI and tox ([@scop] - [#27743])
* Introduce new OAuth2 config flow 助手 ([@balloob] - [#27727]) ([somfy docs]) (breaking change)
* Move imports in fritzbox, fritz 设备 tracker, fritzdect, fritzbox netmonitor ([@springstan] - [#27746]) ([fritz docs]) ([fritzbox docs]) ([fritzbox\_netmonitor docs][fritzbox_netmonitor docs])
* Move imports in cppm\_tracker component ([@Bouni] - [#27889]) ([cppm\_tracker docs][cppm_tracker docs])
...
* Move imports in cisco\_webex\_teams component ([@Bouni] - [#27878]) ([cisco\_webex\_teams docs][cisco_webex_teams docs])
...
* Move imports in cisco\_mobility\_express component ([@Bouni] - [#27877]) ([cisco\_mobility\_express docs][cisco_mobility_express docs])
...
* Move imports for hp\_ilo components ([@briglx] - [#27906]) ([hp\_ilo docs][hp_ilo docs])
* Fix flaky 集成 test ([@balloob] - [#27905])
* Move imports in harmony component ([@briglx] - [#27904]) ([harmony docs])
* Move imports to top for harman\_kardon\_avr ([@briglx] - [#27903]) ([harman\_kardon\_avr docs][harman_kardon_avr docs])
* Dont create coroutine until acting on it ([@balloob] - [#27907]) ([google\_assistant docs][google_assistant docs])
* Report 状态 ([@elupus] - [#27759]) ([google\_assistant docs][google_assistant docs])
...
* Add 温控 profiles to Homematic IP Cloud ([@SukramJ] - [#27772]) ([homematicip\_cloud docs][homematicip_cloud docs])
* Move imports in luftdaten component ([@Quentame] - [#27929]) ([luftdaten docs])
* Bump 版本 of homematicip to 0.10.13 ([@SukramJ] - [#27928]) ([homematicip\_cloud docs][homematicip_cloud docs])
...
* 升级 mypy to 0.740 ([@scop] - [#27913]) ([遮盖 docs]) ([group docs]) ([sun docs]) ([开关 docs]) ([websocket\_api docs][websocket_api docs]) ([区域 docs])
...
* remove duplicate unique\_id, add unique\_id for issues ([@zxdavb] - [#27916]) ([geniushub docs]) (breaking change)
* Remove stride ([@hmmbob] - [#27934]) (breaking change)
* Import shuffle ([@balloob] - [#27935]) ([http docs]) ([persistent\_notification docs][persistent_notification docs]) ([stream docs])
...
* Fix whois 错误, check expiration\_date for list and pick first ([@cyberjacob] - [#27930]) ([whois docs])
* Move imports in sql component ([@Michsior14] - [#27713]) ([sql docs])
* move imports in smarthab component ([@Michsior14] - [#27942]) ([smarthab docs])
* Fixing config\_entries.async\_forward\_entry\_unload calls (step 1) ([@Quentame] - [#27857]) ([cert\_expiry docs][cert_expiry docs]) ([locative docs]) ([luftdaten docs]) ([withings docs])
...
* Move imports in dte\_energy\_bridge component ([@djpremier] - [#27975]) ([dte\_energy\_bridge docs][dte_energy_bridge docs])
...
* Refactor entity\_ids, tweak names and consolidate classes ([@zxdavb] - [#27921]) ([incomfort docs])
...
* Move imports in frontier\_silicon component ([@djpremier] - [#27990]) ([frontier\_silicon docs][frontier_silicon docs])
...
* Move imports in message\_bird component ([@djpremier] - [#28022]) ([message\_bird docs][message_bird docs])
...
* Move imports in neurio\_energy component ([@djpremier] - [#28035]) ([neurio\_energy docs][neurio_energy docs])
...
* Move imports in oasa\_telematics component ([@djpremier] - [#28039]) ([oasa\_telematics docs][oasa_telematics docs])
...
* Move imports in norway\_air component ([@djpremier] - [#28037]) ([norway\_air docs][norway_air docs])
* Move imports in niko\_home\_control component ([@djpremier] - [#28036]) ([niko\_home\_control docs][niko_home_control docs])
...
* Move imports in mobile\_app component ([@djpremier] - [#28027]) ([mobile\_app docs][mobile_app docs])
...
* Move imports in lifx\_legacy component ([@djpremier] - [#28013]) ([lifx\_legacy docs][lifx_legacy docs])
* Move imports in lifx component ([@djpremier] - [#28012]) ([lifx docs])
* Move imports in lg\_soundbar component ([@djpremier] - [#28011]) ([lg\_soundbar docs][lg_soundbar docs])
...
* rest\_command component should support PATCH method ([@pho3nixf1re] - [#27989]) ([rest\_command docs][rest_command docs])
* 升级 discord.py to 1.2.4 ([@fabaff] - [#28054]) ([discord docs])
* Fix buienradar component and add smoke tests ([@ties] - [#27965]) ([buienradar docs])
* Code cleanup for orangepi\_gpio ([@pascallj] - [#27958]) ([orangepi\_gpio docs][orangepi_gpio docs])
* Not slugify cert\_expiry name ([@Quentame] - [#28055]) ([cert\_expiry docs][cert_expiry docs])
* Add hvac\_action to geniushub ([@zxdavb] - [#28056]) ([geniushub docs])
* Add ESPHome 传感器 force\_update option ([@OttoWinter] - [#28059]) ([esphome docs])
...
* 升级 youtube\_dl to 版本 2019.10.22 ([@BKPepe] - [#28070]) ([media\_extractor docs][media_extractor docs])
...
* Move imports in seven\_segments component ([@djpremier] - [#28096]) ([seven\_segments docs][seven_segments docs])
* Move imports in sesame component ([@djpremier] - [#28095]) ([sesame docs])
* Move imports in rpi\_pfio component ([@djpremier] - [#28094]) ([rpi\_pfio docs][rpi_pfio docs])
* Move imports in repetier component ([@djpremier] - [#28093]) ([repetier docs])
* Move imports in remember\_the\_milk component ([@djpremier] - [#28092]) ([remember\_the\_milk docs][remember_the_milk docs])
* Move imports in rejseplanen component ([@djpremier] - [#28091]) ([rejseplanen docs])
* Move imports in recollect\_waste component ([@djpremier] - [#28089]) ([recollect\_waste docs][recollect_waste docs])
...
* Move imports in mitemp\_bt component ([@djpremier] - [#28026]) ([mitemp\_bt docs][mitemp_bt docs])
...
* Support to use Whatsapp numbers (fixes ##28065) ([@fabaff] - [#28078]) ([twilio docs]) ([twilio\_call docs][twilio_call docs]) ([twilio\_sms docs][twilio_sms docs])
* Add modelnumber for ecobee4 ([@marthoc] - [#28107]) ([ecobee docs])
* Add support for more Orange Pi 设备 ([@pascallj] - [#28109]) ([orangepi\_gpio docs][orangepi_gpio docs])
...
* Add support for resource\_template for rest 传感器 ([@fredrike] - [#27869]) ([rest docs])
...
* Add improved 场景 support to the input\_datetime 集成 ([@Santobert] - [#28105]) ([input\_datetime docs][input_datetime docs])
...
* Move imports in wake\_on\_lan component ([@djpremier] - [#28100]) ([wake\_on\_lan docs][wake_on_lan docs])
...
* Additional SSL validation checks for cert\_expiry ([@jjlawren] - [#28047]) ([cert\_expiry docs][cert_expiry docs])
* New platform for Microsoft Teams ([@peroyvind] - [#27981]) ([msteams docs]) (new-集成)
...
* Cleanup typing and asserts for HomematicIP Cloud ([@SukramJ] - [#28144]) ([homematicip\_cloud docs][homematicip_cloud docs])
...
* Fix supported\_features in MQTT 遮盖 ([@Tofandel] - [#28120]) ([MQTT docs])
...
* changed STATE\_OFF to STATE\_STANDBY ([@Villhellm] - [#28148]) ([roku docs]) (breaking change)
* Allow multiple Transmission clients and add unique\_id to 实体 ([@engrbm87] - [#28136]) ([transmission docs])
