...
* SolarEdge Local Component ([@drobtravels] - [#23996]) ([solaredge\_local docs][solaredge_local docs]) (new-集成)
* Google Cloud Platform component (TTS) ([@lufton] - [#23629]) ([google\_cloud docs][google_cloud docs]) (new-集成)
* Life360 集成 ([@pnbruckner] - [#24227]) ([life360 docs]) (new-集成)
* Adds 集成 for Plaato Airlock ([@JohNan] - [#23727]) ([plaato docs]) (new-集成)
* Queensland bushfire alert feed platform ([@exxamalte] - [#24473]) ([qld\_bushfire docs][qld_bushfire docs]) (new-集成)
* Vlc telnet ([@rodripf] - [#24290]) ([vlc\_telnet docs][vlc_telnet docs]) (beta fix) (new-集成)

## New Platforms

* Add LCN 场景 platform ([@alengwenus] - [#24242]) ([lcn docs]) (new-platform)
* Add Environment Canada 天气, 传感器, and 摄像头 platforms ([@michaeldavie] - [#21110]) ([environment\_canada docs][environment_canada docs]) (new-platform)
...
* Add incomfort 传感器 and binary\_sensor ([@zxdavb] - [#23812]) ([incomfort docs]) (new-platform)
...
* Make sure 实体 config is never none ([@balloob] - [#24801]) ([google\_assistant docs][google_assistant docs])
...
* Remove deprecated AlarmControlPanel ([@SukramJ] - [#24322]) ([homematicip\_cloud docs][homematicip_cloud docs]) (breaking change)
* Remove 属性 lowBat ([@SukramJ] - [#24323]) ([homematicip\_cloud docs][homematicip_cloud docs]) (breaking change)
* Remove 二元sensor for ZHA 遥控器 and controllers ([@dmulcahey] - [#24370]) ([zha docs]) (breaking change)
* 恢复 自动化 last\_triggered with initial\_state override ([@frenck] - [#24400]) ([自动化 docs]) (breaking change)
...
* Remove conversation from default config ([@balloob] - [#24515]) ([default\_config docs][default_config docs]) (breaking change)
...
* Save cached logi\_circle tokens in config folder ([@evanjd] - [#24726]) ([logi\_circle docs][logi_circle docs]) (breaking change) (beta fix)

## Beta Fixes

* Vlc telnet ([@rodripf] - [#24290]) ([vlc\_telnet docs][vlc_telnet docs]) (beta fix) (new-集成)
* Fix 设备 tracker see for 实体 registry 实体 ([@MartinHjelmare] - [#24633]) ([device\_tracker docs][device_tracker docs]) (beta fix)
...
* Add show\_as\_state options to Life360 ([@pnbruckner] - [#24725]) ([life360 docs]) (beta fix)
* Save cached logi\_circle tokens in config folder ([@evanjd] - [#24726]) ([logi\_circle docs][logi_circle docs]) (breaking change) (beta fix)
...
* Clean up Google Config ([@balloob] - [#24663]) ([cloud docs]) ([google\_assistant docs][google_assistant docs]) (beta fix)
* Fix locative 设备 更新 ([@MartinHjelmare] - [#24744]) ([locative docs]) (beta fix)
* Improve Alexa 错误 handling ([@balloob] - [#24745]) ([alexa docs]) ([cloud docs]) ([websocket\_api docs][websocket_api docs]) (beta fix)
* Bump pyatmo to v2.1.0 ([@cgtobi] - [#24724]) ([netatmo docs]) (beta fix)
* Handle timeouts gracefully ([@cgtobi] - [#24752]) ([netatmo docs]) (beta fix)
* 更新 Waze route dependency to 0.10 ([@johntdyer] - [#24754]) ([waze\_travel\_time docs][waze_travel_time docs]) (beta fix)
...
* fix gitlab\_ci sad icon ([@Emilv2] - [#24241]) ([gitlab\_ci docs][gitlab_ci docs])
...
* Expose specific device\_class for Velux 遮盖 ([@gibman] - [#24279]) ([velux docs])
...
* Meteofrance fix 24244 ([@victorcerutti] - [#24315]) ([meteo\_france docs][meteo_france docs])
...
* Remove 属性 lowBat ([@SukramJ] - [#24323]) ([homematicip\_cloud docs][homematicip_cloud docs]) (breaking change)
* Don't load last\_checkpoint if shipment is pending ([@davidbb] - [#24301]) ([aftership docs])
* 升级 youtube\_dl to 2019.05.20 ([@fabaff] - [#24347]) ([media\_extractor docs][media_extractor docs])
* Add new movement type "actively" of the Xiaomi Vibration 传感器 ([@syssi] - [#24334]) ([xiaomi\_aqara docs][xiaomi_aqara docs])
* Fix set\_cover\_position of the xiaomi\_aqara 遮盖 for LAN protocol v2 ([@syssi] - [#24333]) ([xiaomi\_aqara docs][xiaomi_aqara docs])
* Add Environment Canada 天气, 传感器, and 摄像头 platforms ([@michaeldavie] - [#21110]) ([environment\_canada docs][environment_canada docs]) (new-platform)
* Google Cloud Platform component (TTS) ([@lufton] - [#23629]) ([google\_cloud docs][google_cloud docs]) (new-集成)
...
* Add templating to MQTT 遮盖 tilt\_status ([@tommyjlong] - [#24355]) ([MQTT docs])
* 升级 ruamel.yaml to 0.15.97 ([@fabaff] - [#24350])
* Bump regenmaschine to 1.5.1 ([@bachya] - [#24358]) ([rainmachine docs])
* Life360 集成 ([@pnbruckner] - [#24227]) ([life360 docs]) (new-集成)
* Refactor Waze Travel Time & 更新 Requirements ([@Petro31] - [#22428]) ([waze\_travel\_time docs][waze_travel_time docs])
...
* Add ATTR\_FORECAST\_PRECIPITATION option ([@rolfberkenbosch] - [#24308]) ([buienradar docs])
...
* Rename via\_hub to via\_device ([@Swamp-Ig] - [#24360])
...
* Bumping Keenetic NDMS2 client to 0.0.8 ([@foxel] - [#24469]) ([keenetic\_ndms2 docs][keenetic_ndms2 docs])
...
* Added name to 传感器 ([@cliffordwhansen] - [#24525]) ([synologydsm docs]) (breaking change)
* 更新 requirement 版本 and add switcher\_kis 服务 ([@TomerFi] - [#23477]) ([switcher\_kis docs][switcher_kis docs])
...
* Fix a bug with Ambient PWS reconnection ([@bachya] - [#24540]) ([ambient\_station docs][ambient_station docs])
* 更新 **init**.py ([@lundan] - [#24553]) ([nissan\_leaf docs][nissan_leaf docs])
...
* Add sensitivity and sensitvity\_max attributs for 二元sensor ([@Cyr-ius] - [#24438]) ([hue docs])
* Cloud: Add Alexa report 状态 ([@balloob] - [#24536]) ([alexa docs]) ([cloud docs])
* Added 切换 服务 to 遮盖 ([@kbickar] - [#23198]) ([遮盖 docs])
* Added invert\_percent 配置 for zwave rollershutter ([@tommasomarchionni] - [#23101]) ([zwave docs])
* Add code\_arm\_required to manual 报警 with MQTT ([@JumpMaster] - [#22641]) ([manual\_mqtt docs][manual_mqtt docs])
* Add code\_arm\_required to manual 报警 ([@JumpMaster] - [#22618]) ([demo docs]) ([manual docs])
...
* Bump base Somfy MyLink library 版本 ([@bendews] - [#24587]) ([somfy\_mylink docs][somfy_mylink docs])
...
* Fix validator for lcn.send\_keys 服务 ([@alengwenus] - [#24580]) ([lcn docs])
* Cloud: Make sure on\_connect forwards platform only once ([@balloob] - [#24582]) ([cloud docs])
...
* Tolerance 配置 for dlib\_face\_identify ([@gonzalezcalleja] - [#24497]) ([dlib\_face\_identify docs][dlib_face_identify docs])
...
* Add 天气 alert 传感器 to meteo france component ([@oncleben31] - [#23128]) ([meteo\_france docs][meteo_france docs])
