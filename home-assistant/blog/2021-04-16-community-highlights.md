...
put a smart plug on the washing machine and you get a 通知 when the
...
<div style="margin:0 auto; text-align:center">
    <a href="https://github.com/maxwroc/battery-状态-卡片" target="_blank">
        <img
            src='/home-assistant/images/blog/2021-04-16-community-highlights/battery.png'
            alt="Preview from battery 状态 卡片"
            style='border: 0;box-shadow: none;width:90%;margin-bottom:10px;'
        />
    </a>
</div>

Do you want to keep an eye on all your battery powered 设备? Then try
the [battery 状态 卡片](https://github.com/maxwroc/battery-状态-卡片) from
[maxwroc](https://github.com/maxwroc), so that you can see by means of a color
which 设备 is almost empty and it's time for a battery replacement.

<object type="image/svg+xml" data="https://gh-卡片.dev/repos/maxwroc/battery-状态-卡片.svg?link_target=_blank"></object>

## Lovelace 仪表盘

Also this week we have a new Lovelace 仪表盘 for the necessary portion of
inspiration 😄 This time it has become that of [FreakLikeMe0991](https://www.reddit.com/user/FreakLikeMe0991/),
which, like last week's 仪表盘, mainly focuses on the use from a mobile 设备.

<blockquote class="reddit-卡片" data-卡片-创建="1618574623"><a href="https://www.reddit.com/r/homeassistant/comments/mpiqak/new_3_click_mobile_dashboard_work_in_progress/">New &gt;3 Click Mobile 仪表盘 - Work in Progress</a> from <a href="http://www.reddit.com/r/homeassistant">r/homeassistant</a></blockquote>
<脚本 async src="//embed.redditmedia.com/widgets/platform.js" charset="UTF-8"></脚本><br>
...
assistant in your kitchen. It projects images (like a Lovelace 仪表盘 or cooking
...
</blockquote><脚本 async src="//s.imgur.com/min/embed.js" charset="utf-8"></脚本>
