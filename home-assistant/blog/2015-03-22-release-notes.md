...
<a name='sabnzbd'></a>
**SABnzbd** <img src='/home-assistant/images/supported_brands/sabnzbd.png' style='border:none; box-shadow: none; float: right;' height='50' /> James Cole 贡献了 SABnzbd 集成支持。这样你就可以在 Home Assistant 中监控下载，并基于这些信息设置自动化。
...
<a name='pushover'></a>
**Pushover** <img src='/home-assistant/images/supported_brands/pushover.png' style='border:none; box-shadow: none; float: right;' height='50' /> James Cole 还贡献了对 <a href='https://pushover.net/'>Pushover 服务</a> 的支持，可作为通知组件的平台。这让各组件能够通过 Pushover 向你发送消息。
