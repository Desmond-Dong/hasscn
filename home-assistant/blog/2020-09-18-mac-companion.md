...
*如果您是 Windows 用户，请不用担心，您可以将您的 PC 与出色的 [IOT Link](https://iotlink.gitlab.io/index.html) 工具集成。*
...
Mac 应用程序绝对是一个 *Mac* 应用程序。应用程序配置页面已从 Home Assistant 的侧边栏删除。相反，配置选项和首选项位于菜单栏上，您希望在任何其他应用程序中找到它们，并且所有标准快捷方式也都可以使用（例如用于首选项的 `⌘,`）。您甚至可以通过“文件”>“新建”打开多个 Lovelace 窗口。
