# 0.59: Order pizza, 实体 Picker, Color Wheel
...
借助 [@craigjmidwinter] 制作的 Dominos Pizza 集成，你的家现在都能帮你避免饿肚子了。再配合 [Skybell](/home-assistant/integrations/skybell/index.md) 或 [DoorBird](/home-assistant/integrations/doorbird/index.md)，你就能准确知道披萨什么时候送到门口。
...
* Support for Unifi direct access 设备 tracker (No unifi controller software) ([@w1ll1am23] - [#10097]) ([device\_tracker.unifi\_direct docs][device_tracker.unifi_direct docs]) (new-platform)
...
* Fix linksys\_ap.py by inheriting DeviceScanner ([@mateuszdrab] - [#10947])
...
* Added unit\_of\_measurement to Currencylayer ([@arsaboo] - [#10598]) ([传感器.currencylayer docs])
* Change generic thermostat - any 切换 设备 as heater 开关 ([@milanvo] - [#10597]) ([温控.generic\_thermostat docs][温控.generic_thermostat docs])
* Add hddtemp 传感器 设备 even if unreachable. ([@cgtobi] - [#10623]) ([传感器.hddtemp docs])
* 恢复 target temperature for generic thermostat ([@tinloaf] - [#10635]) ([温控.generic\_thermostat docs][温控.generic_thermostat docs])
* 更新 lnetatmo ([@gieljnssns] - [#10631]) ([netatmo docs])
* Support for Unifi direct access 设备 tracker (No unifi controller software) ([@w1ll1am23] - [#10097]) ([device\_tracker.unifi\_direct docs][device_tracker.unifi_direct docs]) (new-platform)
* Add Facebook 通知 tests ([@broox] - [#10642])
* Change some 警告 to info ([@cgarwood] - [#10386]) ([emulated\_hue docs][emulated_hue docs])
* Added cycles config option to LaMetric 通知 ([@frittes] - [#10656]) ([通知.lametric docs]) (breaking change)
* Netatmo httperror403 fix ([@gieljnssns] - [#10659]) ([netatmo docs])
* Bump dev to 0.59.0.dev0 ([@fabaff] - [#10675])
* Include unit\_of\_measurement as InfluxDb field ([@PeteBa] - [#9790]) ([influxdb docs])
* Tahoma platform for Somfy 遮盖 and 传感器 ([@philklei] - [#10652]) ([tahoma docs]) ([遮盖.tahoma docs]) ([传感器.tahoma docs]) (new-platform)
* Populate measurement 状态 field for HA 状态 like home/not\_home ([@PeteBa] - [#9833]) ([influxdb docs])
...
* Add Arm Custom Bypass to alarm\_control\_panel ([@uchagani] - [#10697]) ([alarm\_control\_panel docs][alarm_control_panel docs])
* Fix conversation ([@balloob] - [#10686]) ([conversation docs])
* Shopping list: add item HTTP API ([@balloob] - [#10674]) ([shopping\_list docs][shopping_list docs])
* Add 在场 device\_class ([@arsaboo] - [#10705]) ([binary\_sensor docs][binary_sensor docs])
* python-miio 版本 bumped for improved 设备 support. ([@syssi] - [#10720]) ([风扇.xiaomi\_miio docs][风扇.xiaomi_miio docs]) ([灯光.xiaomi\_miio docs][灯光.xiaomi_miio docs]) ([开关.xiaomi\_miio docs][开关.xiaomi_miio docs]) ([吸尘器.xiaomi\_miio docs][吸尘器.xiaomi_miio docs])
...
* Add transmission rate ([@svenstaro] - [#10740]) ([传感器.fritzbox\_netmonitor docs][传感器.fritzbox_netmonitor docs])
...
* Google assistant 温控 mode fix ([@braddparker] - [#10726]) ([google\_assistant.smart\_home docs][google_assistant.smart_home docs])
...
* Add Dominos Pizza platform ([@craigjmidwinter] - [#10379]) ([dominos docs]) (new-platform)
* Fix name collision when using multiple Hue bridges ([@zBart] - [#10486]) ([灯光.hue docs]) (breaking change)
* Make shell\_command async ([@n8henrie] - [#10741]) ([shell\_command docs][shell_command docs])
* 更新 CODEOWNERS with hive Component / Platforms ([@Rendili] - [#10775])
* Bump total-connect-client 版本 ([@uchagani] - [#10769]) ([alarm\_control\_panel.totalconnect docs][alarm_control_panel.totalconnect docs])
* Fix 场景 description formatting. ([@balloob] - [#10785])
* Fixes #10773: Demo 报警 Broken ([@uchagani] - [#10777]) ([alarm\_control\_panel.demo docs][alarm_control_panel.demo docs])
* Load Ring 摄像头 only with Ring Protect plan activated ([@tchellomello] - [#10739]) ([ring docs]) ([摄像头.ring docs])
* system\_log improvements ([@andrey-git] - [#10709]) ([system\_log docs][system_log docs])
* Fix WUnderground 错误 handling, rework 实体 methods ([@milanvo] - [#10295]) ([传感器.wunderground docs])
* Add away\_mode\_name to arlo 报警 control 面板 ([@bcl1713] - [#10796]) ([alarm\_control\_panel.arlo docs][alarm_control_panel.arlo docs])
...
* Changing handling for google\_assistant groups to treat them as 灯光. ([@snowzach] - [#10111])
* Tellduslive 更新 with support for auto config and Local api ([@fredrike] - [#10435]) ([tellduslive docs]) (breaking change)
...
* Add 设备 class for low battery ([@schmittx] - [#10829]) ([binary\_sensor docs][binary_sensor docs])
...
* Add useragent-based detection of JS 版本 ([@andrey-git] - [#10776]) (breaking change)
* add support for multiple execution per execute request ([@perosb] - [#10844]) ([google\_assistant.http docs][google_assistant.http docs])
* 升级 HomeMatic, add 设备 ([@danielperna84] - [#10845]) ([homematic docs]) ([binary\_sensor.homematic docs][binary_sensor.homematic docs]) ([传感器.homematic docs])
* 温控 component: add supported\_features ([@tinloaf] - [#10658]) ([温控 docs]) ([温控.generic\_thermostat docs][温控.generic_thermostat docs]) ([温控.MQTT docs])
...
* 升级 schiene to 0.19 ([@fabaff] - [#10887]) ([传感器.deutsche\_bahn docs][传感器.deutsche_bahn docs])
* Xiaomi 吸尘器: remove deprecated calls ([@rytilahti] - [#10839]) ([吸尘器.xiaomi\_miio docs][吸尘器.xiaomi_miio docs])
* Create ecobee 天气 platform ([@PhracturedBlue] - [#10869]) ([ecobee docs]) ([天气.ecobee docs]) (new-platform)
* Microsoft Text-to-speech: Fixing missing en-gb support bug ([@jeroenterheerdt] - [#10429]) ([tts.microsoft docs])
* 升级 youtube\_dl to 2017.11.26 ([@fabaff] - [#10890]) ([media\_extractor docs][media_extractor docs])
...
* Serve latest extra\_html in dev mode ([@andrey-git] - [#10863])
