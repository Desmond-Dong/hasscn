...
* 支持 August 门铃 ([@snjoetw] - [#11124]) ([august docs]) ([binary\_sensor.august docs][binary_sensor.august docs]) ([摄像头.august docs]) ([门锁.august docs]) (new-platform)
* 新增 BMW Connected Drive 组件 ([@ChristianKuehnel] - [#12277]) ([bmw\_connected\_drive docs][bmw_connected_drive docs]) ([device\_tracker.bmw\_connected\_drive docs][device_tracker.bmw_connected_drive docs]) ([传感器.bmw\_connected\_drive docs][传感器.bmw_connected_drive docs]) (new-platform)
* 为 ISP Start.ca 新增传感器 ([@mikeodr] - [#12356]) ([传感器.startca docs]) (new-platform)
* 新增小米电视平台 ([@simse] - [#12359]) ([媒体播放器.xiaomi\_tv docs][媒体播放器.xiaomi_tv docs]) (new-platform)
...
* Component deconz: Fix dark 属性 on 在场 传感器 ([@tumik] - [#12691]) ([binary\_sensor.deconz docs][binary_sensor.deconz docs])
...
* fix for https://github.com/home-assistant/home-assistant/issues/12673 ([@ChristianKuehnel] - [#12726]) ([传感器.alpha\_vantage docs][传感器.alpha_vantage docs])
...
* updated to bimmer\_connected 0.4.1 ([@ChristianKuehnel] - [#12759]) ([bmw\_connected\_drive docs][bmw_connected_drive docs])
...
* Fixed missing optional keyerror data\_bits ([@basschipper] - [#12789]) ([binary\_sensor.rfxtrx docs][binary_sensor.rfxtrx docs])
...
* is\_allowed\_path: Also test folder #12788 #12807 ([@kellerza] - [#12810])
...
* 如果未配置任何股票代码或货币，将显示一条 persistent\_notification（持久通知）。([@ChristianKuehnel] - [#12252]) ([传感器.alpha\_vantage docs][传感器.alpha_vantage docs]) (breaking change)
...
* device\_tracker.asuswrt: Clean up unused connection param ([@trisk] - [#12262]) ([device\_tracker.asuswrt docs][device_tracker.asuswrt docs])
* Fix some rfxtrx 设备 with multiple 传感器 ([@neffs] - [#12264]) ([传感器.rfxtrx docs])
* have 温控 fallback to 状态 if no ATTR\_OPERATION\_MODE (#12271) ([@ttroy50] - [#12279]) ([google\_assistant docs][google_assistant docs])
* check\_config check bootstrap 错误 ([@kellerza] - [#12291])
...
* Fix Panel\_IFrame - FTP URL not allowed in 0.63 ([@ReneNulschDE] - [#12295]) ([panel\_iframe docs][panel_iframe docs])
...
* add friendly\_name\_template to 模板 传感器 ([@NovapaX] - [#12268]) ([传感器.模板 docs])
* Purge recorder data by default ([@amelchio] - [#12271]) (breaking change)
* Protect bloomsky platform 设置 ([@balloob] - [#12316]) ([binary\_sensor.bloomsky docs][binary_sensor.bloomsky docs]) ([摄像头.bloomsky docs]) ([传感器.bloomsky docs])
* Removed default 传感器 配置 ([@ChristianKuehnel] - [#12252]) ([传感器.alpha\_vantage docs][传感器.alpha_vantage docs]) (breaking change)
...
* Revert #12316 ([@balloob] - [#12329]) ([binary\_sensor.bloomsky docs][binary_sensor.bloomsky docs]) ([摄像头.bloomsky docs]) ([传感器.bloomsky docs])
* zha: Add remove 服务 ([@rcloran] - [#11683]) ([zha docs])
* Fix line endings \[skipci] ([@balloob] - [#12333])
* Unifi tracking filter by SSID ([@mikeodr] - [#12281]) ([device\_tracker.unifi docs][device_tracker.unifi docs])
* device\_tracker.asuswrt: Ignore unreachable ip neigh entries ([@trisk] - [#12201]) ([device\_tracker.asuswrt docs][device_tracker.asuswrt docs])
* nmap\_tracker: don't scan on 设置 ([@abmantis] - [#12322]) ([device\_tracker.nmap\_tracker docs][device_tracker.nmap_tracker docs])
* 升级 Sphinx to 1.7.0 ([@fabaff] - [#12335])
* Mock Module + Platform default to async ([@balloob] - [#12347])
* Change Unifi SSID filtering to list comprehension ([@mikeodr] - [#12344]) ([device\_tracker.unifi docs][device_tracker.unifi docs])
* Use the speedometer icon in the fastdotcom 传感器 ([@d0ugal] - [#12348]) ([传感器.fastdotcom docs])
* Communication reduced. Setting brightness and/or color temperature will 打开 the 设备. ([@syssi] - [#12343]) ([灯光.xiaomi\_miio docs][灯光.xiaomi_miio docs])
* Add New 传感器 for ISP Start.ca ([@mikeodr] - [#12356]) ([传感器.startca docs]) (new-platform)
* bump fedex 版本 ([@happyleavesaoc] - [#12362])
* 升级 alpha\_vantage to 1.9.0 ([@fabaff] - [#12352]) ([传感器.alpha\_vantage docs][传感器.alpha_vantage docs])
* Eq3btsmart more reliable ([@karlkar] - [#11555]) ([温控.eq3btsmart docs])
* Allow disabling 实体 in the registry ([@balloob] - [#12360])
* 升级 panasonic\_viera to 0.3.1 ([@dgomes] - [#12370]) ([媒体播放器.panasonic\_viera docs][媒体播放器.panasonic_viera docs])
...
* 升级 youtube\_dl to 2018.02.11 ([@fabaff] - [#12383]) ([media\_extractor docs][media_extractor docs])
* Remove usage of deprecated assert method ([@balloob] - [#12379])
* Add 属性 (fixes #12332) ([@fabaff] - [#12377]) ([传感器.speedtest docs])
* Improve 服务 by allowing to reference 实体 id instead of deconz id ([@Kane610] - [#11862]) ([deconz docs]) ([场景 docs]) ([binary\_sensor.deconz docs][binary_sensor.deconz docs]) ([灯光.deconz docs]) ([传感器.deconz docs])
...
* File Path fixes for RPi 摄像头 ([@FrederikBolding] - [#12338]) ([摄像头.rpi\_camera docs][摄像头.rpi_camera docs])
* Code cleanup of velux 场景 ([@Julius2342] - [#12390]) ([场景 docs])
* 升级 sphinx-autodoc-typehints to 1.2.5 ([@fabaff] - [#12404])
* Extract data validator to own file and add tests ([@balloob] - [#12401]) ([cloud docs]) ([conversation docs]) ([http docs]) ([shopping\_list docs][shopping_list docs]) (new-platform)
...
* Cleanup of knx component ([@Julius2342] - [#12408]) ([knx docs]) ([binary\_sensor.knx docs][binary_sensor.knx docs]) ([温控.knx docs]) ([遮盖.knx docs]) ([灯光.knx docs]) ([通知.knx docs]) ([传感器.knx docs]) ([开关.knx docs])
* 更新 the Tibber 传感器 at startup ([@danielhiversen] - [#12428]) ([传感器.tibber docs])
* zha: Add unique\_id to 实体 ([@rcloran] - [#12331]) ([zha docs])
* Cleanup http ([@balloob] - [#12424]) ([前端 docs]) ([http docs])
* 更新 CODEOWNERS ([@dgomes] - [#12440])
* Fix: timeout data 属性 now is parsed to float ([@sjvc] - [#12432]) ([telegram\_bot docs][telegram_bot docs])
...
* Fake the 状态 for a short period and skip the next 更新. ([@syssi] - [#12446]) ([风扇.xiaomi\_miio docs][风扇.xiaomi_miio docs])
* Initial support for Config Entries ([@balloob] - [#12079])
* Make WUnderground async ([@OttoWinter] - [#12385]) ([传感器.wunderground docs])
* Add the Xiaomi TV platform. ([@simse] - [#12359]) ([媒体播放器.xiaomi\_tv docs][媒体播放器.xiaomi_tv docs]) (new-platform)
* 更新 voluputous ([@balloob] - [#12463]) (breaking change)
* Map Alexa StepVolume responses to volume\_up/down ([@lucasweb78] - [#12467]) ([alexa docs])
...
* Added doorbird\_last\_motion to DoorBird 摄像头 platform ([@sjvc] - [#12457]) ([摄像头.doorbird docs])
...
* Support for August doorbell ([@snjoetw] - [#11124]) ([august docs]) ([binary\_sensor.august docs][binary_sensor.august docs]) ([摄像头.august docs]) ([门锁.august docs]) (new-platform)
...
* Converted shopping list to use json util and added default override for json util ([@FrederikBolding] - [#12478]) ([shopping\_list docs][shopping_list docs])
...
* new 版本 of xiaomi lib ([@danielhiversen] - [#12513]) ([xiaomi\_aqara docs][xiaomi_aqara docs])
* python-miio 版本 bumped. (Closes: #12471) ([@syssi] - [#12481]) ([风扇.xiaomi\_miio docs][风扇.xiaomi_miio docs]) ([灯光.xiaomi\_miio docs][灯光.xiaomi_miio docs]) ([遥控器.xiaomi\_miio docs][遥控器.xiaomi_miio docs]) ([开关.xiaomi\_miio docs][开关.xiaomi_miio docs]) ([吸尘器.xiaomi\_miio docs][吸尘器.xiaomi_miio docs])
...
* Changed to async\_schedule\_update\_ha\_state ([@thrawnarn] - [#12518]) ([媒体播放器.bluesound docs])
...
* Bugfix: Input Datetime config schema ([@cdce8p] - [#12552]) ([input\_datetime docs][input_datetime docs])
* Fix numeric\_state 条件 spamming on unavailable ([@OttoWinter] - [#12550])
* Frontier silicon async ([@zhelev] - [#12503]) ([媒体播放器.frontier\_silicon docs][媒体播放器.frontier_silicon docs])
...
* Add new component: BMW connected drive ([@ChristianKuehnel] - [#12277]) ([bmw\_connected\_drive docs][bmw_connected_drive docs]) ([device\_tracker.bmw\_connected\_drive docs][device_tracker.bmw_connected_drive docs]) ([传感器.bmw\_connected\_drive docs][传感器.bmw_connected_drive docs]) (new-platform)
...
* Set event\_id foreign key in recorded 状态 ([@amelchio] - [#12580])
...
* Add unique\_id to Xiaomi Aqara ([@tinloaf] - [#12372]) ([xiaomi\_aqara docs][xiaomi_aqara docs])
* Make groups 实体 again ([@balloob] - [#12574]) ([alexa docs])
* Python spotcrime ([@jcconnell] - [#12460]) ([传感器.spotcrime docs]) (new-platform)
* Allow ignoring call 服务 events in mqtt\_eventstream ([@cmsimike] - [#12519]) ([mqtt\_eventstream docs][mqtt_eventstream docs])
* Set speed 服务 fixed. ([@syssi] - [#12602]) ([风扇.xiaomi\_miio docs][风扇.xiaomi_miio docs])
* Updated 脚本/lint ([@cdce8p] - [#12600])
* Adding RoomHinting to GoogleAssistant to allow for 房间 annotations. ([@jeremydk] - [#12598]) ([google\_assistant docs][google_assistant docs])
* Fix mclimate accounts with not only melissa components ([@kennedyshead] - [#12427]) ([melissa docs]) ([温控.melissa docs])
* Cast unique\_id and async discovery ([@OttoWinter] - [#12474]) ([媒体播放器.cast docs])
* Add Tahoma 场景 ([@thijsdejong] - [#12498]) ([场景 docs]) ([tahoma docs]) (new-platform)
* Optimize logbook SQL query ([@amelchio] - [#12608]) ([logbook docs])
* Fix voluptuous breaking change things ([@balloob] - [#12611]) ([xiaomi\_aqara docs][xiaomi_aqara docs]) ([binary\_sensor.knx docs][binary_sensor.knx docs])
...
* The name of the enum must be used here because of the speed\_list. ([@syssi] - [#12625]) ([风扇.xiaomi\_miio docs][风扇.xiaomi_miio docs])
