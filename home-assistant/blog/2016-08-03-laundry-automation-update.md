...
*This is a guest post by Home Assistant 用户 and contributor [Nolan Gilley](https://github.com/nkgilley).*
...
Next I wrote [脚本](/home-assistant/integrations/script/index.md) that are run whenever the washer or dryer completes a load.  This is triggered by the [automation component](/home-assistant/getting-started/automation/index.md).  When the laundry is complete I have the 灯光 in the house turn red and [notify me via Join](/home-assistant/integrations/joaoapps_join.md).  Once the door is opened and laundry emptied another 脚本 runs that sets the 灯光 back to normal.  So far it has been very helpful and very reliable.
