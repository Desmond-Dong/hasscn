...
<div style="margin:0 auto; text-align:center">
    <a href="https://community.home-assistant.io/t/吸尘器-schedule/256590" target="_blank">
        <img
            src='/home-assistant/images/blog/2021-04-30-community-highlights/blueprint.png'
...
with which you can plan on which days of the week your 吸尘器 cleaner should start
...
of inspiration 💡 This time it has become that of [Make\_Itt\_Work](https://www.reddit.com/user/Make_Itt_Work/),
where he also processed the telemetry data from his car in the 仪表盘.
...
<div style="margin:0 auto; text-align:center">
    <a href="https://www.reddit.com/r/homeassistant/comments/n1ci34/latest_dashboard_check_out_my_car_telemetry_card/" target="_blank">
        <img
            src='/home-assistant/images/blog/2021-04-30-community-highlights/dashboard.jpg'
...
<div style="margin:0 auto; text-align:center">
    <a href="https://github.com/denysdovhan/吸尘器-卡片" target="_blank">
        <img
            src='/home-assistant/images/blog/2021-04-30-community-highlights/vacuum.png'
            alt="The 吸尘器 卡片"
            style='border: 0;box-shadow: none;width:70%;margin-bottom:15px;'
        />
    </a>
...
Besides being able to automate when your 吸尘器 cleaning robot gets started,
you probably also want to show the status of your robot in Lovelace. Then try
the [吸尘器 卡片](https://github.com/denysdovhan/吸尘器-卡片) from [denysdovhan](https://github.com/denysdovhan),
...
<a href="https://github.com/denysdovhan/吸尘器-卡片"><img style="border: 0;" src="https://gh-卡片.dev/repos/denysdovhan/吸尘器-卡片.svg"></a>
...
is an add-on, which gives you the possibility to use multiple 开源
...
recently released a new 版本 of OpenTTS and you can 安装 it as an
add-on in Home Assistant.

<a href="https://github.com/synesthesiam/hassio-addons"><img style="border: 0;" src="https://gh-卡片.dev/repos/synesthesiam/hassio-addons.svg"></a>
...
[仪表盘]: https://www.reddit.com/r/homeassistant/comments/n1ci34/latest_dashboard_check_out_my_car_telemetry_card/

[internship]: https://www.home-assistant.io/博客/2021/04/23/community-highlights/#home-assistant-energy

[week_blueprint]: https://community.home-assistant.io/t/吸尘器-schedule/256590
