...
*音乐助手作为 <a href="https://www.home-assistant.io/addons">Home Assistant 附加组件 </a> 进行分发 – 我们通过第三方应用程序轻松扩展您的 Home Assistant 安装的方式。要将其安装为 Docker 容器，请遵循 <a href="https://music-assistant.io/installation/#tertiary-安装-method-Docker-image">MA 安装说明</a>.*
