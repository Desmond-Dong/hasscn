...
这里所说的 *“未授权使用”*，显然指的是 2017 年 2 月加入 Home Assistant 的 MyQ 集成。我们已经通过多种方式联系 Chamberlain Group，希望双方能达成共识，但始终没有收到正式回复。我们只能认为，Chamberlain Group 已经做出了决定，并将强迫客户只能使用 MyQ 官方应用，或其授权合作伙伴的应用。
