...
![Screenshot of websocket 设置](/home-assistant/images/blog/2022-02-android/websocket_setting.png)
...
![Screenshot of changelog](/home-assistant/images/blog/2022-02-android/changelog.png)
...
![Screenshot of template tile](/home-assistant/images/blog/2022-02-android/template_tile.png)
...
![Screenshot of sign in on phone](/home-assistant/images/blog/2022-02-android/sign_in_on_phone.png)
...
* [设备 controls] were updated to add support for `button` and `input_button` domains. The `climate` domain was enhanced for supported HVAC modes and proper temperature increments. The More Info pop-up, when a tile is long pressed, is now more reliable. Thanks for these improvements [jpelgrom].
* [dshokouhi] and [jpelgrom] worked together to remove additional Google 服务 dependencies from the minimal 版本
...
![Screenshot of adding widgets](/home-assistant/images/blog/2022-02-android/add_widget.png)
...
* 通知 commands for `command_activity` and `command_broadcast_intent` were updated for more types of intent extras by [moritzgloeckl]
* The \[WiFi 状态 传感器] now receives instant updates on 设备 that did not have instant updates before, thank you [dshokouhi]
...
* `button` and `input_button` domain support was added to [quick 设置] by [jpelgrom]
...
[Last Used App]: https://companion.home-assistant.io/docs/core/sensor#last-used-app-sensor

[minimal 版本]: https://companion.home-assistant.io/docs/core/android-flavors

[Firebase]: https://companion.home-assistant.io/docs/通知/通知-details

[Local Push 通知]: https://companion.home-assistant.io/docs/通知/通知-local

[Last Used App sensor]: https://companion.home-assistant.io/docs/core/sensor#last-used-app-sensor

[Do Not Disturb sensor]: https://companion.home-assistant.io/docs/core/sensor#do-not-disturb-sensor

[In Use 传感器]: https://companion.home-assistant.io/docs/oculus-quest/#sensor-list

[设备 controls]: https://companion.home-assistant.io/docs/integrations/android-power-menu

[quick 设置]: https://companion.home-assistant.io/docs/integrations/android-quick-设置

[WiFi 状态 sensor]: https://companion.home-assistant.io/docs/core/sensor#connection-type-sensor

[更新 传感器]: https://companion.home-assistant.io/docs/通知/通知-commands#更新-sensor
