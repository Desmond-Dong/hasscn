...
这个项目由 Nabu Casa 与 Open Home Foundation 中的多位成员合作完成。若没有 [Home Assistant Cloud 订阅者](/home-assistant/cloud/index.md) 的支持，以及所有关心 Z-Wave 并购买了 Home Assistant Connect ZWA-2 的用户，这一切都不可能实现。谢谢你们！
