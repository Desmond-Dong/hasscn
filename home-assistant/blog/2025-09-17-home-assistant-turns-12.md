...
特别感谢所有 [Home Assistant Cloud](/home-assistant/cloud/index.md) 订阅者，以及购买过官方 Home Assistant 硬件的每一个人。正是这些支持推动了 Home Assistant（以及 ESPHome、Music Assistant 等许多项目）的全职开发，也是确保这些项目持续获得新功能的最简单方式！
