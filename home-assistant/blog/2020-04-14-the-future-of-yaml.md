...
* 集成 that provide 自动化, e.g., 自动化,
  device\_sun\_light\_trigger, alert.
...
* *“It is harder to test my 配置 if 集成 does not support YAML”.*
...
* *“I like to use a private git repository where I store all my data in,
  including my sensitive data, since it is not public.
  Without YAML this is not possible.”*
