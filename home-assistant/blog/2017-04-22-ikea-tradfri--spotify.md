...
* Telegram 机器人组件（包含 Webhook 和轮询平台） ([@sander76] - [#6913]) ([telegram\_bot docs][telegram_bot docs]) ([telegram\_bot.polling docs][telegram_bot.polling docs]) ([telegram\_bot.webhooks docs][telegram_bot.webhooks docs]) (breaking change) (new-platform)
...
* 支持 LIFX Cloud 场景 ([@amelchio] - [#7124]) ([场景.lifx\_cloud docs][场景.lifx_cloud docs]) (new-platform)
...
* Ping 二元传感器 ([@fabaff] - [#7052]) ([binary\_sensor.ping docs][binary_sensor.ping docs]) (new-platform)
...
* `telegram_webhooks` 已改造成新的 `telegram_bot` 组件，包含两个平台：Webhook 和轮询平台 ([@sander76] - [#6913]) ([telegram\_bot docs][telegram_bot docs])([telegram\_bot.polling docs][telegram_bot.polling docs]) ([telegram\_bot.webhooks docs][telegram_bot.webhooks docs])
...
* Lutron\_Caseta：现在不再需要在配置中填写用户名和密码。 ([@gurumitts] - [#7165]) ([lutron\_caseta docs][lutron_caseta docs])
...
* Fix current\_temperature is rounded ([@aufano] - [#6960]) ([温控 docs])
...
* Replace 'vendor\_id' with 'arch' (fixes #7003) ([@fabaff] - [#7023])
...
* Bugfix slider ([@pvizeli] - [#7047]) ([input\_slider docs][input_slider docs])
* Add MaryTTS platform ([@johanpalmqvist] - [#6988]) ([tts.marytts docs]) (new-platform)
* Fix mysensors callback ([@MartinHjelmare] - [#7057]) ([mysensors docs]) ([device\_tracker.mysensors docs][device_tracker.mysensors docs])
...
* Telegram bot component (incl. Webhook and polling platform) ([@sander76] - [#6913]) ([telegram\_bot docs][telegram_bot docs]) ([telegram\_bot.polling docs][telegram_bot.polling docs]) ([telegram\_bot.webhooks docs][telegram_bot.webhooks docs]) (breaking change) (new-platform)
* 升级 paho-MQTT to 1.2.2 ([@fabaff] - [#7066])
* Fix handling with register callbacks on added\_to\_hass ([@pvizeli] - [#7067])
* Lutron. Bugfix callback registration. ([@pvizeli] - [#7042])
* Adding AlarmDecoder platform ([@hawk259] - [#6900])
* Add communication data 属性 to Zwave node\_entity ([@turbokongen] - [#6813]) ([zwave docs])
* Add product\_name 属性 to zwave nodes. ([@andrey-git] - [#7071])
...
* Better Thread safety in zwave node\_entity ([@andrey-git] - [#7087])
...
* Send stderr of ping tracker to devnull ([@amelchio] - [#7096]) ([device\_tracker.ping docs][device_tracker.ping docs])
...
* Always return True/False from is\_state and is\_state\_attr ([@amelchio] - [#7138])
* Add LIFX Cloud 场景 support ([@amelchio] - [#7124]) ([场景.lifx\_cloud docs][场景.lifx_cloud docs]) (new-platform)
...
* small fix for random effect in order to use the whole rgb range. So 255 is not excluded anymore. ([@Mister-Espria] - [#7156]) ([灯光.flux\_led docs][灯光.flux_led docs]) ([灯光.yeelight docs])
* exposed content\_type in rest\_command ([@cmsimike] - [#7101])
...
* Fix #7026 adding a new wol parameter ([@titilambert] - [#7144]) ([开关.wake\_on\_lan docs][开关.wake_on_lan docs])
...
* Fix id 区域 mismatch ([@gurumitts] - [#7165]) ([lutron\_caseta docs][lutron_caseta docs]) (breaking change)
...
* opensky 传感器 ([@happyleavesaoc] - [#7061]) ([传感器.opensky docs]) (new-platform)
* Add ping 二元sensor ([@fabaff] - [#7052]) ([binary\_sensor.ping docs][binary_sensor.ping docs]) (new-platform)
* Added 灯光.pwm component. ([@soldag] - [#7009])
* Fix for 错误 on missing preview on LG webos TV ([@masarliev] - [#6755]) ([媒体播放器.webostv docs])
* Fix auto discovery for Apple TV ([@postlund] - [#7188]) ([媒体播放器.apple\_tv docs][媒体播放器.apple_tv docs])
* Do not request artwork if not available ([@postlund] - [#7189]) ([媒体播放器.apple\_tv docs][媒体播放器.apple_tv docs])
