...
To get started today, start with making sure that you have [Hass.io 已安装][hassio]. After that, go to the Hass.io 面板 in Home Assistant, open the 插件 store, scroll down to DuckDNS and 安装 it. In the DuckDNS 设置 change "accept\_terms" to true and start it.
