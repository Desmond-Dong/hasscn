...
* Modbus: Modbus write\_register accept list ([@benvm])
* 设备 tracker - Ping: Add 设备 detected by ping as SOURCE\_TYPE\_ROUTER instead of GPS ([@michaelarnauts])
...
* 灯光 - Hyperion: Change CONF\_DEFAULT\_COLOR CV type ([@Joeboyc2])
...
* 模板: Add icon\_template to 模板 传感器 (@tboyce1)
...
* 温控 - Ecobee: Support away\_mode as permanent hold and hold\_mode as temporary hold. ([@Duoxilian])
...
* Fix hdmi\_cec with new customize ([@andrey-git])
...
* Discovery: flux\_led discovery led to problems on systems and has been removed ([@bazwilliams])
