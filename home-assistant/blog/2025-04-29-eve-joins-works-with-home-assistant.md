...
如果你还不知道，Works with Home Assistant 与其他认证计划不同，它会在内部进行严格测试，确保产品开箱即可与 Home Assistant 无缝协作。加入计划的公司也承诺提供长期支持和固件更新，并在 Home Assistant 社区中发挥积极作用。Works with Home Assistant 由 [Open Home Foundation](https://www.openhomefoundation.org/) 运营，而 [Home Assistant Cloud](/home-assistant/cloud/index.md) 订阅者的支持正为这项工作提供资金。
