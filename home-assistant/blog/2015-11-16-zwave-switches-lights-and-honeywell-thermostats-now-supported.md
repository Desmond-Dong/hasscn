...
* Thermostat: [Honeywell](/home-assistant/integrations/honeywell/index.md) now supported ([@sander76])
* 开关: [Orvibo](/home-assistant/integrations/orvibo.md) now supported ([@happyleavesaoc])
* 摄像头: [mjpeg 摄像头's](/home-assistant/integrations/mjpeg.md) now supported ([@ryanturner])
* 通知: Pushetta now supported ([@fabaff])
* 灯光: [MQTT](/home-assistant/integrations/light.mqtt/index.md) now supported ([@hexxter])
...
* New component [logger](/home-assistant/integrations/logger/index.md) allows filtering logged data ([@badele])
* New component [updater](/home-assistant/integrations/updater/) will 通知 用户 if an 更新 for Home Assistant is available ([@rmkraus])
* 通知: [PushBullet](/home-assistant/integrations/pushbullet.md) now allows targeting contacts/channels/specific 设备 ([@tomduijf])
