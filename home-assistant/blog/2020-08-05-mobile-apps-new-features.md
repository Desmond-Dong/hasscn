...
* 我们的WebView中添加了Cookie管理器，允许您保存您可能在[webpage 卡片](/home-assistant/dashboards/iframe/index.md)中使用的网站中的cookie。
