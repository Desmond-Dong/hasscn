...
这是刚刚发布的新产品。这款 TRV 可以通过 Zigbee 直接由 Home Assistant 控制，也可以通过 Aqara 网关来控制。该网关可以通过 [HomeKit Controller 集成](/home-assistant/integrations/homekit_controller/index.md) 以本地方式接入 Home Assistant。
