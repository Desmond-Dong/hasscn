...
<p class="img">
  <img src="/home-assistant/images/blog/2017-05-orangepi/orangie-pi-setup.png" />
</p>

<!--more-->

Download [Armbian](https://www.armbian.com/orange-pi-zero/) and create the SD card with [balenaEtcher](https://www.balena.io/etcher). There is no way to connect a display to the Orange Pi Zero. This means you need a wired network setup with a DHCP server. After your Orange Pi Zero is running, give it some time, and look for its IP address. The hostname is `orangepizero`.

After you find the IP address, use your SSH client to connect to the Orange Pi Zero. The default password is `1234`.
...
Let's run an upgrade to make sure all available packages are up to date.
...
These steps to install Home Assistant are also described in the [documentation](/home-assistant/docs/installation/armbian/) and the guide for [`venv`](/home-assistant/docs/installation/virtualenv/). Switch to the newly created user `ha` and perform the remaining installation steps, which are reduced to the minimum below:
...
<p class="img">
  <img src="/home-assistant/images/blog/2017-05-orangepi/orange-pi-running.png" />
</p>
