...
这种卡片还可以与其他支持多个实体的卡片一起使用，例如 [glance](/home-assistant/dashboards/glance/index.md) 或 [picture-glance](/home-assistant/dashboards/picture-glance/index.md)。默认情况下，它使用[实体卡片](/home-assistant/dashboards/entities/index.md)模型。
...
使用 [glance](/home-assistant/dashboards/glance/index.md) 仅显示在家的人：
