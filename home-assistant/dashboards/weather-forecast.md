...
Theme:
description: 用于此卡片的任何已加载主题的名称。有关主题的更多信息，请参阅 [前端文档](/home-assistant/integrations/frontend/index.md)。

:::important
此卡片仅适用于定义了 `weather` 实体的平台。
例如，它适用于 [OpenWeatherMap](/home-assistant/integrations/openweathermap/index.md#weather)，但不适用于 [OpenWeatherMap 传感器](/home-assistant/integrations/openweathermap/index.md#sensor)
:::
...
默认的天气图标可以通过[主题](/home-assistant/integrations/frontend/index.md#themes)进行主题化。主题变量包括：
...
天气图标可以通过[主题](/home-assistant/integrations/frontend/index.md#themes)用您自己的个人图片覆盖。主题变量包括：
