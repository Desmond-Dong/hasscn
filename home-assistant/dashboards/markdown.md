...
content:
required: true
description: "要渲染为 [Markdown](https://commonmark.org/help/) 的内容。可以包含[模板](/home-assistant/docs/configuration/templating/index.md)。"
type: string
title:
required: false
description: 卡片标题。
...
theme:
required: false
description: 使用任何已加载的主题覆盖此卡片所使用的主题。有关主题的更多信息，请参阅[前端文档](/home-assistant/integrations/frontend/index.md)。
type: string
show\_empty:
required: false
