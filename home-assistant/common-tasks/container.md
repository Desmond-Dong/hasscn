...
要了解如何备份系统，或如何从备份恢复系统，请参阅[通用任务](/home-assistant/common-tasks/general/index.md#备份)中的备份文档。

## 更新

### 前提条件

1. [备份您的安装](/home-assistant/common-tasks/general/index.md#备份)，并将备份和[备份应急工具包](/home-assistant/more-info/backup-emergency-kit/index.md)保存在安全的地方。
...
然后使用新镜像重新创建容器。请参阅[安装 Home Assistant Container](/home-assistant/installation/linux.md#install-home-assistant-container)。
...
如果您想降级安装，请改为执行[从备份恢复](/home-assistant/common-tasks/general/index.md#恢复备份)。
...
*如果您的容器名称不是 `homeassistant`，请在下面的示例中替换该名称。*
...
查看某个集成的配置（此示例中为 [`light`](/home-assistant/integrations/light.md)）：
