...
这里描述的常规设置由 [Home Assistant 核心集成](/home-assistant/integrations/homeassistant/index.md) 管理。如果您对此集成提供的动作感兴趣，请查看集成文档。
...
1. 转到 [**设置** > **系统** > **常规**](https://my.home-assistant.io/redirect/general/)。
   ...
   * 然后，调整位置和半径。 <img class="no-shadow" src='/home-assistant/images/docs/configuration/change_location_radius.webp' alt='显示如何在编辑主页上缩放和平移以更改位置和半径的屏幕录制'>
   * 要添加新区域，选择 **添加区域**。
   * 要保存更改，选择 **更新**。
...
4. **故障排除**：如果任何设置显示为灰色且无法编辑，这是因为它们在 **`configuration.yaml`** 文件中定义。
   ...
   * 有关 YAML 中常规设置的更多信息，请参阅 [Home Assistant 核心集成文档](/home-assistant/integrations/homeassistant/index.md)。
...
5. 要应用更改，请按照 [重新加载配置](/home-assistant/docs/configuration/index.md#reloading-configuration-changes) 上的步骤操作。
...
* [认证](/home-assistant/docs/authentication/index.md)
* [多因素认证](/home-assistant/docs/authentication/multi-factor-auth/index.md)
* [帮助，我被锁定了](/home-assistant/docs/locked_out/index.md)
