...
Home Assistant 中的每个实体都有一个默认图标。数量太多无法在此一一列出，但您会在仪表盘中看到它们。您可以[自定义任何实体](/home-assistant/docs/configuration/customizing-devices/index.md)来更改显示给您的图标。
...
有关自定义实体（包括其图标）的更详细步骤，请参阅[自定义实体](/home-assistant/docs/configuration/customizing-devices/index.md)。
...
浏览可用图标的最后一种方法是在 Pictogrammers 网站上查看图标库，<https://pictogrammers.com/library/mdi/>。选择您想使用的图标，然后选择"Home Assistant"查看其使用示例。
