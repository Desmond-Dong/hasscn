...
在使用表格时，您可以选择多个项目来应用动作。如果您通过将项目分配到楼层、区域、标签或分类来进行[分组](/home-assistant/docs/organizing/index.md)，您也可以相应地筛选数据。
...
3. 您现在可以对所有选中的元素应用更改，例如[应用标签](/home-assistant/docs/organizing/labels/index.md)或[启用或禁用实体和自动化](/home-assistant/common-tasks/general/index.md)。
...
2. 在筛选面板中，选择您的筛选条件。
   ...
   * 如果您之前定义了[楼层](/home-assistant/docs/organizing/floors/index.md)、[区域](/home-assistant/docs/organizing/areas/index.md)、[标签](/home-assistant/docs/organizing/labels/index.md)和[类别](/home-assistant/docs/organizing/categories/index.md)，可以按这些进行筛选。
   * 可用的条件列表取决于表格的类型。
