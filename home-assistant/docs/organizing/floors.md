...
2. 在对话框中，输入楼层详情：
   ...
   * 添加 **别名**。
     * 别名是 [语音助手](/home-assistant/voice_control/aliases/index.md) 中用于引用实体、区域或楼层的替代名称。
...
4. 您现在可以[将区域分配给该楼层](/home-assistant/docs/organizing/areas/index.md#assigning-areas-to-floors-and-add-labels)。
