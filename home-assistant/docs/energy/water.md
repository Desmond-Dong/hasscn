...
一些带有水表的硬件还可能提供额外的实用功能或传感器，例如[阀门](/home-assistant/integrations/valve.md)，用于控制水阀开关，或温度和压力（用于启用冻结报警）。

我们有以下集成可用于提供用水信息的现有产品：

* [Droplet](/home-assistant/integrations/droplet.md)
* [Flo](/home-assistant/integrations/flo.md)
* [Flume](/home-assistant/integrations/flume.md)
* [HomeWizard Energy](/home-assistant/integrations/homewizard.md)
* [StreamLabs](/home-assistant/integrations/streamlabswater.md)
* [Suez Water](/home-assistant/integrations/suez_water.md)
* [Watergate](/home-assistant/integrations/watergate.md)

还有一些基于现有通用 IoT 协议标准的用水监控产品：

* [Z-Wave](/home-assistant/integrations/zwave_js.md)
* [Zigbee](/home-assistant/integrations/zha.md)
...
您可以通过将一个设备设置为另一个设备的"上游设备"来创建用水设备的层级结构。这可以防止重复计算，例如当您有一个主水表和单独的设备水表时。有关设置设备层级结构和防止重复计算的更多详细信息，请参阅[单个设备文档](/home-assistant/docs/energy/individual-devices/index.md)。
...
* Pieter Brinkman 有一篇[不错的博客文章，介绍如何使用 ESPHome 创建自己的水传感器](https://www.pieterbrinkman.com/2022/02/02/build-a-cheap-water-usage-sensor-using-esphome-home-assistant-and-a-proximity-sensor/)，或者[制作一个与 P1 Monitor 集成](/home-assistant/integrations/p1_monitor.md)配合使用的水表]\(https://www.ztatz.nl/p1-monitor-watermeter/)。
* [AI-on-the-edge-device](https://github.com/jomjol/AI-on-the-edge-device) 是一个运行在 ESP32-CAM 上的项目，可以使用 MQTT 的 Home Assistant 发现功能完全集成到 Home Assistant 中。它将您的燃气/水/电表显示数字化，并以多种方式提供其数据。![AI-on-the-edge-device 工作流程照片](/home-assistant/images/docs/energy/ai-on-the-edge-device.jpg)
...
如果您手动集成传感器，例如使用 [MQTT](/home-assistant/integrations/MQTT) 或 [RESTful](/home-assistant/integrations/rest.md) 集成：请确保为这些传感器设置并提供 `device_class`、`state_class` 和 `unit_of_measurement`。
