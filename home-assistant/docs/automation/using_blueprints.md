...
如果您因某些原因不想[重新导入蓝图](/home-assistant/docs/automation/using_blueprints/index.md#重新导入蓝图)，可以手动编辑其 YAML 内容以保持最新：

1. 前往蓝图目录 (`blueprints/automation/`)。
   此目录的位置取决于安装类型。这与查找 [`configuration.yaml`](/home-assistant/docs/configuration/index.md#editing-configurationyaml) 的方式类似。
...
通过[阅读我们关于创建蓝图的教程](/home-assistant/docs/blueprint/tutorial/index.md)，了解更多关于蓝图的信息。
