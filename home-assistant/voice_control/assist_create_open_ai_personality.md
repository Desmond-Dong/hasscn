...
* 根据提示词选择一个个性设定。
* 获得带有你定义角色风格的回复。
* 执行 Home Assistant 意图（如打开/关闭灯光等），前提是 Assist 已按照我们的[最佳实践](/home-assistant/voice_control/best_practices.md)正确配置。
...
Home Assistant 同时支持由 [Open AI](/home-assistant/integrations/openai_conversation/index.md) 或 [Anthropic](/home-assistant/integrations/anthropic/index.md) 提供的云端代理，以及由 [Ollama](/home-assistant/integrations/ollama.md) 提供的本地代理。

## 前提条件

* 已根据我们的[最佳实践](/home-assistant/voice_control/best_practices.md)配置好 Home Assistant 和 Assist。
...
1. 前往 [**设置** > **设备 & 服务**](https://my.home-assistant.io/redirect/integrations/) 并 **Add 集成**，找到你的 LLM 提供商，并使用 API 密钥完成设置。
   * 如果使用 Ollama 这类本地代理提供商，你需要配置代理已安装位置的本地 URL。此时请遵循对应的[集成建议](/home-assistant/integrations/ollama.md)。
...
4. 配置该代理（点击代理名称旁边的齿轮图标）。
   ...
   * 定义该语音助手是否被允许控制你家中的设备。
     ...
     * **Assist**：你可以与代理对话，它也可以控制设备。例如，它可以打开灯光。
       * Assist 只能控制那些已[暴露](/home-assistant/voice_control/voice_remote_expose_devices/index.md)给它的设备。
...
5. 你可以取消勾选 Recommended model 设置，然后点击 Submit，这会解锁更多自定义项。以 OpenAI 为例，可在[这里](/home-assistant/integrations/openai_conversation/index.md#model)查看其他设置的简要说明。

6. 你可以直接在语音助手面板中测试该代理，在代理菜单中选择 Start a conversation。它会像在任何语音硬件上一样控制你的 Home Assistant 并进行回复。

7. 如果你需要排查 LLM 提供商相关问题，请在我们的[集成文档](/home-assistant/integrations.md)中查看对应 AI 的具体说明。
...
* [ESP32-S3-BOX 语音助手](/home-assistant/voice_control/s3_box_voice_assistant/index.md)
* [$13 语音助手 using ATOM Echo](/home-assistant/voice_control/thirteen-usd-voice-remote/index.md)
* [Assist on Android](/home-assistant/voice_control/android/index.md)
* [Assist on Apple](/home-assistant/voice_control/apple/index.md)
