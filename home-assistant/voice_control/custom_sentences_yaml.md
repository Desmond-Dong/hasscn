...
你可以在 `configuration.yaml` 文件中的 [`conversation`](/home-assistant/integrations/conversation/index.md) 配置里添加意图和语句：
...
你也可以添加新的意图，并通过 [`intent_script`](/home-assistant/integrations/intent_script/index.md) 集成为它们定义响应和动作：
...
* [自定义语句主页](/home-assistant/voice_control/custom_sentences.md)
* [$13 的 Home Assistant 语音助手](/home-assistant/voice_control/thirteen-usd-voice-remote/index.md)
