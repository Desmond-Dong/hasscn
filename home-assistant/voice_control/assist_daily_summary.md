...
* [Home Assistant Cloud](https://www.nabucasa.com) 或手动配置的[本地语音助手管线](/home-assistant/voice_control/voice_remote_local_assistant/index.md)。
...
1. 前往[集成页面](/home-assistant/integrations/index.md)，选择日历 **Calendar** 筛选器。
2. 选择一个你喜欢的日历，并按照文档说明安装。
3. 如果你只是想跟着本教程操作，请安装 [local calendar](/home-assistant/integrations/local_calendar/index.md) 集成。
...
1. 前往[集成页面](/home-assistant/integrations/index.md)，选择 **Weather** 筛选器。
...
1. 前往[集成页面](/home-assistant/integrations/index.md)，选择 **通知** 筛选器。
2. 选择一个你喜欢的聊天服务，并按照文档说明安装。
3. 如果不确定，请选择 **Telegram** 并添加该集成。
4. 如果你还没有，请先在手机上安装 Telegram。
5. 要开始在 Home Assistant 中使用 Telegram，请按照[设置说明](/home-assistant/integrations/telegram/index.md#configuration-example)逐步操作。
...
* [创建一个 Mario 个性](/home-assistant/voice_control/assist_create_open_ai_personality/index.md)。
