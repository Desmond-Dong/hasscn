...
* 已安装 Home Assistant Operating System 的 Home Assistant 2023.12 或更高版本。如果您尚未安装 Home Assistant，请参考[安装页面](/home-assistant/installation/index.md)
...
1. 确保您的助手已经[启用唤醒词](/home-assistant/voice_control/install_wake_word_add_on/index.md)，并使用 “OK Nabu”。
...
4. 如果您选择了设备端唤醒词处理，但不想使用 *Okay Nabu*，可以更改设备端唤醒词。
   ...
   * 如需更改，请按照[在 S3-BOX-3 上自定义设备端唤醒词](/home-assistant/voice_control/s3-box-customize/index.md#customizing-on-device-wake-words-microwakeword)中的步骤操作。
...
2. 说出一条[受支持的语音命令](/home-assistant/voice_control/builtin_sentences/index.md)。例如，*打开灯*。
   * 意图处理完成后，LED 会亮起绿色，Home Assistant 也会确认该操作。
     * 请确保您使用的区域名称与 Home Assistant 中定义的完全一致。
     * 您也可以提出问题，例如：
       * *前门锁上了吗？*
       * *客厅里有哪些灯是开着的？*
3. 如果您的命令不受支持，可以使用[句子触发器](/home-assistant/voice_control/custom_sentences/index.md)添加自己的命令。
