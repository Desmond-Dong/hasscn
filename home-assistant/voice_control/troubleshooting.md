...
6. 检查是否成功。
   ...
   * 检查您的短语是否[受支持](/home-assistant/voice_control/builtin_sentences/index.md)。
...
1. 请确保您已安装[天气服务](/home-assistant/integrations/index.md#weather)。
   * 默认情况下会安装 [Met.no](/home-assistant/integrations/met/index.md)。
...
5. 请确保您可以访问配置文件。
   * 如果您不确定该使用哪种方式，可以[安装 File editor 应用](/home-assistant/common-tasks/os/index.md#installing-and-using-the-file-editor-app)。
