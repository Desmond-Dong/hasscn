...
* 您已经[安装了 Home Assistant](/home-assistant/installation/index.md)
* 您已完成[初始设置步骤](/home-assistant/getting-started/onboarding/index.md)
* 您已按照[添加集成](/home-assistant/getting-started/integration/index.md)的步骤操作
* 您有一个已集成到 Home Assistant 的灯光
  * 如果您还没有灯光，不确定买什么，试试 [Philips Hue](/home-assistant/integrations/hue/index.md)、[nanoleaf](/home-assistant/integrations/nanoleaf/index.md) 或支持 [WLED](/home-assistant/integrations/wled/index.md) 的产品
...
5. 输入 `light` 并选择 **打开灯光**。
   ...
   * 这只有在您的灯光分配到区域时才有效。
   * 要了解更多关于在区域中分组设备的信息，请参阅[区域文档](/home-assistant/docs/organizing/areas/index.md)。
...
6. 要保存自动化，选择 **保存**。给自动化命名，添加 **描述**，然后再次 **保存**。
   ...
   * 或者按照这些步骤立即[测试您的自动化](/home-assistant/docs/automation/troubleshooting/index.md#testing-your-automation)。
...
7. [测试您的自动化](/home-assistant/docs/automation/troubleshooting/index.md#testing-your-automation)。

:::info [在场检测](/home-assistant/getting-started/presence-detection/index.md)
:::

完成此入门后，如果您有兴趣阅读更多关于自动化的内容，我们推荐以下页面：

* [触发器](/home-assistant/docs/automation/trigger/index.md)
* [条件](/home-assistant/docs/automation/condition/index.md)
* [动作](/home-assistant/docs/automation/action/index.md)
