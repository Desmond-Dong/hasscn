...
* 所有可以在 HA 中分组的媒体播放器类型都可以通过[播放器列表](/music-assistant/ui/index.md#player-list)或 <a href="https://www.home-assistant.io/integrations/media_player/#action-media_playerjoin" target="_blank" rel="noopener noreferrer">HA 操作</a>在 MA 中分组

## 配置

在添加播放器提供者之前，必须安装[插件](/music-assistant/ha-plugin/index.md)。下图显示了成功安装的样子
...
有关 MA UI 中看到的设置的信息，请参阅[播放器提供者设置](/music-assistant/settings/player-provider/index.md)和[单个播放器设置](/music-assistant/settings/individual-player/index.md)页面。
