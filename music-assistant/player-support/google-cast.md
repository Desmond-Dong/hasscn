...
除了[单个播放器设置](/music-assistant/settings/individual-player/index.md)外，Google Cast 提供者还有一些独特的设置，如下所示：
...
* Cast 扬声器不支持音频交叉淡入淡出。如果您想要交叉淡入淡出和/或完全无缝支持，请在播放器的高级设置中启用"[流模式](/music-assistant/faq/tech-info/index.md#track-queueing)"。启用流模式可能会解决播放问题，但可能会带来禁用实际物理按钮和/或设备本身显示元数据的副作用
...
* 可以通过[通用组](/music-assistant/faq/groups/index.md#universal-groups)分组 Cast 播放器，尽管它们可能不会同步播放
