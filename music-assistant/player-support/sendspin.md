...
当客户端连接时，单个 Sendspin 播放器将自动出现，标准[播放器设置](/music-assistant/settings/player-provider/index.md)适用。
...
| **[Google Cast (Sendspin 模式)](/music-assistant/player-support/google-cast/index.md)** | Chromecast 设备的实验性 Sendspin 模式 |
