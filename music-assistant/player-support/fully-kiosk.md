...
除了[单个播放器设置](/music-assistant/settings/individual-player/index.md)之外，Fully Kiosk 提供者还有以下设置：
...
* 如果在单个播放器设置中启用了[流模式](/music-assistant/faq/tech-info/index.md#track-queueing)，则支持交叉淡入淡出。启用流模式也可能解决播放问题，但可能会有禁用实际物理按钮和/或设备本身显示元数据的副作用
* 此播放器可以通过[通用组](/music-assistant/faq/groups/index.md#universal-groups)分组，但无法实现完美同步。
