...
* 有一个按钮可用于清除 Music Assistant 使用的缓存。不要经常使用此按钮，因为它会增加 [API 使用量](/music-assistant/usage/index.md#online-metadata-sources)并减慢 MA 体验
...
此部分包含影响 MA [音量标准化](/music-assistant/faq/tech-info/index.md#volume-normalization)功能的设置。此功能默认启用，设置也可在[单个播放器](/music-assistant/settings/individual-player/index.md#audio)上使用。通过在设置 UI 中为每个选项选择 !<a href="/assets/icons/question-mark.png" target="_blank"><img src="/assets/icons/question-mark.png" alt="问号" loading="lazy" style="max-width: 100%;" /></a> 图标，可以获得这些设置的详细在线帮助。
