...
[流媒体服务器设置](/music-assistant/settings/core/index.md#streamserver-audio-settings)包含许多选项，这些选项决定音量标准化将如何执行。此外，[单个播放器设置](/music-assistant/settings/individual-player/index.md#audio)提供启用和禁用此功能的选项以及调整[目标级别](/music-assistant/settings/individual-player/index.md#advanced-settings)。
