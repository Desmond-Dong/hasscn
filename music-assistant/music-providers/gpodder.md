...
| 自托管本地媒体  | 否 |
| 支持的媒体类型 | 播客 |
| 支持[推荐](/music-assistant/ui/index.md#view-home) | 否 |
| 支持歌词 | 否 |
| [电台模式](/music-assistant/ui/index.md#track-menu) | 否 |
| 最高流媒体质量 | 有损，可变质量 |
...
支持 <a href="https://github.com/gpodder/mygpo" target="_blank" rel="noopener noreferrer">mygpo</a> 兼容的网络服务，此提供者已针对 <a href="https://github.com/kd2org/opodsync" target="_blank" rel="noopener noreferrer">opodsync</a> 进行测试
要设置此功能，您需要：
...
要实现与 MA 用户的单个媒体项目进度的正确同步，请参阅[用户管理](/music-assistant/settings/user-management/index.md#filter-progress-multi-user)。
