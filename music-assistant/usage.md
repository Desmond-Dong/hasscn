...
> \[!NOTE]
> 如果相同的项目（例如专辑或音轨）没有跨提供商或在提供商内匹配，请导航到项目的[提供商详情](/music-assistant/ui/index.md#provider-details)部分并使用那里的选项链接它们。
...
作为进一步筛选库的方法，项目可以标记为"收藏"。这在 UI 中显示为实心心形图标。从音乐提供商导入时项目是否默认收藏取决于[提供商设置](/music-assistant/music-providers/index.md)。如果您取消选择顶部菜单中的心形图标，您可以看到所有项目。
