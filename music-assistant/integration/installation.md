...
> \[!NOTE]
> | HA 集成将为 MA 原生支持的播放器类型创建新的 media\_player 实体。要查看这些播放器的名称，请转到`HA 设置 >> 设备与服务 >> 集成 >> MUSIC ASSISTANT`并查看实体。这些是需要在自动化和脚本中作为目标的播放器
...
* [music\_assistant.play\_media](/music-assistant/faq/massplaymedia/index.md)
* [music\_assistant.play\_annnouncement](/music-assistant/faq/massannounce/index.md)
* [music\_assistant.transfer\_queue](/music-assistant/faq/masstransfer/index.md)
* [music\_assistant.search](/music-assistant/faq/masssearch/index.md)
* [music\_assistant.get\_library](/music-assistant/faq/get_library/index.md)
* [music\_assistant.get\_queue](/music-assistant/faq/get_queue/index.md)
