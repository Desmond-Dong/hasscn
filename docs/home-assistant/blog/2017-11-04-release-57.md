...
description: Due to Hacktoberfest we had to ship more fixes, improvements and components
  than usual.
---
...
- Fixed update() method and removed `ding` feature from stickupcams/floodlight ([@tchellomello] - [#10428]) ([binary_sensor.ring docs]) ([摄像头.ring docs]) ([传感器.ring docs])
...
- API.AI was renamed to [Dialogflow](/home-assistant/integrations/dialogflow/). This requires to rename the entry in your `configuration.yaml` file from `apiai:` to `dialogflow`. ([@fabaff] - [#10006]) ([dialogflow docs]) (breaking change)
