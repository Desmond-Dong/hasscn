...
我们永远不会使用这些策略来改进 Home Assistant。我们做了一些令智能家居行业新颖且令人困惑的事情 - 我们明确请求您的帮助。例如，Home Assistant 有[选择加入统计](https://analytics.home-assistant.io/)；这些确实帮助我们关注人们正在使用的东西，并投入资源以产生最大的影响。当您[选择加入时，它确实有帮助](/home-assistant/integrations/analytics/)，但如果您不这样做，我们完全理解 - 这是您的家和您的数据。我们对语音也做了同样的事情，明确寻求帮助，并且希望您能帮助提高其唤醒词功能。
