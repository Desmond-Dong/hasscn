...
- IoT 课程的一部分
- 自动化一家疗养院！
- 用于编写代码、测试、构建，以及贡献 Home Assistant 的专用硬件
- HassIO - 面向新手的 Home Assistant 中枢

投票现已开启。为了尽量简化流程，我们使用了 [forum] 的投票功能。快去为你支持的方案投票吧。

投票截止时间：2017 年 4 月 30 日 23:59 UTC

[hardware]: /博客/2017/04/01/thomas-krenn-award/
