---
title: '0.67：Mastodon、Tahoma 开关与 Nanoleaf Aurora 灯光面板'
description: '<a href=''/home-assistant/integrations/版本/0.67''<img src=''/home-assistant/images/blog/2018-04-0.67/components.png'' style=''border: 0;box-shadow: none;''</a。'
---
...
- 新增 `folder_watcher` 组件 ([@robmarkcole] - [#12918]) ([folder_watcher docs]) (new-platform)
- 新增 FreeDNS 组件 ([@bdurrer] - [#13526]) ([freedns docs]) (new-platform)
- 新增 Google Maps 位置共享设备追踪器 ([@michaelarnauts] - [#12301]) ([device_tracker.google_maps docs]) (new-platform)
- 新增 Waze 路程时间传感器 ([@Myrddyn1] - [#12387]) ([传感器.waze_travel_time docs]) (new-platform)
...
- Add support for Nanoleaf Aurora 灯光 面板 ([@Oro] - [#13456]) ([灯光.nanoleaf_aurora docs]) (new-platform)
...
- Fix #13846 Double underscore in 蓝牙 address ([@aav7fl] - [#13884]) ([device_tracker docs])
- Fix race 条件 for component loaded before listening ([@balloob] - [#13887]) ([config docs])
- Missing property decorator added ([@syssi] - [#13889]) ([风扇.xiaomi_miio docs])
- Fix call to parent broadlink 开关 ([@Danielhiversen] - [#13906]) ([开关.broadlink docs])
- Import operation modes from air 加湿器 ([@syssi] - [#13908]) ([风扇.xiaomi_miio docs])
...
- 更新到 BMW ConnectedDrive 的新 `b2vapi` ([@ChristianKuehnel] - [#13305]) ([bmw_connected_drive docs]) ([binary_sensor.bmw_connected_drive docs]) ([门锁.bmw_connected_drive docs]) ([传感器.bmw_connected_drive docs]) (breaking change)
- 移除 MercedesME 组件。([@ReneNulschDE] - [#13538]) ([device_tracker docs]) (mercedesme docs) (binary_sensor.mercedesme docs) (传感器.mercedesme docs) (breaking change)
...
- Added ENTITY_ID_FORMAT import and set entity_id in __init__ ([@timmo001] - [#13642]) ([开关.broadlink docs]) (breaking change)

## 所有变更

- Updates default Pilight port number ([@frenck] - [#13419]) ([pilight docs]) (breaking change)
- 升级 mypy to 0.580 ([@fabaff] - [#13420])
- 更新 to new "b2vapi" of BMW ConnectedDrive ([@ChristianKuehnel] - [#13305]) ([bmw_connected_drive docs]) ([binary_sensor.bmw_connected_drive docs]) ([门锁.bmw_connected_drive docs]) ([传感器.bmw_connected_drive docs]) (breaking change)
- Add code owner for Manual 报警 with MQTT Control ([@colinodell] - [#13438])
- QNAP updates ([@colinodell] - [#13435]) ([传感器.qnap docs])
- Xiaomi MiIO 风扇: Xiaomi Air 加湿器 集成 ([@syssi] - [#12627]) ([风扇.xiaomi_miio docs])
- Bump songpal 版本, fixes lots of issues mentioned in #13022 ([@rytilahti] - [#13440]) ([媒体播放器.songpal docs])
- Removed the google home 警告 from emulated_hue ([@mf-social] - [#13436])
...
- 更新 total_connect_client to 0.17 for Honeywell L5100-WiFi Support ([@phileaton] - [#13473]) ([alarm_control_panel.totalconnect docs])
...
- Adds 模板 function state_attr to get 属性 from a 状态 ([@Nossnevs] - [#13378])
...
- Tradfri - unique_id's and color_temp support for rgb-bulbs ([@NovapaX] - [#13531]) ([灯光.tradfri docs])
...
- Fix BMW 设备 tracker toggling 状态 if vehicle tracking is disabled ([@ChristianKuehnel] - [#12999]) ([device_tracker.bmw_connected_drive docs])
- Xiaomi MiIO 开关: Support for the Xiaomi Chuangmi Plug V3 ([@syssi] - [#13271]) ([开关.xiaomi_miio docs])
- Add FreeDNS component ([@bdurrer] - [#13526]) ([freedns docs]) (new-platform)
- 更新 pylint to 1.8.3 ([@scop] - [#13544])
- Google Maps location sharing 设备 tracker ([@michaelarnauts] - [#12301]) ([device_tracker.google_maps docs]) (new-platform)
...
- xiaomi lib 升级 ([@Danielhiversen] - [#13577]) ([xiaomi_aqara docs])
- Remove MercedesME component ([@ReneNulschDE] - [#13538]) ([device_tracker docs]) (mercedesme docs) (binary_sensor.mercedesme docs) (传感器.mercedesme docs) (breaking change)
- Added Waze travel time 传感器 ([@Myrddyn1] - [#12387]) ([传感器.waze_travel_time docs]) (new-platform)
...
- Added support for requesting RSSI values from 蓝牙 设备 ([@FrederikBolding] - [#12458]) ([device_tracker.bluetooth_tracker docs])
...
- Fix IMAP email message_data ([@zhaokoh] - [#13606]) ([传感器.imap_email_content docs])
...
- Use 0/1 for 树莓派 遮盖 GPIO writes rather than true/false ([@fezfox] - [#13610]) ([遮盖.rpi_gpio docs])
...
- 升级 youtube_dl to 2018.04.03 ([@fabaff] - [#13647]) ([media_extractor docs])
...
- Add missing 服务 docs for hs_color ([@armills] - [#13667])
...
- Spelling fixes ([@scop] - [#13681]) ([device_tracker docs]) ([smappee docs]) ([alarm_control_panel.ifttt docs]) ([温控.nest docs]) ([遥控器.xiaomi_miio docs])
- Xiaomi MiIO 灯光: White Philips Candle 灯光 support ([@syssi] - [#13682]) ([灯光.xiaomi_miio docs])
...
- 更新 ha-philips_js to 0.0.3 ([@danielperna84] - [#13702]) ([媒体播放器.philips_js docs])
- Coverage & Codeowners ([@kellerza] - [#13700])
- Bump insteonplm to 0.8.6 to fix 传感器 message handling ([@teharris1] - [#13691]) ([insteon_plm docs])
...
- Adding 配置 to disable IP address as a requirement Fixes: #13399 ([@PlanetJ] - [#13692]) ([device_tracker docs])
- Tahoma 开关 ([@ikucuze] - [#13636]) ([tahoma docs]) ([开关.tahoma docs]) (new-platform)
...
- Rename from aurora 灯光 to nanoleaf_aurora ([@Oro] - [#13831]) ([灯光.nanoleaf_aurora docs])
