...
description: Fool possible burglars by pretending you are at home with a blueprint,
...
Also, keep an eye out for the ESPHome 发布 next week Wednesday. We're
...
Are there more people who turn their 灯光 on and off at certain times
when they go on holiday?

This week's blueprint is that of [timgiwo](https://community.home-assistant.io/u/timgiwo),
who 创建 a blueprint that can repeat the behavior of your 灯光 from
the past week, so it seems like you are still at home. Try it out! Read more
about it on the [community forum][week_blueprint] or 安装 this 自动化
...
<div style="margin:0 auto; text-align:center">
    <a href="https://github.com/mattieha/slider-button-卡片" target="_blank">
        <img
            src='/home-assistant/images/blog/2021-06-11-community-highlights/button.gif'
            alt="Preview of the button slider 卡片"
            style='border: 0;box-shadow: none;width:90%;margin-bottom:15px;'
        />
    </a>
</div>

[Mattieha](https://github.com/mattieha) made a [button 卡片](https://github.com/mattieha/slider-button-卡片)
that also included a slider, so you could, for example: 开关 a 灯光 but
also immediately adjust the brightness with the slider. Useful for those who
want to keep their 仪表盘 compact.

<a href="https://github.com/mattieha/slider-button-卡片"><img style="border: 0;" src="https://gh-卡片.dev/repos/mattieha/slider-button-卡片.svg"></a>
...
who has a [仪表盘](https://github.com/theone11/HomeAssistantConfig) with a
...
<div style="margin:0 auto; text-align:center">
    <a href="https://github.com/alsFC/esphome-iSpindel" target="_blank">
        <img
            src='/home-assistant/images/blog/2021-06-11-community-highlights/ispindel.png'
...
that works with [ESPHome][esphome], it's a 传感器 with which you can
