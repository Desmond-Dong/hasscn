---
title: '0.46：Rachio 喷灌、Netgear Arlo 摄像头与 Z-Wave 风扇'
description: '<a href=''/home-assistant/integrations/版本/0.46''<img src=''/home-assistant/images/blog/2017-06-0.46/components.png'' style=''border: 0;box-shadow: none;''</a。'
---
...
- Continue tracking 设备 over dhcp lease table if wireless adapter not 已安装 ([@LvivEchoes] - [#7690]) ([device_tracker.mikrotik docs])
- device_tracker.ubus: Handle empty results ([@tobygray] - [#7673]) ([device_tracker.ubus docs])
- Bump pyEight 版本 ([@mezz64] - [#7701]) ([eight_sleep docs])
...
- Redesign monitored variables for hp_ilo 传感器 ([@Juggels] - [#7534]) ([传感器.hp_ilo docs]) (breaking change)
- Fix time_date 传感器 to 更新 at predictable intervals ([@stu-gott] - [#7644]) ([传感器.time_date docs])
...
- Powerview to async ([@sander76] - [#7682]) ([场景.hunterdouglas_powerview docs])
...
- 升级 pysnmp to 4.3.6 ([@fabaff] - [#7806]) ([device_tracker.snmp docs]) ([传感器.snmp docs])
- Rachio (Sprinklers) ([@Klikini] - [#7600]) ([开关.rachio docs]) (new-platform)
...
- 升级 pysnmp to 4.3.7 ([@fabaff] - [#7828]) ([device_tracker.snmp docs]) ([传感器.snmp docs])
- Flux led fix ([@danielhiversen] - [#7829]) ([灯光.flux_led docs])
...
- Optimize history_stats efficiency and database usage ([@bokub] - [#7858]) ([传感器.history_stats docs])
- don't use default for 开关 name, so that the object id is used ([@abmantis] - [#7845]) ([开关.broadlink docs]) (breaking change)
- Disallow ambiguous color descriptors in the 灯光.turn_on schema ([@amelchio] - [#7765]) (breaking change)
