...
description: 'Home Assistant 过去一直缺少一个与用户沟通的方式。比如家里没人时灯却被打开了，若能及时收到消息不是很好吗？由于 Home Assistant 前端在手机上是以 Web 应用形式运行，我们无法主动把自己切到前台。这正是新通知组件发挥作用的地方，而它由 PushBullet 驱动。'
---
# 你好 PushBullet，很高兴和你对话
