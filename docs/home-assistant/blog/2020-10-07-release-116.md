---
title: '0.116：实体卡片行编辑器、恢复快照与性能指标'
description: 现在可在引导期间上传并恢复快照，实体卡片行拥有 UI 编辑器，自动化编辑器支持星期选择，Supervisor 还加入了性能指标
---
...
any effect. Instead, 用户 should use [灯光 profiles](/home-assistant/integrations/light/)
as default color.
