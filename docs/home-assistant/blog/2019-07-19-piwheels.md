---
title: 旧版 Raspbian/Hassbian 的 piwheels 问题
description: '如果你使用的是 Hass.io(https://www.home-assistant.io/hassio/installation/)、Docker(https://www.home-assistant.io/docs/installation/Docker/)，或基于 Debian Buster 的发行版。'
---
# 旧版 Raspbian/Hassbian 的 piwheels 问题

_如果你使用的是 [Hass.io](https://www.home-assistant.io/hassio/installation/)、[Docker](https://www.home-assistant.io/docs/installation/Docker/)，或基于 Debian Buster 的发行版，那么本文不适用于你。_
