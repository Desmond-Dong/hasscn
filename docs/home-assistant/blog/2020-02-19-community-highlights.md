...
_This requires the Mosquitto 插件 to be 已安装 and an MQTT 传感器 ([instructions](https://www.home-assistant.io/integrations/sensor.MQTT))._
...
_This requires the MariaDB 插件 to be 已安装 and the recorder configured to use it ([instructions](https://github.com/home-assistant/hassio-addons/tree/master/mariadb))._
