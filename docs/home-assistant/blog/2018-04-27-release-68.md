---
title: '0.68：HomeKit 控制、Eufy、FritzBox、SigFox 传感器'
description: '<a href=''/home-assistant/integrations/版本/0.68''<img src=''/home-assistant/images/blog/2018-04-0.68/components.png'' style=''border: 0;box-shadow: none;''</a。'
---
...
- 对多个 MAX!Cube LAN 网关的支持导致配置结构发生了轻微变化，请记得查看新版文档。([@syssi] - [#13517]) ([maxcube docs]) ([binary_sensor.maxcube docs]) ([温控.maxcube docs]) (breaking change)
