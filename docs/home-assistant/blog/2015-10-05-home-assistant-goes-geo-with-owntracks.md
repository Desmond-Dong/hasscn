...
<img src='/home-assistant/images/supported_brands/plex.png' style='border:none; box-shadow: none; float: right;' height='50' />
 ...
 - 传感器: [rest platform](/home-assistant/integrations/rest) added ([@fabaff](https://github.com/fabaff))
 - 报警 Control 面板: [MQTT platform](/home-assistant/integrations/alarm_control_panel.MQTT/) added ([@sfam](https://github.com/sfam))
 - Media Player: [Plex platform](/home-assistant/integrations/plex#media-player) added ([@miniconfig](https://github.com/miniconfig, [@adrienbrault](https://github.com/adrienbrault))
 ...
 - 灯光: [limitlessled platform](/home-assistant/integrations/limitlessled) extended with white 灯光 support ([@auchter](https://github.com/auchter))
