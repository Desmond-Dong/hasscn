---
title: '2021.4：献给高级用户 ❤️'
description: '<a href=''/home-assistant/integrations/版本/2021.4''<img src=''/home-assistant/images/blog/2021-04/social.png'' style=''border: 0;box-shadow: none;''</a。'
---
# 2021.4：献给高级用户 ❤️
...
想了解它的工作原理以及会共享哪些数据，
请查看我们的[文档](/home-assistant/integrations/analytics)。
...
For more information, [see the documentation](/home-assistant/integrations/template/#configuration-for-trigger-based-template-sensors).
...
[scripts documentation](/home-assistant/integrations/script)
...
previous behavior, set [default_interface](/home-assistant/integrations/zeroconf/#default_interface)
to `false`.
...
See the [`analytics` integration](/home-assistant/integrations/analytics) for more details on
how to configure it.
...
- Add run_id to 自动化 logbook event ([@balloob] - [#47980]) ([自动化 docs])
...
- Type check KNX 集成 __init__ and knx_entity ([@farmio] - [#48044]) ([knx docs])
