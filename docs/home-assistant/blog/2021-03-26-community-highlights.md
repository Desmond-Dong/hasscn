...
This week's blueprint is all about 温控 and energy saving,
[SmartLiving.Rocks](https://community.home-assistant.io/u/smartliving.rocks/) has
written a handy blueprint that can 开关 your 温控 设备 based on whether a
...
<object type="image/svg+xml" data="https://gh-卡片.dev/repos/dylandoamaral/uptime-卡片.svg?link_target=_blank"></object>

For those who would like to show their uptime robot status or other types of
二元sensor in a very special way, there is now a new 卡片 made by
...
<div style="margin:0 auto; text-align:center">
    <a href="https://github.com/dylandoamaral/uptime-卡片" target="_blank">
        <img
            src='/home-assistant/images/blog/2021-03-26-community-highlights/uptime-card.png'
            alt="How the uptime-卡片 will looks like"
            style='border: 0;box-shadow: none;width:75%;'
        />
    </a>
</div><br>

Keep in mind that the 卡片 is still at an early stage of development.

## DIY Smart 门锁

Always wanted to make your door 门锁 smarter? Then try the DIY solution
from [bkbilly](https://community.home-assistant.io/u/bkbilly), with which
you can make your own smart door 门锁 with a stepper motor, 3D printed gears
...
[community forum](https://community.home-assistant.io/t/smart-门锁-with-gears/278231).
...
[week_blueprint]: https://community.home-assistant.io/t/window-open-温控-off/257293