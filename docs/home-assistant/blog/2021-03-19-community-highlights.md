...
description: From now on, never forget to put the wheelie bin on the street again,
...
are already various custom 集成 where you can keep track of when the pick-up
...
to get a 通知 every time so that you don't forget it.
...
are still looking for which 动作 they want to link to their Aqara Magic Cube.

<blockquote class="reddit-卡片" data-卡片-创建="1616149831"><a href="https://www.reddit.com/r/homeassistant/comments/m45tca/my_aqara_magic_cube_setup_is_a_bit_different/">My Aqara Magic Cube 设置 is a bit different (pet-proof). Details in comment.</a> from <a href="http://www.reddit.com/r/homeassistant">r/homeassistant</a></blockquote>
...
Still looking for a way how you would like to set up your own system 仪表盘? Maybe
the photo of [Akmantainman](https://www.reddit.com/user/Akmantainman/) will give you
some inspiration to make your own 版本 of this.

<blockquote class="reddit-卡片" data-卡片-创建="1616150627"><a href="https://www.reddit.com/r/homeassistant/comments/m6f23i/homelab_monitor_setup/">Homelab Monitor 设置</a> from <a href="http://www.reddit.com/r/homeassistant">r/homeassistant</a></blockquote>
<脚本 async src="//embed.redditmedia.com/widgets/platform.js" charset="UTF-8"></脚本>

Also look in the comments on Reddit, because many people shared their own
版本 on this post already.
