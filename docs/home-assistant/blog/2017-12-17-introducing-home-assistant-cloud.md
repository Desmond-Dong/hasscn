...
The first 服务 that is supported via the Home Assistant Cloud is the Amazon Alexa Smart Home skill. 此integrations will allow you to control all your 设备 in Home Assistant via Amazon Alexa. You will be able to say _“Alexa, 打开 the kitchen 灯光”_ and your local Home Assistant will 打开 the 灯光. Because Alexa talks to Home Assistant, it doesn’t Matter what kind of 灯光 they are! Anything that is linked to Home Assistant will work. IKEA 灯光, a 10 year old X10 开关 or something you’ve made yourself. As long as Home Assistant can control it, you can control it via Alexa.
...
升级 Home Assistant to 0.60 and enable the [`cloud`](/home-assistant/integrations/cloud/) and [`config`](/home-assistant/integrations/config/) components:
...
See the [Cloud component 配置](/home-assistant/integrations/cloud/) to learn how to filter which 设备 get exposed to Alexa.
