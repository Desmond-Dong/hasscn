---
title: '0.77: 认证 system 👮‍♂️ + Hangouts bot 🤖'
description: '<div class=''videoWrapper'' <iframe width="560" height="315" src="https://www.youtube.com/embed/Xm6tsnXabcw" frameborder="0" allowfullscreen</iframe </div。'
---
...
- The previously deprecated package `homeassistant.remote` has been removed. ([@balloob] - [#16099]) ([api docs]) ([http docs]) ([mqtt_eventstream docs]) ([mqtt_statestream docs]) ([通知 docs]) ([splunk docs]) ([websocket_api docs]) (breaking change)
