...
本次发布的第一个亮点，是许多人一直在期待的功能：自动化编辑器。它目前仍处于实验阶段，很多内容还在持续完善中，但已经可以使用。你现在可以创建新的自动化，也可以编辑现有自动化。如果你是从全新配置开始，那已经可以直接使用；否则，请先查看[这些说明](/home-assistant/docs/automation/editor/)，让你的自动化做好在 UI 中编辑的准备。
