---
title: '0.117：Quick Bar、紧凑页眉、YAML 编辑器、Xbox 与模板类型'
description: 可在任何地方使用的快速导航与搜索栏、内置紧凑页眉、在 UI 中编辑完整脚本/自动化 YAML，以及计数器、计时器助手与模板测试版改动
---
...
[Check the 文档 更多信息 and usage tips](/home-assistant/docs/tools/quick-search).
...
Instead, it should be set by [customizing 实体](/home-assistant/docs/configuration/customizing-devices/).
...
Please note, if you have a time-based 模板 where you _do not_ want it to
