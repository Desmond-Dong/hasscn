...
然后我写了几个[脚本](/home-assistant/integrations/script/)，在洗衣机或烘干机完成一轮后自动运行。这些脚本由 [automation component](/home-assistant/getting-started/automation/) 触发。当洗衣完成时，我会让家里的灯光变红，并通过 [notify me via PushBullet](/home-assistant/integrations/pushbullet) 收到通知。等衣物处理完后，另一个脚本会把灯光恢复正常。到目前为止，这套方案非常有帮助，也非常可靠。
