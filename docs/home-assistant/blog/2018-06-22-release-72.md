...
description: '我对这次发布非常兴奋，它很好地展示了我们如何持续打磨系统：一方面更可定制，另一方面也更用户友好。最让我激动的是全新的实验性用户界面，我们称它为 Lovelace。可以看看 @ciotlosm 整理的超详细功能总览(https://gist.github.com/ciotlosm/9508388876edf92。'
---
