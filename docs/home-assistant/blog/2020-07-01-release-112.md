---
title: '0.112：让一切更快；日志簿与历史记录'
description: '<a href=''/home-assistant/integrations/版本/0.112''<img src=''/home-assistant/images/blog/2020-07-0.112/social.png'' style=''border: 0;box-shadow: none;''</a。'
---
...
- **Xiaomi Gateway (Aqara)**
  ...
  If your Xiaomi Aqara Gateway does not show up automatically, go to "配置"-> "集成"-> press the "+" icon -> search for "xiaomi_aqara" and enter the 设置. If no key is provided during 设置, only the binary_sensor and 传感器 platforms will be available. A key is required to activate the other platforms.
