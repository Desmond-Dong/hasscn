---
title: '0.82：TensorFlow、Lovelace UI 编辑与 Z-Wave Barrier 类'
description: '又到了发布时间。这次覆盖了 HacktoberFest 的收尾阶段，所以内容依然非常充实。希望你会喜欢这些更新。 本页属于 Home Assistant 中文博客与更新记录，适合了解版本演进、功能变更与社区动态。'
---
...
- 更新 zha __init__.py to reflect new Zigbee name stylization by the Zigbee Alliance ([@Hedda] - [#17751]) ([zha docs])
