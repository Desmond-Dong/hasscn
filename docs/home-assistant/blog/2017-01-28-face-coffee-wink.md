...
- 配置: Fix load_yaml default value ([@balloob])
...
- 开关 - insteon_local.py: only check for 设备 when not defined in config ([@craigjmidwinter])
...
[openalpr]: /integrations/#图像-processing
