...
- Add type 配置 in history_stats ([@bokub] - [#6430])
...
- Fix gen_requirements_all.py 脚本 for Windows. ([@siebert] - [#6547])
...
- 升级 async_timeout to 1.2.0 ([@fabaff] - [#6590])
...
- 升级 to dsmr_parser 0.8, supporting protocol 3 and 5. ([@aequitas] - [#6600])
...
- Do not 日志 警告 on rest_command if no 错误 ([@balloob] - [#6713])
