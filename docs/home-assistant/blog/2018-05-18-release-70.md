---
title: '0.70：Facebox、SpaceAPI、Konnected 报警系统'
description: '0.70 版本来了。因为前端构建方式做了大规模重构，这次发布时间比预期稍晚一些。它不应该影响前端的外观和使用体验。感谢所有参与测试版并帮助验证的朋友。目前看 Firefox 在运行 Hass.io 面板时仍有一些问题，我们正在尽快发布修复。 本页属于 Home Assistant 中文博客与更新记录。'
---
...
- 新增更多 HomematicIP Cloud 组件 ([@mxworm] - [#14084]) ([homematicip_cloud docs]) ([binary_sensor.homematicip_cloud docs]) ([灯光.homematicip_cloud docs]) ([开关.homematicip_cloud docs]) (new-platform)
- 新增 Facebox ([@robmarkcole] - [#14356]) ([image_processing.facebox docs]) (new-platform)
...
- 新增 Konnected 组件，支持发现、二元传感器和开关 ([@heythisisnate] - [#13670]) ([konnected docs]) ([binary_sensor.konnected docs]) ([开关.konnected docs]) (new-platform)
...
- 对于 BMW 电动车：当前传感器 `remaining_range_fuel` 已被 `remaining_range_total` 取代，用于表示带燃油发动机车辆的总剩余续航。([@gerard33] - [#14293]) ([bmw_connected_drive docs]) ([binary_sensor.bmw_connected_drive docs]) ([传感器.bmw_connected_drive docs]) (breaking change)
...
- fix nanoleaf aurora 灯光 min and max temperature ([@Oro] - [#14571]) ([灯光.nanoleaf_aurora docs]) (beta fix)
- Fix ISY moisure 传感器 showing unknown until a leak is detected ([@OverloadUT] - [#14496]) ([binary_sensor.isy994 docs]) (beta fix)
- Bump insteonplm 版本 to fix 设备 hanging ([@teharris1] - [#14582]) ([insteon_plm docs]) (beta fix)
...
- Add unique_id to MQTT 开关 ([@thepotoo] - [#13719]) ([开关.MQTT docs])
...
- 更新 hitron_coda.py to fix login for Shaw modems ([@mikedm139] - [#14306]) ([device_tracker docs])
- Add 传感器 for BMW electric cars ([@gerard33] - [#14293]) ([bmw_connected_drive docs]) ([binary_sensor.bmw_connected_drive docs]) ([传感器.bmw_connected_drive docs]) (breaking change)
- Add more homematicip cloud components ([@mxworm] - [#14084]) ([homematicip_cloud docs]) ([binary_sensor.homematicip_cloud docs]) ([灯光.homematicip_cloud docs]) ([开关.homematicip_cloud docs]) (new-platform)
...
- Improving icloud 设备 tracker ([@evgeniy-khatko] - [#14078]) ([device_tracker docs])
- Adds useful 属性 to RainMachine programs and 区域 ([@bachya] - [#14087]) ([开关.rainmachine docs])
- Waze Travel Time: optional inclusive/exclusive filters ([@diraimondo] - [#14000]) ([传感器.waze_travel_time docs])
...
- 后端 tweaks to make authorization work ([@balloob] - [#14339]) ([api docs]) ([前端 docs]) ([http docs]) ([websocket_api docs])
...
- Bump PyXiaomiGateway 版本 ([@syssi] - [#14412]) ([xiaomi_aqara docs])
...
- Remove extra quotes from docstrings ([@scop] - [#14431]) ([folder_watcher docs]) ([传感器.sigfox docs]) ([传感器.simulated docs])
...
- 升级 requests_mock to 1.5 ([@fabaff] - [#14444])
- 升级 pyota to 2.0.5 ([@fabaff] - [#14442]) ([iota docs]) ([传感器.iota docs])
- 升级 python-telegram-bot to 10.1.0 ([@fabaff] - [#14441]) ([telegram_bot docs])
- 升级 Sphinx to 1.7.4 ([@fabaff] - [#14439])
- 升级 youtube_dl to 2018.05.09 ([@fabaff] - [#14438]) ([media_extractor docs])
...
- Add Konnected component with support for discovery, 二元sensor and 开关 ([@heythisisnate] - [#13670]) ([konnected docs]) ([binary_sensor.konnected docs]) ([开关.konnected docs]) (new-platform)
- Make Feedreader component more extendable ([@exxamalte] - [#14342]) ([feedreader docs])
- BMW code cleanup ([@gerard33] - [#14424]) ([binary_sensor.bmw_connected_drive docs]) ([传感器.bmw_connected_drive docs])
...
- Add stdout and stderr to 调试 output for shell_command ([@n8henrie] - [#14465]) ([shell_command docs])
- New 传感器 FinTS ([@ChristianKuehnel] - [#14334]) ([传感器.fints docs]) (new-platform)
- 更新 hitron_coda.py ([@mikedm139] - [#14506]) ([device_tracker docs])
...
- Flux bug fix ([@oblogic7] - [#14476]) ([灯光.flux_led docs]) ([开关.flux docs])
- Show 警告 if no locations are shared (fixes #14177) ([@fabaff] - [#14511]) ([device_tracker docs])
...
- 更新 mychevy to 0.4.0 ([@sdague] - [#14372]) ([mychevy docs]) ([binary_sensor.mychevy docs]) ([传感器.mychevy docs])
