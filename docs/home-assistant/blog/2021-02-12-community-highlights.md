...
your Home Assistant using the 按钮 on a StreamDeck but also display certain 传感器 values.

How cool is this!

<object type="图像/svg+xml" data="https://gh-卡片.dev/repos/cgiesche/streamdeck-homeassistant.svg?link_target=_blank"></object>

<a href="https://github.com/cgiesche/streamdeck-homeassistant" target="_blank">
  <img
    src='/home-assistant/images/blog/2021-02-12-community-highlights/streamdeck.png'
...
Quite recently ESPHome has received a new 更新 (1.16.0), with a lot of new hardware support.
From now on, you will also be able to expect more frequent updates, as they have adopted a monthly 发布 cycle.

<p class='img'>
  <a href="https://esphome.io/changelog/v1.16.0.html" target="_blank">
    <img
      src='/home-assistant/images/blog/2021-02-12-community-highlights/esphome.png'
      alt="A new 发布 更新 of ESPHome"
      style='border: 0;box-shadow: none;'
      />
  </a>
...
wonders whether there might be a market for these kinds of products. Quite a funny 设备
to remind yourself in certain situations 🙂

Who else would want one in the house?

<blockquote class="reddit-卡片" data-卡片-创建="1613128537">
<a href="https://www.reddit.com/r/homeassistant/comments/l1w4gh/is_there_a_market_for_bespoke_home_automation/">Is there a market for bespoke home 自动化 components? You may recall I built this interface to our home that speaks, rings, and 灯光 regular alerts. It has tasmota at its heart so is hardware based and easily interfaced with Home Assistant. Is there a market for me to make this kind of thing?</a> from <a href="http://www.reddit.com/r/homeassistant">r/homeassistant</a>
</blockquote>
