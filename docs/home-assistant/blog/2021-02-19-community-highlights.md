...
try this custom 集成 of [Miicroo](https://github.com/Miicroo).

<object type="图像/svg+xml" data="https://gh-卡片.dev/repos/Miicroo/ha-birthdays.svg?link_target=_blank"></object>
...
[sanderdw](https://github.com/sanderdw) has made an 插件 so that you can
easily use it with Home Assistant. Please note, the 插件 is still in an __Alpha__ 状态.

<object type="图像/svg+xml" data="https://gh-卡片.dev/repos/sanderdw/hassio-addons.svg?link_target=_blank"></object>

<a href="https://community.home-assistant.io/t/dsmr-reader-add-on-for-home-assistant/279087" target="_blank">
  <img
    src='/home-assistant/images/blog/2021-02-19-community-highlights/dsmr-reader.png'
    alt="Screenshot from the DSMR Reader 插件"
...
Would you like to display the 状态 of your smart washing machine (such as an LG ThinQ)
...
<blockquote class="reddit-卡片" data-卡片-创建="1613656949"><a href="https://www.reddit.com/r/homeassistant/comments/ll5ioi/took_some_trickery_but_my_laundry_card_is_done/">Took some trickery but my laundry 卡片 is done</a> from <a href="http://www.reddit.com/r/homeassistant">r/homeassistant</a></blockquote>
<脚本 async src="//embed.redditmedia.com/widgets/platform.js" charset="UTF-8"></脚本>
