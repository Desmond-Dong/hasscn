...
description: 'The idea of creating HTTP to MQTT bridge(https://github.com/petkov/httptomqtt) appeared when I was trying to integrate Google Assistant with my Home。'
---
# HTTP to MQTT bridge
...
1. 配置 the Home Assistant [MQTT 触发器](/home-assistant/docs/automation/trigger/#MQTT-触发器).
1. 配置 [CloudMQTT](https://www.cloudmqtt.com/). Check this [video 教程](https://www.youtube.com/watch?v=VaWdvVVYU3A) for details.
...
1. Add the [配置 Variables](https://devcenter.heroku.com/articles/config-vars#setting-up-config-vars-for-a-deployed-application) to your Heroku app mentioned here.
...
1. 配置 [Maker Webhooks](https://ifttt.com/maker_webhooks) 服务 with below parameters.
