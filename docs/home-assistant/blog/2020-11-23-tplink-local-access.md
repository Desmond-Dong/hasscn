...
description: '11 月 26 日更新： TP-Link 现已宣布他们正在开发新固件来解决该问题。在 Twitter 上私信他们以获取信息。 本页属于 Home Assistant 中文博客与更新记录，适合了解版本演进、功能变更与社区动态。'
  访问本地API。他们正在部分撤销这一决定。
---
# “[更好的解决方案！] TP-Link 提供了重新添加本地 API 的方法”
