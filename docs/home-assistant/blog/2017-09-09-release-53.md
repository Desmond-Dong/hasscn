---
title: '0.53: Tesla、自定义编辑器与超高速 KNX 重写'
description: '<a href=''/home-assistant/integrations/版本/0.53''<img src=''/home-assistant/images/blog/2017-09-0.53/components.png'' style=''border: 0;box-shadow: none;''</a。'
---
...
- The Homematic `delay` option has been dropped because it is no longer necessary ([@pvizeli] - [#9058]) ([homematic docs]) ([binary_sensor.homematic docs]) ([温控.homematic docs]) ([遮盖.homematic docs]) ([灯光.homematic docs]) ([传感器.homematic docs]) ([开关.homematic docs]) (breaking change)
