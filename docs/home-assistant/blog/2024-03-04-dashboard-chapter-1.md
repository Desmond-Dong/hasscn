---
title: '家庭认可的仪表盘第 1 章：拖放、剖面视图和新的网格系统设计！'
description: '哇！终于！一切顺利，我们实验性的仪表盘拖放功能终于来了！ 🥲。 本页属于 Home Assistant 中文博客与更新记录，适合了解版本演进、功能变更与社区动态。'
---
...
* 要添加新部分，请选择 **创建部分** 按钮。
  <img height="56px" src="/home-assistant/images/blog/2024-03-dashboard-chapter-1/sections-add-section-button.png" alt="Add Section button"/>
