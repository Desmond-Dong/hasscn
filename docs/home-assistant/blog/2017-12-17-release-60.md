...
description: Use Home Assistant for your production line or track prices and the stock
  market.
---
...
- Add Alpha Vantage 传感器 ([@fabaff] - [#10873]) ([传感器.alpha_vantage docs]) (new-platform)
- Add ADS component ([@stlehmann] - [#10142]) ([ads docs]) ([binary_sensor.ads docs]) ([灯光.ads docs]) ([传感器.ads docs]) ([开关.ads docs]) (new-platform)
- Gearbest 传感器 ([@HerrHofrat] - [#10556]) (new-platform)
- Add Ziggo Mediabox XL 媒体播放器 ([@b10m] - [#10514]) ([媒体播放器.ziggo_mediabox_xl docs]) (new-platform)
- Meraki AP 设备 tracker ([@masarliev] - [#10971]) ([device_tracker.meraki docs]) (new-platform)
...
- Add support for Logitech UE Smart Radios. ([@GreenTurtwig] - [#10077]) ([媒体播放器.ue_smart_radio docs]) (new-platform)
...
- Fix inverted 传感器 on the concord232 二元sensor component ([@CTLS] - [#11261]) ([binary_sensor.concord232 docs])
- Fix handling zero values for state_on/state_off ([@ziotibia81] - [#11264]) ([开关.modbus docs])
- Fix allday events in custom_calendars ([@maxlaverse] - [#11272]) ([日历.caldav docs])
- Fix unpredictable 实体 names in concord232 binary_sensor ([@rwa] - [#11292]) ([binary_sensor.concord232 docs])
- Fix leak 传感器 always showing Unknown until Wet ([@OverloadUT] - [#11313]) ([binary_sensor.isy994 docs])
- Don't block on 服务 call for alexa ([@pvizeli] - [#11358]) ([alexa.smart_home docs])
...
- ISY994 传感器 improvements ([@OverloadUT] - [#10805]) ([isy994 docs]) ([binary_sensor.isy994 docs]) (breaking change)
...
- More declarative timeout syntax for manual 报警 control 面板. ([@bonzini] - [#10738]) ([alarm_control_panel.manual docs]) ([alarm_control_panel.manual_mqtt docs])
...
- don't ignore voltage data if 传感器 data changed ([@PaulAnnekov] - [#10925]) ([xiaomi_aqara docs])
- Add ADS component ([@stlehmann] - [#10142]) ([ads docs]) ([binary_sensor.ads docs]) ([灯光.ads docs]) ([传感器.ads docs]) ([开关.ads docs]) (new-platform)
- Gearbest 传感器 ([@HerrHofrat] - [#10556]) (new-platform)
- Add Ziggo Mediabox XL 媒体播放器 ([@b10m] - [#10514]) ([媒体播放器.ziggo_mediabox_xl docs]) (new-platform)
- Generic thermostat initial_operation_mode ([@ziotibia81] - [#10690]) ([温控.generic_thermostat docs])
- Use new build path for dev translations ([@armills] - [#10937])
- Add option to set default hide if away for new 设备 ([@masarliev] - [#10762]) ([device_tracker docs])
...
- Added Vera 场景 ([@alanfischer] - [#10424]) ([vera docs]) ([场景.vera docs]) (new-platform)
- Fix Egardia 报警 status shown as unknown after 重启 ([@jeroenterheerdt] - [#11010]) ([alarm_control_panel.egardia docs])
...
- Added force_update for REST 传感器 ([@foxel] - [#11016]) ([传感器.miflora docs]) ([传感器.MQTT docs]) ([传感器.rest docs])
- Add support for Logitech UE Smart Radios. ([@GreenTurtwig] - [#10077]) ([媒体播放器.ue_smart_radio docs]) (new-platform)
...
- 升级 youtube_dl to 2017.12.10 ([@fabaff] - [#11080]) ([media_extractor docs])
- 升级 shodan to 1.7.7 ([@fabaff] - [#11084]) ([传感器.shodan docs])
- 更新 tellcore-net to 0.4 ([@pvizeli] - [#11087]) ([tellstick docs])
- Bump pymusiccast to 版本 0.1.6 ([@jalmeroth] - [#11091]) ([媒体播放器.yamaha_musiccast docs])
- Use luftdaten module ([@fabaff] - [#10970]) ([传感器.luftdaten docs]) (breaking change)
...
- Add problem 设备 class ([@armills] - [#11130]) ([binary_sensor docs])
- set default utc offset to 0 ([@pollett] - [#11114]) ([传感器.efergy docs])
- Allow using more than one keyboard 遥控器 ([@BryanJacobs] - [#11061]) ([keyboard_remote docs])
- ISY994 传感器 improvements ([@OverloadUT] - [#10805]) ([isy994 docs]) ([binary_sensor.isy994 docs]) (breaking change)
