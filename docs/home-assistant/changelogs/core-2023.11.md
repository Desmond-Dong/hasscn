---
title: Home Assistant Core 2023.11 的完整变更日志
description: '这些都是 Home Assistant Core 2023.11 版本中包含的所有更改。 本页属于 Home Assistant 中文文档，适合查阅安装部署、集成、自动化与日常使用说明。'
---
...
- 添加 loader.async_suggest_report_issue 和 loader.async_get_issue_tracker ([@emontnemery] - [#101336])
