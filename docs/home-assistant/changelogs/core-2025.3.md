---
title: Home Assistant Core 2025.3 完整更新日志
description: '以下是 Home Assistant Core 2025.3 版本包含的全部变更。 本页属于 Home Assistant 中文文档，适合查阅安装部署、集成、自动化与日常使用说明。'
---
...
- Explicitly pass in the config_entry in pvpc_hourly_pricing 协调器 ([@mib1185] - [#138032])
...
- 替换 `config.yaml` with 修正 `configuration.yaml` in folder_watcher ([@NoRi2909] - [#138434])
...
- 设置 parallel_updates in pyLoad 集成 ([@tr4nt0r] - [#138897])
