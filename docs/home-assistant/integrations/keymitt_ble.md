...
要使用此集成，运行 Home Assistant 的设备必须已正确设置并启用 [Bluetooth](/home-assistant/integrations/bluetooth)。不需要 Naran/Keymitt 集线器。
...
启用且正常运行 [Bluetooth](/home-assistant/integrations/bluetooth) 集成后，此集成会自动发现设备。
