...
All [climate actions](/home-assistant/integrations/climate) are supported except `set_swing_mode`.
...
For more details, see the [humidifier](/home-assistant/integrations/humidifier) integration documentation.
