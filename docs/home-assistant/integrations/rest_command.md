...
在自动化中，您可以使用 [`response_variable`](/home-assistant/docs/scripts/perform-actions#use-templates-to-handle-response-data) 访问该响应。
...
此示例使用 [templates](/home-assistant/docs/configuration/templating/) 构造动态参数。
...
可以在侧边栏的 [developer tools](/home-assistant/docs/tools/dev-tools/) 中调用这个新操作，并传入如下 `data`：
