---
title: Yardian
description: 'Yardian 集成可让您控制 Yardian 智能喷灌控制器(https://yardian.com/products/yardian-pro-smart-sprinkler-controller/)。 本页属于 Home Assistant 中文文档，适合查阅安装部署、集成、自动化与日常使用说明。'
ha_category:
  - Irrigation
  - Sensor
  - Switch
