...
Besides the standard actions provided by the Home Assistant [Light](/home-assistant/integrations/light/) and [Scene](/home-assistant/integrations/scene) integrations, the following extra actions are provided by the UPB integration:
