...
要获取站点的 ID，您需要在 [openSense 地图](https://opensensemap.org/) 上选择它，并在浏览器的地址栏中找到它。它是 URL 的最后一部分，例如 `5b450e565dc1ec001bf7cd1d` [https://opensensemap.org/explore/5b450e565dc1ec001bf7cd1d](https://opensensemap.org/explore/5b450e565dc1ec001bf7cd1d)。
