...
The `camera.play_stream` action may be used to send camera streams (HLS) directly to your device. This feature requires the [`stream` integration](/home-assistant/integrations/stream) and makes use of the PlayOnRoku API.
