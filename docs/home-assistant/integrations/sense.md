---
title: Sense
description: '将您的 Sense(https://sense.com) 电表信息集成到 Home Assistant 中。 本页属于 Home Assistant 中文文档，适合查阅安装部署、集成、自动化与日常使用说明。'
ha_category:
  - Binary sensor
  - Energy
  - Sensor
...
:::note
[Emulated Kasa](/home-assistant/integrations/emulated_kasa) 集成可通过模拟 TP-Link Kasa 智能插座，将 Home Assistant 中的设备暴露给 Sense Monitor。
