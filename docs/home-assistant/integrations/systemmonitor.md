...
:::note
All entities are disabled by default, you need to [enable the entities](/home-assistant/common-tasks/general/#enabling-or-disabling-entities) that you wish to use.
