...
- [通知](/home-assistant/integrations/dovado/#notifications)
- [传感器](/home-assistant/integrations/dovado/#sensor)
...
这是一个通知平台，因此可以通过调用通知动作来控制，[如所述](/home-assistant/integrations/notify/)。它将向通知 **target** 中的单个电话号码发送短信通知。
