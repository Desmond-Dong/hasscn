...
| 数据属性 | 可选 | 说明 | 示例 |
| ---------------------- | -------- | ----------- | ------- |
| `entity_id` | 否 | 要更新的实体。 | sensor.jacuzzi_j_335_primary_filtration_cycle |
...
| 数据属性 | 可选 | 说明 | 示例 |
| ---------------------- | -------- | ----------- | ------- |
| `entity_id` | 否 | 要更新的实体。 | sensor.jacuzzi_j_335_secondary_filtration_cycle |
...
| 数据属性 | 可选 | 说明 | 示例 |
| ---------------------- | -------- | ----------- | ------- |
| `entity_id` | 否 | 要更新的实体。 | binary_sensor.jacuzzi_j_335_refresh_water_reminder |
