...
它本质上与 [MQTT Alarm Panel](/home-assistant/integrations/alarm_control_panel.mqtt/) 相反。后者是让 Home Assistant 观察一个现有的、功能完整的报警设备，所有报警逻辑都内置在那个物理设备中。
...
详细说明请参阅 [manual alarm 平台](/home-assistant/integrations/manual)文档。
...
更多真实使用示例请参阅 [Manual Alarm Control 页面](/home-assistant/integrations/manual#examples)。

## MQTT 控制

你可以使用 [MQTT](/home-assistant/integrations/mqtt/) 控制该报警的状态。添加此组件前，请先确认已完成 MQTT 配置。
