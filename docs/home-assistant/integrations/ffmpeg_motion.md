---
title: FFmpeg Motion
description: 'FFmpeg Motion 集成允许您在 Home Assistant 中使用任何视频源和 FFmpeg(https://www.ffmpeg.org/) 进行运动检测。 本页属于 Home Assistant 中文文档，适合查阅安装部署、集成、自动化与日常使用说明。'
ha_category:
  - Image processing
...
如果您在使用此传感器时遇到问题，请参阅[故障排除部分](/home-assistant/integrations/ffmpeg/#troubleshooting)。
