...
由于 eQ-3 MAX! Cube 的连接数有限，如果仍有其他应用连接到网关，Home Assistant 将无法连接。这可能会导致类似 _Error: timed out You will need to restart Home Assistant after fixing._ 以及 _The following integrations and platforms could not be set up: maxcube Please check your configuration._ 这样的超时错误。
