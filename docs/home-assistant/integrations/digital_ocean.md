...
- [二值传感器](/home-assistant/integrations/digital_ocean/#binary-sensor)
- [开关](/home-assistant/integrations/digital_ocean/#switch)
...
要使用您的 Digital Ocean droplets，您首先需要设置您的 [Digital Ocean 集线器](/home-assistant/integrations/digital_ocean/)，然后将以下内容添加到您的 "`configuration.yaml`" 文件中：
