...
You can find the `event_data` `id` by going to [**Settings** > **Developer tools** > **Events**](https://my.home-assistant.io/redirect/developer_events/) and listening to "button_pressed" events. Then hit a button on the device and you should see an event.
