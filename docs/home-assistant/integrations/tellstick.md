...
To get started, add the integration to your "`configuration.yaml`" file.
:::tip
...
There is a [TellStick app for Home Assistant](/home-assistant/addons/tellstick/) (formerly known as TellStick add-on) available in the Home Assistant app store.
