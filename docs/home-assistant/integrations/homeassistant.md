...
Home Assistant Core 集成也负责管理常规设置。这些设置会在初始引导时定义，但你稍后也可以在 [**Settings** > **System** > **General**](https://my.home-assistant.io/redirect/general/) 下进行更改。详细步骤请参见[基本设置](/home-assistant/docs/configuration/basic/)。
...
其中大多数设置都可以在 UI 中更改。详细步骤请参见[自定义实体](/home-assistant/docs/configuration/customizing-devices/)。
...
- [Binary sensor](/home-assistant/integrations/binary_sensor/#device-class)
- [Button](/home-assistant/integrations/button/#device-class)
- [Cover](/home-assistant/integrations/cover/#device-class)
- [Event](/home-assistant/integrations/event/#device-class)
- [Humidifier](/home-assistant/integrations/humidifier/#device-class)
- [Media player](/home-assistant/integrations/media_player/#device-class)
- [Number](/home-assistant/integrations/number/#device-class)
- [Sensor](/home-assistant/integrations/sensor#device-class)
- [Switch](/home-assistant/integrations/switch/#device-class)
- [Update](/home-assistant/integrations/update/#device-class)
- [Valve](/home-assistant/integrations/valve/#device-class)
