...
description: "Nintendo Switch 家长控制集成允许您通过 Nintendo Switch 家长控制服务监控和控制儿童的屏幕时间。"
...
- 复制的链接的格式应类似于“npf54789befxxxxxxxx://auth#session_token_code={redacted}&state={redacted}&session_state={redacted}”。
