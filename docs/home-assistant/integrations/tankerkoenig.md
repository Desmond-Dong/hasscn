...
If you consider to [define a custom polling interval](/home-assistant/common-tasks/general/#defining-a-custom-polling-interval), then please keep in mind that requests should be limited to less than once every 5 minutes.
...
The example below uses the common [sensor card](/home-assistant/dashboards/sensor/) in the frontend and adds a visibility condition.
