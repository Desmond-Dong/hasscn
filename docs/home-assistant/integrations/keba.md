...
description: 'The Keba Charging Station integration integrates your Keba P30/P20 charging station/BMW Wallbox into your Home Assistant instance using the UDP Smart Home。'
ha_category:
  - Binary sensor
  - Lock
  - Notifications
...
The use of the notify action is [described here](/home-assistant/integrations/notify/).
