...
Your shopping list will be accessible from the sidebar, and you can optionally add the [To-do list card](/home-assistant/dashboards/todo-list/) to your dashboard. With the [conversation integration](/home-assistant/integrations/conversation/), you can add items to your shopping list using voice commands like "Add eggs to my shopping list."
