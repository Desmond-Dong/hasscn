...
这些凭据与 [Nest](/home-assistant/integrations/nest)、[Google Mail](/home-assistant/integrations/google_mail) 和 [Google Sheets](/home-assistant/integrations/google_sheets) 使用的是同一组。
它们与 [Google Calendar](/home-assistant/integrations/google) 使用的凭据不同。
...
随后，集成设置流程会引导您输入[应用程序凭据](/home-assistant/integrations/application_credentials/)，并授权 Home Assistant 连接到 YouTube。
