...
description: 'Open Hardware Monitor 集成会使用您的 Open Hardware Monitor(https://openhardwaremonitor.org/) 安装作为传感器数据源，以显示系统信息。 本页属于 Home Assistant 中文文档，适合查阅安装部署、集成、自动化与日常使用说明。'
ha_category:
  - System monitor
ha_release: 0.48
