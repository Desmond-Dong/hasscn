...
要在你的安装中使用MQTT气候，请先[将 MQTT 设备作为子条目添加](/home-assistant/integrations/mqtt/#configuration)，或者将以下内容添加到“`configuration.yaml`”文件中。
:::tip
...
或者，你也可以使用更高级的方式：通过 [MQTT discovery](/home-assistant/integrations/mqtt/#mqtt-discovery) 进行设置。
