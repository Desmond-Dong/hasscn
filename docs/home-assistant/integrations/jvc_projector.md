...
The JVC Projector remote platform will create a [Remote](/home-assistant/integrations/remote/) entity for the device. This entity allows you to send the following commands via the [remote.send_command](/home-assistant/integrations/remote/) action.
...
The JVC Projector binary sensor platform will create the following [Binary Sensor](/home-assistant/integrations/binary_sensor/) entity:
...
The JVC Projector sensor platform will create the following [Sensors](/home-assistant/integrations/sensor/) entities. Some of these sensors are disabled by default and may not be available for your model.
...
The JVC Projector select platform will create the following [Select](/home-assistant/integrations/select/) entities. Some of these selects are disabled by default and may not be available for your model.
