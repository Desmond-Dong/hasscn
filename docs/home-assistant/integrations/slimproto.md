...
description: 有关如何将基于 SlimProto 的播放器（例如 Squeezebox）集成到 Home Assistant 中而无需媒体服务器的说明。
ha_category:
  - Media player
ha_release: 2022.5
...
:::note
此集成会直接与运行 “SLIM” 协议的播放器通信，实际上相当于让 Home Assistant 充当媒体服务器，因此您不再需要 Logitech Media Server 或 Roon 之类的外部媒体服务器。这意味着您要播放的媒体需要能够在 Home Assistant 中获取，例如通过 [Radio Browser](/home-assistant/integrations/radio_browser) 集成或自定义的 [Music Assistant](https://github.com/music-assistant/hass-music-assistant) 集成提供。
