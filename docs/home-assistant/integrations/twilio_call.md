...
前提是您已设置好 [Twilio](/home-assistant/integrations/twilio/)。
...
Twilio 是一个通知平台，因此您可以像[此处所述](/home-assistant/integrations/notify/)那样，通过调用通知操作来控制它。它会向通知 `target` 中列出的所有 E.164 电话号码发送通知。有关电话号码格式的更多信息，请参阅上文关于 `from_number` 配置变量的说明。
