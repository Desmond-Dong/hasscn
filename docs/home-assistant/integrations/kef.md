---
title: KEF
description: 'KEF 集成可让您在 Home Assistant 中控制 KEF LS50 Wireless 和 KEF LSX(https://international.kef.com/products/lsx) 扬声器。 本页属于 Home Assistant 中文文档，适合查阅安装部署、集成、自动化与日常使用说明。'
ha_category:
  - Media player
