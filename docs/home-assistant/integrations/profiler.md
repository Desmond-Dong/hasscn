...
`profiler.lru_stats` 动作会记录 [lru_cache](https://docs.python.org/3/library/functools.html#functools.lru_cache) 和 [lru-dict](https://pypi.org/project/lru-dict/) 的统计信息，帮助你优化 Home Assistant，并定位内存泄漏。
