---
title: Folder
description: '用于监控文件夹内容的传感器。请注意，文件夹路径必须添加到 allowlistexternaldirs(/home-assistant/integrations/homeassistant/allowlistexternaldirs) 中。您也可以选择为文件夹中的文件应用一个通配符过滤器(https://doc。'
ha_category:
  - Sensor
  - Utility
