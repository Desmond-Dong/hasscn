...
1. 访问 [https://developer.home-connect.com](https://developer.home-connect.com) 并注册开发者账号。
...
集成配置会要求你填写上面创建的 *Client ID* 和 *Client Secret*。更多信息请参阅 [Application Credentials](/home-assistant/integrations/application_credentials)。
...
4. 若上述均正常但问题依旧，请联系 Home Connect 支持。
   - [Home Connect 服务与联系方式](https://www.home-connect.com/us/en/support/contact-and-service)
   - [Home Connect 开发者帮助与支持](https://developer.home-connect.com/support/contact)
