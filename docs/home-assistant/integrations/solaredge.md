...
You can show them in the UI using the [`Statistic card`](/home-assistant/dashboards/statistic/) or [`Statistics graph card`](/home-assistant/dashboards/statistics-graph/).
You can use them in automations using the [`SQL`](/home-assistant/integrations/sql/) integration.
...
To identify problematic modules, you could set up the [`SQL`](/home-assistant/integrations/sql/) integration with the following:
...
- The statistics are intentionally updated infrequently (every 12 hours). If you want more frequent updates, you can call the [`homeassistant.reload_config_entry`](/home-assistant/integrations/homeassistant/#action-homeassistantreload_config_entry) action from an automation.
