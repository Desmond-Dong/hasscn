---
title: YoLink
description: 'Integrates YoLink(https://www.yosmart.com/) Devices into Home Assistant. 本页属于 Home Assistant 中文文档，适合查阅安装部署、集成、自动化与日常使用说明。'
ha_category:
  - Binary sensor
  - Climate
  - Cover
...
<details>
<summary>Using custom application credentials</summary>
