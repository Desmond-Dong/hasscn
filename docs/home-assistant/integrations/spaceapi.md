...
To configure connectivity and authentication to the API that this integration exposes, refer to the HTTP integration documentation.
...
Although SpaceAPI supports many other sensors, this integration only supports temperature or humidity.
...
This integration implements SpaceAPI **version 13** (v0.13).
