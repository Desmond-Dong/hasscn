...
`qbittorrent.get_torrents` 动作使用提供的过滤器填充[响应数据](/home-assistant/docs/scripts/perform-actions#use-templates-to-handle-response-data)中的种子字典。
...
`qbittorrent.get_all_torrents` 动作使用提供的过滤器填充[响应数据](/home-assistant/docs/scripts/perform-actions#use-templates-to-handle-response-data)中的种子字典。
