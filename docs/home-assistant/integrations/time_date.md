...
For more information about using time related variables and sensors in templates (such as `today_at()`, `now()` or `as_timestamp()`) visit this [time section](/home-assistant/docs/configuration/templating/#time) on the templating page.
