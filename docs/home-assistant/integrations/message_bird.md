...
MessageBird is a notify platform and thus can be controlled by calling the notify action [as described here](/home-assistant/integrations/notify/). It will send a notification to the specified mobile phone number(s).
