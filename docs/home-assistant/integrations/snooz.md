---
title: Snooz
description: '将 SNOOZ(https://getsnooz.com/) 设备集成到 Home Assistant 中。 本页属于 Home Assistant 中文文档，适合查阅安装部署、集成、自动化与日常使用说明。'
ha_category:
  - Fan
ha_bluetooth: true
ha_release: '2022.11'
...
启用且可正常工作的 [Bluetooth](/home-assistant/integrations/bluetooth) 集成后，SNOOZ 集成会自动发现设备。
