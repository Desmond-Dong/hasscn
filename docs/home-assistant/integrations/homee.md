...
请先查看通用的 [Home Assistant 故障排查指南](/home-assistant/docs/configuration/troubleshooting/)。

**homee** 集成支持[调试日志和诊断](/home-assistant/docs/configuration/troubleshooting/#debug-logs-and-diagnostics)。
