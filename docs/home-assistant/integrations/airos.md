...
:::note
Ubiquiti UISP 产品不能从其流行的[UniFi](/home-assistant/integrations/unifi/) 软件进行管理。它们通常使用 Web 浏览器、UISP 移动应用程序或 UISP 平台（云端或[自托管](https://help.uisp.com/hc/en-us/articles/22591008678039-UISP-First-Time-Setup-Installation)）进行配置。
...
上面的示例目前考虑了 450 Mbit/s 的 25% 退化。如果您想以动态方式考虑您的实际容量，我们建议查看 [Statistics](/home-assistant/integrations/statistics/) 集成。
