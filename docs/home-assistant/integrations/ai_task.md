...
| `attachments`          | 是      | 要包含在任务中的附件列表。每个附件是 [媒体选择器](/home-assistant/docs/blueprint/selectors/#media-selector) 的输出。 |
...
- `media_source_id`：生成图像的 [媒体源](/home-assistant/integrations/media_source/) 内容 ID。
