---
title: Telegram
description: 'Telegram 集成已被标记为弃用，未来将被移除。 请改用 Telegram bot integration(/home-assistant/integrations/telegrambot)。 本页属于 Home Assistant 中文文档，适合查阅安装部署、集成、自动化与日常使用说明。'
ha_category:
  - Notifications
ha_release: 0.7.5
...
请改用 [Telegram bot integration](/home-assistant/integrations/telegram_bot)。
...
3. 在 Home Assistant 中创建一个 [Telegram bot](/home-assistant/integrations/telegram_bot)。
4. 创建通知器：
   - 将以下内容粘贴到配置文件中：
...
有关 `telegram_bot` 的配置，请参阅 [Telegram chatbot 页面](/home-assistant/integrations/telegram_bot/) 中提到的平台说明。
...
:::important
自 Home Assistant 0.48 起，您必须将要包含在通知中的文件所在源文件夹加入 [allowlist_external_dirs](/home-assistant/integrations/homeassistant/#allowlist_external_dirs) 白名单。
