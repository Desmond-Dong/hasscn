...
配置好基础 Twilio 集成后，您可以添加并配置 [Twilio SMS](/home-assistant/integrations/twilio_sms) 和/或 [Twilio Phone](/home-assistant/integrations/twilio_call) 集成，以使用通知功能。

要接收来自 Twilio 的事件，您的 Home Assistant 实例需要可从互联网访问，并且您需要在 Home Assistant 中[配置](/home-assistant/integrations/homeassistant/#external_url)外部 URL。
