---
title: IntelliClima
description: 'The IntelliClima integration is used to integrate with Fantini Cosmi(https://www.fantinicosmi.it/en/) Ecocomfort 2.0 ventilation devices. The Ecocomfort。'
ha_release: 2026.3
ha_category:
  - Fan
...
5. Check Home Assistant logs: Look for error messages in the Home Assistant logs for more details about the connection failure:
   - Go to [**Settings** > **System** > **Logs**](https://my.home-assistant.io/redirect/logs/).
