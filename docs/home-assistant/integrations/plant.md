...
The main sources of the data will usually be a [MiFlora sensor](/home-assistant/integrations/miflora) or a [MQTT sensor](/home-assistant/integrations/sensor.mqtt/) receiving the data from a [PlantGateway](https://github.com/ChristianKuehnel/plantgateway).
