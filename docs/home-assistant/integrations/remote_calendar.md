...
概览请参阅 [Calendar Automations](/home-assistant/integrations/calendar#automation)，可用触发变量请参阅 [Calendar Trigger Variables](/home-assistant/docs/automation/templating/#calendar)。您可以在条件或操作中使用事件的 `summary`、`description`、`location` 等信息。
