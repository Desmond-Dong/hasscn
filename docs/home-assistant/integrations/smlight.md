---
title: SMLIGHT SLZB
description: SMLIGHT SLZB 集成允许用户直接在 Home Assistant 中监控和管理其 SMLIGHT SLZB-06x 设备。
ha_category:
  - Binary sensor
  - Button
  - Sensor
...
The **SMLIGHT** integration will poll for sensor updates every 5 minutes, except for the internet connectivity sensor which is checked every 15 minutes. Firmware updates for both core and Zigbee are checked once per day.
