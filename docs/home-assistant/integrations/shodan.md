---
title: Shodan
description: 'The Shodan integration is displaying the total of result of a Shodan(https://www.shodan.io/) query. 本页属于 Home Assistant 中文文档，适合查阅安装部署、集成、自动化与日常使用说明。'
ha_category:
  - Sensor
