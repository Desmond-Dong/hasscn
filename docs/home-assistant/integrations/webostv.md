...
- [Media player](/home-assistant/integrations/media_player/)
- [Notifications](/home-assistant/integrations/notify/)
...
如果您想通过自动化来打开 LG webOS TV，请安装如 [HDMI-CEC](/home-assistant/integrations/hdmi_cec/) 或 [WakeOnLan](/home-assistant/integrations/wake_on_lan/) 等集成。它们提供了可用于开机的操作。
...
您也可以配置其他用于开机的 [actions](/home-assistant/docs/automation/action/)。
...
它使用 [Media player](/home-assistant/integrations/media_player/) 集成中的 `select_source` 操作，来启动安装在 LG 电视上的特定应用。
...
此集成依赖 [SSDP](/home-assistant/integrations/ssdp) 集成，必须启用后设备发现功能才能正常工作。

### [WakeOnLan](/home-assistant/integrations/wake_on_lan/) 无法工作
