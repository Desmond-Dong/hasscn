...
这些凭据与 [Nest](/home-assistant/integrations/nest)、[Google Sheets](/home-assistant/integrations/google_sheets) 和 [YouTube](/home-assistant/integrations/youtube) 的凭据相同。
...
The integration setup then gives you instructions to enter the [Application Credentials](/home-assistant/integrations/application_credentials/) and authorize Home Assistant to connect to Google Mail.
