...
The [Yale Access Bluetooth](/home-assistant/integrations/yalexs_ble) integration provides local control over Bluetooth of many Yale Home locks that use the same system.
...
- The [Yale Access Bluetooth integration](/home-assistant/integrations/yalexs_ble) must support the lock.
- The Bluetooth integration must be active and functional.
- The lock must be discoverable by the [Yale Access Bluetooth integration](/home-assistant/integrations/yalexs_ble).
...
- Ensure the lock is in range and discoverable by the [Yale Access Bluetooth integration](/home-assistant/integrations/yalexs_ble).
