...
1. 如果您在设备包装上看到 Matter 标识，请按照[将 Matter 设备添加到 Home Assistant](/home-assistant/integrations/matter/#adding-a-matter-device-to-home-assistant)中的步骤操作。

   <img src="/home-assistant/images/integrations/thread/matter_onpackbadge_logo.png"  width="200">

2. 如果您在设备包装上看到 Apple HomeKit 标识，请按照[将 HomeKit 设备添加到 Home Assistant](/home-assistant/integrations/homekit_controller/#adding-a-homekit-device-through-thread)中的步骤操作。
...
- [将 Matter 设备添加到 Home Assistant](/home-assistant/integrations/matter/#adding-a-matter-device-to-home-assistant)
- [通过 Thread 添加 Apple HomeKit 设备](/home-assistant/integrations/homekit_controller/#adding-a-homekit-device-through-thread)
...
2. 确保 Home Assistant Thread 网络已被设为首选网络。
   ...
   - 您应能在 **Preferred network** 下看到 Home Assistant 标识。
     ...
     ![image](/home-assistant/images/integrations/thread/thread-preferred-network-ha-only.png)
...
4. 要添加基于 Matter 的 Thread 设备，请按[将 Matter 设备添加到 Home Assistant](/home-assistant/integrations/matter/#adding-a-matter-device-to-home-assistant)中的步骤操作。
...
![image](/home-assistant/images/integrations/thread/thread-no-preferred-network-but-third-party-present.png)
...
4. 选择 **Make preferred network**。
   ...
   ![image](/home-assistant/images/integrations/thread/thread-google-br.png)
...
5. 要启用 Thread 支持，您需要安装 **OpenThread Border Router** 应用。请按对应流程操作：
   ...
   ![image](/home-assistant/images/integrations/thread/thread-ha-preferred.png)
...
- 智能家居主机上已安装 [Home Assistant Operating System](/home-assistant/docs/glossary/#home-assistant-operating-system)。例如：
...
- 您的智能家居主机上已安装 [Home Assistant Operating System](/home-assistant/docs/glossary/#home-assistant-operating-system)。例如：
  - Home Assistant Green（预装 Home Assistant OS）
  - Home Assistant Yellow 或 Raspberry Pi
