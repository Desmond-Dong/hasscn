---
title: Thread
description: 'Thread 集成可帮助您跟踪家中的不同 Thread 网络，并存储 Thread 网络凭据（类似于 Wi-Fi 密码）。Home Assistant 中的 Thread 集成目前仍在持续完善中。 本页属于 Home Assistant 中文文档，适合查阅安装部署、集成、自动化与日常使用说明。'
ha_category:
  - Other
ha_release: 2023.2
ha_codeowners:
