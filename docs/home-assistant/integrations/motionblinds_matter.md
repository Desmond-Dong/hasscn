...
Motionblinds Matter 设备在本地运行，并可与 Home Assistant 中的 Matter 集成无缝配合。由于所有连接都在本地完成，状态更新和设备控制都能在 Home Assistant 中即时生效。

[![Open **Add device** in your Home Assistant instance.](https://my.home-assistant.io/badges/add_matter_device.svg)](https://my.home-assistant.io/redirect/add_matter_device/?domain=motionblinds_matter)

[了解 Home Assistant 中有关 Matter 的更多信息。](/home-assistant/integrations/matter/)

## 支持的设备

### 支持蓝牙和 433MHz 的 Motionblinds

要通过 Matter 连接这些电机，您需要使用 Motionblinds Matter 网关（CM-55）。
...
### 支持 Matter 和 Thread 的 Eve Motionblinds

由 Eve 提供支持、基于 Matter 的 Motionblinds 设备需要 Thread 边界路由器才能接入网络。有关 Thread 的更多信息，请参阅 [Thread 文档](/home-assistant/integrations/thread/)。
...
若想查找可购买这些电机及定制窗帘的地点，请访问 [Motionblinds 门店查询](https://motionblinds.com/stores)。

若想进一步了解这些电机及其技术信息，请访问 [Motionblinds 网站](https://motionblinds.com/smart-connectivity/home-assistant)。
