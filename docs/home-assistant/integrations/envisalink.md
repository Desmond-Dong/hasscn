---
title: Envisalink
description: 关于如何使用 envisalink evl3/evl4 板将 DSC/Honeywell 报警面板与 Home Assistant 集成的说明。
ha_category:
  - Alarm
  - Binary sensor
  - Sensor
...
- Binary sensor：报告防区状态（可查看[类型/类别](/home-assistant/integrations/binary_sensor/#device-class)列表，以了解防区可能的可视化表示）
