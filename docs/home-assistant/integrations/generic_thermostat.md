...
description: 'The Generic Thermostat integration is a thermostat implemented in Home Assistant. It uses a sensor and a switch connected to a heater or air conditioning。'
ha_category:
  - Climate
  - Helper
ha_release: pre 0.7
...
as well. To enable the integration, you need to add it to your "`configuration.yaml`" file.
:::tip
