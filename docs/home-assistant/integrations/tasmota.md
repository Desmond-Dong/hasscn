...
- 在 Home Assistant 中设置 MQTT 代理和 [MQTT 集成](/home-assistant/integrations/mqtt/)。
...
- 当启用“SetOption73”时，Tasmota 按钮将被添加为 Home Assistant“自动化触发器”。不会创建“binary_sensor”实体。您可以在设备屏幕上找到可用的“自动化触发器”。 ![自动化触发器](/home-assistant/images/integrations/tasmota/tasmota_button_automations.png)
...
- Tasmota 开关将添加为 Home Assistant“binary_sensor”实体或“自动化触发器”，具体取决于启用“SetOption114”时使用的“switchmode”。
