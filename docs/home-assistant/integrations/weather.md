...
如需查看天气类集成列表，请在集成页面中选择[天气分类](/home-assistant/integrations/#weather)。
...
此操作会填充 [response data](/home-assistant/docs/scripts/perform-actions#use-templates-to-handle-response-data)，返回天气服务及其对应预报的映射。
...
包含每小时天气预报的 [template sensor](/home-assistant/integrations/template#yaml-configuration) 示例
