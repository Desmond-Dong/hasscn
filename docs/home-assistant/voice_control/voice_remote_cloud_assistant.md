...
3. 如需查看设置，请前往 [**设置** > **语音助手**](https://my.home-assistant.io/redirect/voice_assistants/)，然后在 **Assist** 下选择 **Home Assistant Cloud**。
   ...
   - **故障排除**：如果这里没有显示任何助手，说明您没有使用[默认配置](/home-assistant/integrations/default_config)。这种情况下，您需要在 `configuration.yaml` 文件中添加以下内容：
...
配置完成后，您就可以开始使用 Assist 了。现在，您可以通过您的设备与它对话，比如 [Android](/home-assistant/voice_control/android/)、[iOS](/home-assistant/voice_control/apple/)，或 [Voice Preview Edition](https://support.nabucasa.com/hc/en-us/categories/24451727188125-Home-Assistant-Voice-Preview-Edition)。

如果想获得更好的语音交互体验，别忘了查看[最佳实践](/home-assistant/voice_control/best_practices/)。
