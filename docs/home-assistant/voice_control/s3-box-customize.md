...
- 已成功完成[ESP32-S3-BOX-3 语音助手](/home-assistant/voice_control/s3_box_voice_assistant/)教程
...
3. 确保您已经[可以访问配置文件](/home-assistant/common-tasks/os/#configuring-access-to-files)。
   - [安装 Samba 应用](/home-assistant/common-tasks/os/#installing-and-using-the-samba-app)。
   - 这样可以一次复制多个文件。
4. 将图片文件夹复制到配置目录：
...
- 已安装 Home Assistant Operating System 的 Home Assistant 2024.2 或更高版本。如果您尚未安装 Home Assistant，请参考[安装页面](/home-assistant/installation/)
- 已成功[在 S3-BOX-3 上安装 ESPHome](/home-assistant/voice_control/s3_box_voice_assistant/)
