---
title: 设置在场检测
description: '区域在场检测可以检测人员是否在某个区域内，这可以作为自动化的重要输入。知道谁在家或他们在哪里可以开启一系列自动化选项：。 本页属于 Home Assistant 中文文档，适合查阅安装部署、集成、自动化与日常使用说明。'
---
# 设置在场检测
...
- [已安装 Home Assistant](/home-assistant/installation/)
- 已完成[初始设置步骤](/home-assistant/getting-started/onboarding/)
- [已启用远程访问](/home-assistant/docs/configuration/remote/)
  - 最简单的方法是启用
...
6. 检查您的[区域](/home-assistant/integrations/zone/)为自动化做准备。
...
:::info [加入社区](/home-assistant/getting-started/join-the-community/)
:::
