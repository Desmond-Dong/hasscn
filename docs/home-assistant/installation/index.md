...
- 推荐页面：[在 Raspberry Pi 上安装 Home Assistant](/home-assistant/installation/raspberrypi)
...
- [Odroid](/home-assistant/installation/odroid)
- [通用 x86-64](/home-assistant/installation/generic-x86-64)
- [其他安装方式](/home-assistant/installation/alternative)

## 遇到问题？

- 查看 [安装故障排除](/home-assistant/installation/troubleshooting)
- 安装完成后，继续阅读 [入门指南](/home-assistant/getting-started/)
