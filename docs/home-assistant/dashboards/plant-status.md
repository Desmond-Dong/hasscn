---
title: 植物状态卡片
description: '植物状态卡片是为所有可爱的植物爱好者准备的。 本页属于 Home Assistant 中文文档，适合查阅安装部署、集成、自动化与日常使用说明。'
---
# 植物状态卡片
...
实体:
  required: true
  description: "`plant` 域的实体 ID。更多信息，请参阅 [`plant` 集成](/home-assistant/integrations/plant)。"
  type: string
name:
  required: false
