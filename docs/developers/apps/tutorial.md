...
有关所有有效 app 配置选项的概述，请参见 [App configuration options](/developers/apps/configuration#app-configuration)。
...
现在导航到 [http://homeassistant.local:8000](http://homeassistant.local:8000) 查看我们的服务器运行效果！
