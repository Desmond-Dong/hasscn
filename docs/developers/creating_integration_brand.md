...
官方集成的品牌图片（图标和徽标）存储在[品牌库](https://github.com/home-assistant/brands)。自定义集成也可以提供自己的品牌图片。有关品牌图片及其提供方式的更多信息，请参阅[集成文件结构：品牌图片](/developers/creating_integration_file_structure#品牌形象---brand)。
