...
- 阅读[架构指南](/developers/apple/architecture)了解代码库布局。
- 浏览[目标概述](/developers/apple/targets)查看每个 surface（iPhone、Watch、CarPlay、widgets 等）。
- 在打开 pull request 之前，审阅[编码风格指南](/developers/apple/codestyle)。
- 在[持续集成指南](/developers/apple/ci)中了解 CI 如何工作。
