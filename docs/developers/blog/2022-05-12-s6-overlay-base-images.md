...
title: 我们 Docker base images 上的 S6-Overlay 3.x 更新
---
...
你需要调整你的 [AppArmor profile](/developers/apps/presentation#apparmor) 使其与新 s6-Overlay 配合工作。我们更新了文档中的默认 profile。需要进行以下更改：
