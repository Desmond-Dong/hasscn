...
title: "Frontend component updates 2026.6"
---
...
继上个版本介绍的 [context entry decorators](/developers/blog/2026-05-04-frontend-context-groups-decorators) 之后，我们为从 `internationalizationContext` 读取最常见的单个字段——`localize` 函数——添加了一个快捷方式。
