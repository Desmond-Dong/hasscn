...
title: "icon translations schema 的变更"
---

icon translations schema 已经调整，允许为[service 中的 sections](/developers/dev_101_services#grouping-of-service-action-fields)分配 icon。
