...
title: "add-ons 即将发生的变更"
---

:::note
本文描述的 builder action（`home-assistant/builder@master`）是遗留工作流。它已被专门的 composite actions 取代。请参见 [builder migration 博文](/developers/blog/2026-04-02-builder-migration) 了解当前推荐的方法。
:::
