...
title: "注册自定义 dashboard strategies"
---

从 Home Assistant 2026.5 开始，你现在可以注册自定义 dashboard strategies，就像你可以使用 [custom cards](/developers/frontend/custom-ui/custom-card) 一样，在 **Community dashboards** 部分下通过 **新的 dashboard** 对话框更容易地发现并添加它们。
...
查看更新后的 [custom strategies](/developers/frontend/custom-ui/custom-strategy) 文档，其中包含示例代码和更多详情。
