...
title: "Reauth 和 reconfigure flows 必须关联到一个 config entry"
---
...
更多详情请参阅 [reconfigure](/developers/core/integration/config_flow#reconfigure) 和 [reauthentication](/developers/core/integration/config_flow#reauthentication) 文档。