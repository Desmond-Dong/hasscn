...
title: "Sensor device classes 现拥有默认显示精度"
---
...
更多详情请参阅实现 [pull request](https://github.com/home-assistant/core/pull/145013) 和 [Sensor entity 文档](/developers/core/entity/sensor)。