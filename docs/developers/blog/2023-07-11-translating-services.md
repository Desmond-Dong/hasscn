...
`services.yaml` service 描述更新的示例可在[我们的文档中](/developers/dev_101_services#service-action-descriptions)找到。[后端本地化](/developers/internationalization/core#service-actions)也已扩展，包含一个已翻译 service 的示例，与 service 描述中的示例相匹配。
