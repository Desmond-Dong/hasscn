...
title: "用于 RF 设备集成的新 radio frequency entity platform"
---
...
这与 [`infrared` entity platform](/developers/blog/2026-03-30-infrared-entity-platform) 类似，并已在 [architecture discussion #1365](https://github.com/home-assistant/architecture/discussions/1365) 中获得批准。
...
更多详情，请参阅 [radio frequency entity 文档](/developers/core/entity/radio-frequency)。
