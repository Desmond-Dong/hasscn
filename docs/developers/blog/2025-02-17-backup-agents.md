...
第一个实现 backup agent 的集成是 Home Assistant Cloud 集成。在 2025 年 2 月的版本中，又有三个集成实现了 backup agents：Google Drive、OneDrive 和 Synology DSM。如果你是一名集成作者，并希望为你喜欢的备份位置添加支持，你可以在[开发者文档](/developers/core/platform/backup)中了解更多关于如何实现 backup agents 的信息。