---
title: "前端数据"
description: '前端会传递同一个 hass 对象。这个对象包含最新状态，允许你向服务器发送命令，并提供用于格式化实体状态的辅助方法。 本页属于 Home Assistant 开发者文档，适合查阅集成、前端、系统、语音与 API 相关实现说明。'
sidebar_label: "数据"
---
# 前端数据
...
一个包含 Home Assistant 中所有实体状态的对象。key 是 entity_id，value 是状态对象。
