...
请先按照我们的[devcontainer development environment](/developers/setup_devcontainer_environment)指南设置合适的开发环境。
...
你需要先准备一个 Home Assistant 实例。关于开发实例，请参阅我们的[设置开发环境](/developers/development_environment)指南。
