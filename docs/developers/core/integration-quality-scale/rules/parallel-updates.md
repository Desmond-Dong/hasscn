---
title: "指定并行更新数"
description: '某些设备或服务不喜欢同时接收大量请求。 为了避免这种情况，Home Assistant 有一个内置功能来限制同时发送到设备或服务的请求数量。 本页属于 Home Assistant 开发者文档，适合查阅集成、前端、系统、语音与 API 相关实现说明。'
---
# 指定并行更新数
...
有关请求并行性的更多信息，请检查 [documentation](/developers/integration_fetching_data#request-parallelism) 。
