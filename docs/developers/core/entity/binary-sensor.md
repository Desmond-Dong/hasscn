...
| 名称 | 类型 | 默认值 | 说明
| ---- | ---- | ------- | -----------
| is_on | <code>bool &#124; None</code> | `None` | **必需的**。二进制传感器当前打开或关闭。
...
| `BinarySensorDeviceClass.UPDATE` | 亮起表示有更新，熄灭表示是最新的。应避免使用此设备类，请考虑使用 [`update`](/developers/core/entity/update) 实体。
