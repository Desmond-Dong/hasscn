...
| `conversation_id` | string | 可选。[对话的唯一 ID](/developers/intent_conversation_api#conversation-id)。                                                                                                                                                                                                         |
...
| `intent-start` | 意图识别开始  | 总是     | `engine` - [代理](/developers/intent_conversation_api) 引擎<br />`language`: 处理语言。<br /> `intent_input` - 输入到代理的文本                                                                                                                         |
| `intent-progress`   | 意图识别的中间更新    | 取决于对话代理     | `chat_log_delta` - 可选，来自[聊天日志](/developers/core/entity/conversation#chat-log)的 delta 对象 <br /> `tts_start_streaming` - 可选，如果 TTS 流式传输已开始则为 True                                                                                                                                                                          |
| `intent-end`   | 意图识别结束    | 总是     | `intent_output` - [对话响应](/developers/intent_conversation_api#conversation-response)                                                                                                                                                                          |
