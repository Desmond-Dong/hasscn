...
模板句子需要提交到我们在 [GitHub 上的 Intents 仓库](https://github.com/home-assistant/intents)。句子将由[语言负责人](/developers/voice/language-leaders)审核，如果正确则合并。你可以贡献新句子或改进现有句子。

Intent 仓库结构如下：

- `sentences/<language>/` - 每种语言的模板句子 - [了解更多](/developers/voice/intent-recognition/template-sentence-syntax)
- `tests/<language>/` - 每种语言的测试 - [了解更多](/developers/voice/intent-recognition/test-syntax)
...
如果你无法在本地运行 add_language 脚本，请在 Discord 中请求维护者为你运行。
