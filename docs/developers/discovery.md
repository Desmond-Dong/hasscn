...
要了解有关 config flow 的更多信息，请查看[config flow 文档](/developers/core/integration/config_flow)。
要了解有关网络协议上的发现更多信息，请查看[网络与发现文档](/developers/network_discovery)。
要了解有关蓝牙设备发现的更多信息，请查看[蓝牙文档](/developers/bluetooth)。
要了解有关在 manifest 中指定不同发现方法的更多信息，请查看[集成 Manifest 文档](/developers/creating_integration_manifest)。
