---
title: "安卓代码检查指南"
description: 'linter 是一种静态代码分析器，可帮助识别代码中的引人注目的问题和潜在的改进。它通过确保正确使用语言并遵守最佳实践来超越编译器的作用。编译器根据语法验证代码，而 linter 则侧重于代码质量和架构。 本页属于 Home Assistant 开发者文档。'
sidebar_label: "短绒"
---
# 安卓代码检查指南
...
- **一致性**：强制执行标准代码风格，类似于我们的[codestyle](/developers/android/codestyle)。
...
我们使用 [KTLint](https://pinterest.github.io/ktlint) 作为 Kotlin linter，通过 [Gradle plugin](https://github.com/JLLeitschuh/ktlint-gradle) 集成。配置位于主`build.gradle.kts` 文件中。我们主要使用默认配置，但为 GitHub Actions 启用 [SARIF](/developers/android/tips/sarif_reports) 报告来注释拉取请求中的问题。
