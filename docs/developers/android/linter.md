...
- **一致性**: 强制执行标准代码风格，类似于我们的 [编码风格](/developers/android/codestyle)。
...
我们使用 [KTLint](https://pinterest.github.io/ktlint) 作为我们的 Kotlin linter，通过 [Gradle 插件](https://github.com/JLLeitschuh/ktlint-gradle) 集成。配置位于主 `build.gradle.kts` 文件中。我们大多使用默认配置，但启用了 [SARIF](/developers/android/tips/sarif_reports) 报告，以便 GitHub Actions 在 pull request 中标注问题。
