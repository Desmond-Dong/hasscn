...
你可以根据需要使用 playground，但只有在对其他开发者有价值时才提交更改。在向 playground 提交更改时，请确保遵循[编码风格](/developers/android/codestyle)和[最佳实践](/developers/android/best_practices)。不过，翻译可以省略。
