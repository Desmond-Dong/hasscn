---
title: "开发者游乐场"
description: '该应用程序严重依赖于 WebView 和与服务器的活动连接，这使得在开发过程中快速测试功能变得具有挑战性。通常，您可能需要多次重建应用程序以测试特定行为。虽然 撰写预览 功能可以帮助进行 UI 测试，但有时它们还不够，需要您完成整个 UX 流程，这可能会很乏味。'
...
您可以根据需要自由使用游乐场，但只有在为其他开发人员提供价值时才提交更改。对 Playground 进行更改时，请确保遵循 [codestyle](/developers/android/codestyle) 和 [best practices](/developers/android/best_practices)。然而，可以省略翻译。
