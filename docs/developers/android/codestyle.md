---
title: "安卓代码风格"
description: '我们的目标是维护一致且标准的代码库。通过强制执行代码风格：。 本页属于 Home Assistant 开发者文档，适合查阅集成、前端、系统、语音与 API 相关实现说明。'
sidebar_label: "代码风格"
---
# 安卓代码风格
...
如果检测到 KTLint 错误，CI 将失败，GitHub 将使用生成的 [SARIF](/developers/android/tips/sarif_reports) 报告将其作为 PR 中的评论进行报告。
