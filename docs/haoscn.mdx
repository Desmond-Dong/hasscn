...
export const VideoPlayer = ({ src, width = "100%", height = "400" }) => {
  return (
    <iframe
      src={src}
      width={width}
...
<VideoPlayer src="//player.bilibili.com/player.html?bvid=BV1tr7VzCE35&page=1" />

家庭宽带：1G约1~1.5分钟，500M约3分钟，100M约5分钟

**升级速度演示**

<VideoPlayer src="//player.bilibili.com/player.html?bvid=BV1judBY2ES7&page=1" />
