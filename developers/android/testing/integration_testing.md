...
[单元测试](/developers/android/testing/unit_testing.md)很棒，应是你编写测试时的首选。然而，集成测试确保在真实 Android 环境中应用的行为得到验证。集成测试通过模拟器在真实的 Android 操作系统上运行，使用终端用户也将使用的相同 JVM。
...
如果你的测试需要 WebView，你可能需要遵循这些[Lollipop 模拟器提示](/developers/android/tips/lollipop_emulator.md)。
