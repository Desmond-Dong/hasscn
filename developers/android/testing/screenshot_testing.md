...
* **不需要模拟器**：这些测试不需要模拟器，使它们资源消耗较少且比[集成测试](/developers/android/testing/integration_testing.md)快得多。
...
我们的[CI 流水线](/developers/android/ci.md)会验证测试报告中是否有任何错误。如果发现差异，CI 将阻止 pull request，直到问题解决。
