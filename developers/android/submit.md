...
* **公关说明**：提供您的更改的清晰完整的描述。
* **测试**：在我们的[testing guidelines](/developers/android/testing/introduction.md)之后添加所有必要的测试。
* **文档**：确保您的代码已正确记录。
...
* **最佳实践**：遵循[best practices](/developers/android/best_practices.md)。
* **代码风格**：遵守[code style](/developers/android/codestyle.md)。
* **棉绒**：确保不会引入 lint 问题 ([linter](/developers/android/linter.md))。
