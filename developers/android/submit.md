...
* **测试**: 遵循我们的 [测试指南](/developers/android/testing/introduction.md) 添加所有必要的测试。
* **文档**: 确保代码已妥善记录。
...
* **最佳实践**: 遵循 [最佳实践](/developers/android/best_practices.md)。
* **编码风格**: 遵循 [编码风格](/developers/android/codestyle.md)。
* **Linting**: 确保没有引入 lint 问题（[linter](/developers/android/linter.md)）。
