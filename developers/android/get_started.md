...
:::info
如果您需要创建发布版本，请遵循[release build instructions](/developers/android/tips/release.md)。
:::
...
请按照我们的[Push notification guide](/developers/android/tips/fcm_push_notification.md)获取其他设置说明。

## 下一步怎么办？

现在您已经构建了应用程序，请浏览文档的其余部分，以加深您对项目的理解。 [Architecture guide](/developers/android/architecture.md) 是一个很好的起点，它解释了代码库的一般结构。
