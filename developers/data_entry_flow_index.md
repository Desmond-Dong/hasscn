...
有关 `strings.json` 的更详细说明，请参阅[后端翻译](/developers/internationalization/core.md)页面。
...
有关数据录入流程（data entry flow）翻译的更多细节，请参阅[核心翻译文档](/developers/internationalization/core.md)。
