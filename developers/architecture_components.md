...
有关已定义域的列表，请参见 [entities](/developers/core/entity.md)。
...
与外部设备和服务交互的集成通常不允许消耗来自其他集成的 entity 状态，例外情况是具有位置的来自其他集成的 entity，例如 zone 和 device\_tracker entity 的状态。

更多信息请参见 [entity 架构](/developers/architecture/devices-and-services.md)。
