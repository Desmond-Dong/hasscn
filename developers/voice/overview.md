...
* **对话**集成负责处理用户文本。内置对话代理会把文本匹配到某个意图。集成也可以提供[自定义对话代理](/developers/core/entity/conversation.md)。
* **意图**集成负责执行意图并返回响应。
* **Text-to-Speech** 集成负责将文本转换为语音。集成也可以提供[自定义文本转语音代理](/developers/core/entity/tts.md)。
* **Speech-to-Text** 集成负责将语音转换为文本。集成也可以提供[自定义语音转文本代理](/developers/core/entity/stt.md)。
