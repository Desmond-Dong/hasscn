...
在 Home Assistant 中，我们将句子模板收集在 [GitHub](https://github.com/home-assistant/intents) 上。该仓库的目标是为每种语言，以及 Home Assistant 中每个[受支持的意图](/developers/intent_builtin.md)，收录用户可能说出的句子。
