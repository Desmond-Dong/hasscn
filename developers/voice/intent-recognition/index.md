...
在 Home Assistant 中，我们将 sentence templates 收集在 [GitHub](https://github.com/home-assistant/intents) 上。该仓库旨在针对每种语言和 Home Assistant 中的每个 [supported intent](/developers/intent_builtin.md)，包含用户可能会说的各种句子。
