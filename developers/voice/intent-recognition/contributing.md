...
模板句子需要提交到我们的 [GitHub Intents 仓库](https://github.com/home-assistant/intents)。这些句子会由[语言负责人](/developers/voice/language-leaders.md)审核，正确后将被合并。你既可以贡献新句子，也可以改进现有句子。

Intent 仓库的结构如下：

* `sentences/<language>/` - 各语言的模板句子 - [了解更多](/developers/voice/intent-recognition/template-sentence-syntax.md)
* `tests/<language>/` - 各语言的测试 - [了解更多](/developers/voice/intent-recognition/test-syntax.md)
