...
| `conversation_id` | string | 可选。[对话的唯一 ID](/developers/intent_conversation_api.md)。                                                                                                                                                                                                         |
...
| `intent-start` | 意图识别开始              | always     | `engine` - 使用的 [Agent](/developers/intent_conversation_api.md) 引擎<br />`language`: 处理语言。<br /> `intent_input` - 发送给代理的输入文本                                                                                                                         |
| `intent-progress`   | 意图识别的中间更新        | 取决于对话代理     | `chat_log_delta` - 可选，来自[聊天记录](/developers/core/entity/conversation.md)的增量对象 <br /> `tts_start_streaming` - 可选，如果 TTS 流式输出已开始则为 `true`                                                                                                                                                                          |
| `intent-end`   | 意图识别结束              | always     | `intent_output` - [对话响应](/developers/intent_conversation_api.md)                                                                                                                                                                          |
