...
* The documentation rules of the [Integration Quality Scale](/developers/core/integration-quality-scale.md).
...
你可以复用那些在多个页面中反复出现的[通用文本片段](/developers/documenting/general-style-guide.md#reusable-text)。
