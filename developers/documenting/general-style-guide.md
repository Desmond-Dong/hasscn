...
* 不要使用 "e.g."，请改用 *for example*、*such as* 或 *like*。
...
所有包含 Jinja2 模板的示例，都应在代码块 *外层* 使用 `{% raw %}` 包裹。
...
如果想了解为集成添加图片时的要求，请参见[图片、图标与 logo](/developers/documenting/create-page.md#images-icons-and-logos)。
...
关于编写集成文档时可复用的示例，请参见 [Configuration](/developers/documenting/create-page.md#configuration)。
...
关于术语表的推荐用法，请参见[术语表与术语提示](/developers/documenting/standards.md#glossary--terminology-tooltips)。
