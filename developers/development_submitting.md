...
2. 进行你的更改，创建[新平台](/developers/creating_platform_index.md)，开发[新集成](/developers/creating_component_index.md)，或修复[issues](https://github.com/home-assistant/core/issues)。

3. [测试你的更改](/developers/development_testing.md) 并检查是否存在风格违规。
   考虑添加测试以确保你的代码能够正常工作。

4. 如果根据这些[必须项](/developers/development_checklist.md) 一切看起来都没问题，提交你的更改：
