...
2. 进行更改，创建[新平台](/developers/creating_platform_index.md)，开发一个[新集成](/developers/creating_component_index.md)，或修复[问题](https://github.com/home-assistant/core/issues).

3. [测试您的更改](/developers/development_testing.md)并检查是否有样式违规。
   考虑添加测试以确保您的代码有效。

4. 如果根据这些一切看起来都不错[必须](/developers/development_checklist.md)，提交您的更改：
