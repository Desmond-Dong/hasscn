...
#### SSLContext.load\_verify\_locations

参见 [`SSLContext.load_default_certs`](#sslcontextload_default_certs)。

#### SSLContext.load\_cert\_chain
