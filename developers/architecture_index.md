...
* [操作系统](/developers/operating-system.md) 提供了运行 Supervisor 和 Core 所需的最小 Linux 环境。
* [Supervisor](/developers/supervisor.md) 管理系统。
* [Core](/developers/architecture/core.md) 与用户、supervisor 和 IoT 设备及服务交互。
