...
* [操作系统](/developers/operating-system.md)提供通信的Linux环境来运行Supervisor和Core。
* [Supervisor](/developers/supervisor.md)管理操作系统。
* [Core](/developers/architecture/core.md)与用户、Supervisor以及物联网设备和服务进行交互。
