...
除了 [voluptuous](https://pypi.python.org/pypi/voluptuous) 默认类型外，还有许多自定义类型。要概览它们，请查看 [config\_validation.py](https://github.com/home-assistant/core/blob/dev/homeassistant/helpers/config_validation.py) helper。
