...
除了 [voluptuous](https://pypi.python.org/pypi/voluptuous) 的默认类型外，我们还提供了许多自定义类型。概览请参阅辅助模块 [config\_validation.py](https://github.com/home-assistant/core/blob/dev/homeassistant/helpers/config_validation.py)。
