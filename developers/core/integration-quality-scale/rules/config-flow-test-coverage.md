...
有关配置流的更多信息，请参阅 [config flow documentation](/developers/config_entries_config_flow_handler.md)。
有关集成测试的更多信息，请参阅 [testing documentation](/developers/development_testing.md)。
