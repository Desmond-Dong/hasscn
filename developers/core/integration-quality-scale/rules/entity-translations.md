...
关于翻译流程的更多信息，请参阅 [翻译文档](/developers/internationalization/core.md)，其中还包含有关 [entity 翻译](/developers/internationalization/core.md#name-of-entities)的信息。
关于 entity 命名的更多信息，请参阅 [entity 文档](/developers/core/entity.md#has_entity_name-true-mandatory-for-new-integrations)。
