...
可用 device class 的列表可在 [entity](/developers/core/entity.md) 页面下的实体页面中找到。
更多有关实体命名的信息可在 [entity](/developers/core/entity.md#has_entity_name-true-mandatory-for-new-integrations) 文档中找到。
