...
目前唯一支持的 feature 是 'coalesce\_messages'，其结果是消息以批量方式合并发送，而不是逐个发送。
...
[阅读更多](/developers/core/platform/raising_exceptions.md) 关于抛出 exceptions 或 [exceptions 的本地化](/developers/internationalization/core.md#exceptions)。
