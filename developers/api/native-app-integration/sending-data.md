...
| Key | Type | Description |
| --- | --- | --- |
| `app_data` | Dict | 如果应用有支持组件来扩展 mobile\_app 功能或希望启用 notification platform，则可使用应用数据。 |
...
有关可用的 key 和响应，请参阅[conversation API 文档](/developers/intent_conversation_api.md)。
