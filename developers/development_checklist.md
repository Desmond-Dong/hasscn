...
* 任何删除或更改现有行为的内容都遵循[废弃流程](/developers/deprecating.md)。
* 已为 [home-assistant.io](https://home-assistant.io/) 开发文档
  * 访问[网站文档](/developers/documenting.md)以获取更多有关为 [home-assistant.io](https://github.com/home-assistant/home-assistant.io) 做贡献的信息。
