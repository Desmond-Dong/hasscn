...
首先按照我们的 [devcontainer 开发环境](/developers/setup_devcontainer_environment.md) 指南，设置一个合适的开发环境。
...
你需要先设置好一个 Home Assistant 实例。开发实例请参考我们的 [设置开发环境](/developers/development_environment.md) 指南。
...
| `yarn dev:gallery`      | 8100 | [设计图库](/developers/frontend/design.md)。                             |
...
* **Gallery**：[设计图库](/developers/frontend/design.md)。
