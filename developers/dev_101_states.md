...
这是一个简单的教程/示例，介绍如何创建和设置 states。我们将在一个名为 "hello\_state" 的 component 中进行操作。这个 component 的目的是在 frontend 中显示给定的文本。
...
要让你的 integration 被包含在 Home Assistant 的 releases 中，请按照 [Submit your work](/developers/development_submitting.md) 部分描述的步骤操作。基本上你只需要将 integration 移动到你 fork 的 `homeassistant/component/` 目录，并创建一个 Pull Request。
