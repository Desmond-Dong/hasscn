...
这与之前的 OS 版本不同，之前的版本将限制设置为"无限"（实际上超过 10 亿的值）——这也是上游引入的变更——[自 Home Assistant OS 10 起](/developers/blog/2023-04-13-new_limits_for_add_ons.md)。新限制符合现代 Linux 系统上的常见做法，并遵循其他 Linux 发行版逐渐采用的变更。
