...
查看更新后的 custom card 示例，以在 vanilla JS 中使用它：[Custom card example](/developers/frontend/custom-ui/custom-card.md#defining-your-card)。

### 使用 @transform 处理派生数据

*仅在 home-assistant frontend codebase 内可用*
