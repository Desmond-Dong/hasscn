...
*Home Assistant 如何使用 Azure Pipelines 自动化一切。*
...
*（旁注。Python 是以 Monty Python 命名的，包索引则因他们著名的一个段子被叫做 "the Cheese Shop"。因此 Wheel 格式是以一块轮状奶酪命名的，而不是汽车的轮子。5000 块轮状奶酪是很多的奶酪。）*
