...
[`BaseScannerEntity`](/developers/core/entity/device-tracker.md#basescannerentity) class 应被拥有 scanner 但不追踪与 WLAN 或其他本地网络连接状态的集成使用，例如追踪与 BLE beacon 连接的 scanners。
