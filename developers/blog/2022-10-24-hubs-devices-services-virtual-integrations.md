...
我们已经有 [`integration_type`](/developers/creating_integration_manifest.md#integration-type)
清单属性，现在已扩展以支持这些新类型：
...
:::caution
当 [`integration_type`](/developers/creating_integration_manifest.md#integration-type)
未设置时，我们将其自动默认为 `hub`。这是一个临时降级方案。
未来我们将要求显式设置 [`integration_type`](/developers/creating_integration_manifest.md#integration-type)。
...
[虚拟集成](/developers/creating_integration_manifest.md#virtual-integration)。
...
[在开发者文档中了解更多信息。](/developers/creating_integration_manifest.md#virtual-integration)
