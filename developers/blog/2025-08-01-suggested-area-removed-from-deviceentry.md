...
更多详情请参阅 [DeviceEntry 文档](/developers/device_registry_index.md#device-properties) 以及弃用了 `DeviceEntry.suggested_area` 的核心 [PR 149730](https://github.com/home-assistant/core/pull/149730)。
