...
* 还新增了几个 [websocket 命令](/developers/core/entity/assist-satellite.md#websocket-api)，提供了一种统一的方式来获取和设置设备上的活动唤醒词。
