...
复杂功能也可以使用[通知命令](/companion/notifications/commands.md)进行更新。这些更新受系统限制，每天 50 次，您可以在[配置](https://my.home-assistant.io/redirect/config/)的伴侣应用部分的 Apple Watch 部分查看当前限制。
