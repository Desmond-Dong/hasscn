...
Home Assistant 已开始在 Meta Quest 上提供 Android 应用的[精简版本](/companion/core/android-flavors.md)。该应用可在 [SideQuest](https://www.sidequestvr.com) 找到，这是 Meta Quest 的替代应用商店。

\<a href="https://sidequestvr.com/app/6427/home-assistant" style={{ display: 'inline-block', width: '200px' }}> <img class="download-badge" width="175" src="https://sidequestvr.com/assets/images/branding/Get-it-on-SIDEQUEST.png" alt="在 SideQuest 下载" /> </a> <br /><br />
