...
### "Invalid Client ID or Redirect URI" 和 "OS Error while looking up redirect\_uri"
...
### "Invalid Client ID or Redirect URI" 和 "Timeout while while looking up redirect\_uri"
...
### SSL error while looking up redirect\_uri <https://home-assistant.io/iOS>

此错误意味着您的 Home Assistant 无法协商与 <https://home-assistant.io> 的加密连接。此问题曾在运行在 MacOS 上的安装中出现，其中安装程序关于证书的通知被跳过和忽略。来自 Python 3.7.5 自述文件：
