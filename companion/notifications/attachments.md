...
<img src="/companion-assets/apple.svg" alt="iOS" style="height: 1em; vertical-align: middle;" /> iOS 用户可以使用[动态附件中的摄像头流](/companion/notifications/dynamic-content.md#camera-stream)。
...
* 如果您设置了 [`icon_url`](/companion/notifications/basic.md#notification-icon) 和 `image` 属性，则设备上只会显示图像。
