    ...
    return id;
        ...
        setup (api) {
            ...
            api.onAfterCreateCompiler(({ compiler })=>{
                ...
                rewriteUrls && rule.use(CHAIN_ID.USE.RESOLVE_URL).loader(external_node_path_default().join(src_dirname, '../compiled/resolve-url-loader/index.js')).options({
                    join: await getResolveUrlJoinFn(),
                    sourceMap: !1
                }).end(), rule.use(CHAIN_ID.USE.SASS).loader(external_node_path_default().join(src_dirname, '../compiled/sass-loader/index.js')).options(options);
            });
        }
    });
